...
[Läs mer...](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-cloud/discover-smarter-faster-learning-with-experience-league-s-new/td-p/739750?profile.language=sv)
...
| Januari 2025 | [[!UICONTROL Dataflow] inmatning från felaktig källmapp i  [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-25581) | Ny artikel | Lär dig hur du löser problemet där en [!UICONTROL dataflow] som har konfigurerats att importera data från [!DNL Azure Blob Storage] läser filer från en felaktig mapp. |
| Januari 2025 | [Stöd för [!DNL KMS-encrypted S3 buckets] in [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-25534) | Ny artikel | Lär dig mer om stöd för krypteringsmetoder i [!DNL Adobe Experience Platform], och om alternativen för datainmatning och export. |
| Januari 2025 | [Åtgärdar [!DNL DULE] fel i [!DNL Adobe Experience Platform] för målgruppsaktivering](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-25552) | Ny artikel | Lär dig hur du löser problemet med [!DNL DULE]-fel på grund av konflikter mellan dataetiketter och marknadsföringsåtgärder. |
| Januari 2025 | [Fält visas inte i [!DNL AEP Segment Builder]](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-25544) | Ny artikel | Lär dig hur du löser problemet där attribut eller fält från en datauppsättning inte visas i [!DNL Adobe Experience Platform] [!DNL Segment Builder], även efter att dataimporten lyckades. |
...
| -----------| ---------- | ---------- | ---------- |
|January 2025|[Adobe [!DNL Analytics] & CJA: Quick Start for Basic to Intermediate Analysis Capabilities](https://experienceleague.adobe.com/sv/docs/events/adobe-customer-success-webinar-recordings/2024/basic-to-intermediate-analysis-capabilities)|Event |Learn about Adobe [!DNL Analytics] and [!DNL Customer Journey Analytics] with a focus on basic to intermediate analysis capabilities.|
|January 2025|[AEP Web SDK Troubleshooting, Assurance, and Tips and Tricks](https://experienceleague.adobe.com/sv/docs/events/tech-sessions/2024/rtcdp-office-hours-2024/aep-web-sdk-troubleshooting)|Event |Gain insights into troubleshooting, assurance, and tips and tricks for the Adobe [!DNL Experience Platform] (AEP) Web SDK.| -->
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|----|----|-----------|
| Januari 2025 | [[!DNL Virtual Report Suite (VRS)] och funnel-avvikelser i [!DNL Adobe Analytics]](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-25603) | Ny artikel | Lär dig hur du löser funnel-avvikelser i [!DNL Adobe Analytics] [!DNL Virtual Report Suite] (VRS) genom att jämföra den med överordnade Suite-data och använda rätt segment. |
...
|September 2024|[Marketo Measure Ultimate overview](https://experienceleague.adobe.com/sv/docs/marketo-measure-learn/tutorials/marketo-measure-ultimate/overview)|New video |Learn how Marketo Measure Ultimate allows B2B marketers to gather data from almost any source, including multiple sources of the same type, for thorough attribution. |
|September 2024|[API Help - How to set the Access token in a variable](https://experienceleague.adobe.com/sv/docs/marketo-learn/tutorials/integrations/api-set-access-token-variable)|New video |Learn how to set up the Postman application and leverage variables to save data into the variable for reusability purposes. You will also learn how to make your first Marketo Engage REST API call to get the access token.|
|September 2024|[Go live with Dynamic Chat in just 15 minutes](https://experienceleague.adobe.com/sv/docs/marketo-learn/tutorials/dynamic-chat/go-live-in-15-minutes)|New video |Watch a step by step guide to help you go live with your first dialogue using Dynamic Chat in just 15 minutes.| -->

...
| Publicerad | Namn | Typ | Beskrivning |
|---------|----|----|-----------|
| Januari 2025 | [[!DNL Virtual Report Suite (VRS)] och funnel-avvikelser i [!DNL Adobe Analytics]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-25603) | Ny artikel | Lär dig hur du löser funnel-avvikelser i [!DNL Adobe Analytics] [!DNL Virtual Report Suite] (VRS) genom att jämföra den med överordnade Suite-data och använda rätt segment. |

...
* [Kaffebrytningar för communityfrågor](#coffee): Chatt med produktchefer i Experience League Communities
* [Adobe Developer Live](#dev-live): On-demand-videohändelser tillgängliga på Experience League

Scheman och händelserna är följande:

### EXPERIENCE LEAGUE LIVE{#exl-live}

[Experience League LIVE](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html) är ett direktuppspelningsprogram som skapats av Experience League-teamet. Det är en chans att få kontakt med produktexperter från Adobe. Lär dig praktiska tips, tricks och strategier som du kan använda med Adobe Experience Cloud-programmen.

| Händelsedatum | Tid | Händelsenamn | Format | Beskrivning |
| -----------| ---------- | ---------- | ---------- |---------- |
| 25 januari 2022 | 9.00 (PST) | [Analysera ditt företag utifrån datakällor](https://www.youtube.com/watch?v=L2EWCOHeyXI) | Live Video-händelse | Använd Customer Journey Analytics för att samla alla data på ett och samma ställe. |
| 3 februari 2022 | kl. 12 (EST) | [Vi presenterar alla nya referensdemonstrationer i AEM](https://www.youtube.com/watch?v=FEREXV826NQ) | Live Video-händelse | Lär dig det snabbaste sättet att tillhandahålla, demonstrera och utforska AEM as a Cloud Service funktioner. |

{style="table-layout:auto"}

Tidigare avsnitt finns på [Experience League Live](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html).
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Customer Journey Analytics och Analytics framtid | 18 januari 2022 kl. 8.00 PST | Adobe Analytics, Customer Journey Analytics, Experience Platform | Frågor och svar | Lägg upp dina frågor i Analytics Community för Trevor Paulsen, Group Product Manager, Adobe Analytics.<br>[Information och registrering](https://analyticscommunityqacoffeebrea.splashthat.com/?utm_source=community-thread&amp;utm_campaign=coffee_talk_AA&amp;utm_content=220118) |
...
| -----------| ---------- | ---------- |---------- |
| [Adobe [!DNL Developers Live]](https://experienceleague.adobe.com/docs/adobe-developers-live-events/events/2021/oct2021/overview.html) | On Demand | Video | [!DNL Developers Live] visar upp de senaste tekniska framstegen och utvecklarverktygen för design, arbetsflöden för innehållsskapande, dokumenttjänster och hantering av kundupplevelser i olika branscher. Visa huvudkommenteringsadressen, läs om API:er för Analytics, klientdatalager, öppen källkodsprojekt i Adobe I/O med mera. |
...
Läs den [senaste versionsinformationen](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html#status) för [!DNL Adobe System Status].
...
Läs den senaste informationen i [versionsinformationen för Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html).
...
| -----------| ---------- | ---------- | ---------- |
| Januari 2022 | [Konfigurera kund-AI](https://experienceleague.adobe.com/docs/platform-learn/tutorials/intelligent-services/configure-customer-ai.html) | Video | Lär dig hur du skapar en instans av Kund-AI för att förutsäga kundbeteende. |
| Januari 2022 | [Konfigurera Attribution AI](https://experienceleague.adobe.com/docs/platform-learn/tutorials/intelligent-services/configure-attribution-ai.html) | Video | Lär dig hur du skapar en instans av Attribution AI för att förstå effekten av dina marknadsföringskanaler och kampanjer. |
...
| ----------- | ---------- | ------- |
| N/A | | Se [Allmän tillgänglighet](https://experienceleague.adobe.com/docs/analytics/technotes/releases.html) |
...
De senaste uppdateringarna av AppMeasurement (version 2.2.4) finns i [AppMeasurementet för JavaScript versionsinformation](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html).
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Januari 2022 | [Grundläggande analyser för företagsanvändare har tagits bort](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/retire-fundamentals-for-business-users-course.html) | Video | Läs om varför den ursprungliga kursen gick ut och om de nya ersättningskurserna som Adobe rekommenderar. |
| Januari 2022 | [Panel för tidsåtgång för mediauppspelning](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/media-analytics/measuring-media-analytics/media-playback-time-spent-panel.html) | Video | Lär dig hur mediaanvändarna kan se hur mycket tid de tittar på medieuppspelningstiden är, baserat på hur lång tid de tittar på under dagen och på en vald granularitet. |
| Januari 2022 | [Strategier för kundsegmentering och metodtips i Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/customer-segmentation-strategies.html) | Video | Delta i analysinsikterna för en analysstorsdag som fokuserar på kundsegmentering, strategier och bästa metoder. |
| Januari 2022 | [Konfigurera identifiering av betald sökning](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/configure-paid-search-detection.html#) | Video | Lär dig hur du går igenom konfigurationen av avsnittet Betalsökningsidentifiering i Adobe Analytics Admin Console, inklusive några rekommendationer. |
| Januari 2022 | [Konfigurerar listvariabler](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/configuring-list-variables.html) | Video | Lär dig hur och varför du konfigurerar och använder listvariabler i Adobe Analytics. Med listvariabler kan du placera mer än ett värde i en eVar. |
| Januari 2022 | [Konfigurerar trafikvariabler (props)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/configuring-traffic-variables-props.html) | Video | Lär dig mer om konfiguration av trafikvariabler, som också kallas _props_, i Analytics Admin Console. |
| Januari 2022 | [Ändra inkommande data med bearbetningsregler](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/manipulating-incoming-data-with-processing-rules.html) | Video | Läs mer om hur du bearbetar regler i Adobe Analytics och vad du kan använda dem till. Få tips, exempel och en varning om hur du använder bearbetningsregler. |
| Januari 2022 | [Använda segment som Dimensioner i Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-as-dimensions-in-analysis-workspace.html) | Uppdaterad video | Lär dig hur du jämför och visualiserar segment genom att använda dem som en dimension i Analysis Workspace. |
| Januari 2022 | [Segmenthantering och delning i Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-management-and-sharing.html) | Uppdaterad video | I den här uppdaterade videon får du tips på hur du delar och hanterar dina segment. |
| Januari 2022 | [Använda segment för att begränsa data i Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-to-limit-data-in-analysis-workspace.html) | Uppdaterad video | Lär dig hur du kan begränsa användare av ett projekt i Analysis Workspace till ett visst segment (eller segment) när de arbetar med verktyget. |
| Januari 2022 | [Segmentjämförelse i Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-comparison-in-analysis-workspace.html) | Uppdaterad video | Läs om hur segmentanalys, som ingår i Analysis Workspace i Adobe Analytics, förenklar analysen genom att undersöka vilka två analyssegment som helst i alla era dimensioner och mätvärden för att automatiskt identifiera de mest statistiskt signifikanta skillnaderna. |
...
| Funktion | Beskrivning | Måldatum |
| ----------- | ---------- | ----- |
| [!UICONTROL Persistence] alternativ för bindningsdimensioner och bindningsmått | När du skapar eller redigerar en datavy kan du binda en dimensions beständighet till en annan dimension eller mätvärde. Det här konceptet kallas _marknadsföring_ i rapporter och analyser och stöds nu i CJA. [Läs mer](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/persistence.html#binding-dimension) | 19 januari 2022 |
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Dynamic Media - Du kan nu använda Experience Manager Dynamic Media-gränssnittet för att konfigurera [!UICONTROL General Settings] och [!UICONTROL Publish Setup] i stället för att behöva gå igenom Dynamic Media Classic skrivbordsprogram.
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * **Gör arbetsflödesdata externt för säker bearbetning**: Du kan lagra processdata (Experience Manager [!UICONTROL Workflow Variables] -data) som innehåller SPD-element (känsliga personuppgifter) i en kundhanterad databas för säker bearbetning. Dataelementen och arbetsflödesvariablerna lagras inte i Experience Manager-databasen och hämtas på begäran från en kundhanterad databas när arbetsflödet bearbetas.
...
* **Experience Manager GEMs webbinarium - Experience Manager as a Cloud Service** | 2021 års översyn och 2022 års prognoser
...
| Januari 2022 | [AEM Headless-snabbinställning för AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/quick-setup/cloud-service.html) | Video | Ta en titt på AEM Headless-snabbinstallationen. Den ger dig möjlighet att prova AEM Headless med innehåll från exempelprojektet WKND Site och ett exempel på React App (en SPA) som förbrukar innehållet AEM Headless GraphQL API:er. | AEM as a Cloud Service |
...
Experience Manager Guides är ett program som distribueras till AEM. Det är en kraftfull, komponentbaserad innehållshanteringslösning (CCMS) som möjliggör inbyggt DITA-stöd i Adobe Experience Manager och ger möjlighet att AEM hantera DITA-baserad framtagning och leverans av innehåll. Läs mer om [XML Documentation för AEM](https://www.adobe.com/products/xml-documentation-for-experience-manager/features.html).
...
| Januari 2022 | [Utdatagenerering med XML Documentation för AEM](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/videos/output-generation/overview.html) | Videor och artiklar | Läs mer om Map Dashboard, rapporter, publicering med baslinjer och villkor med mera. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Januari 2022 | [Business Intelligence](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/business-intelligence/1-overview.html) | Video (flera) | Börja med översikten och lär dig allt om Business Intelligence, en komplett lösning som har optimerats för alla handlare i Adobe Commerce och Magento Open Source. |
| Januari 2022 | [Användare, roller och behörigheter](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/users-roles-permissions.html) | Video | Lär dig hur du skapar ett separat användarkonto för varje användare och tilldelar begränsad åtkomst baserat på deras affärsbehov. |
| Januari 2022 | [Tvåfaktorautentisering](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/two-factor-authentication.html) | Video | Lär dig hur tvåfaktorsautentisering (2FA) förhindrar obehörig åtkomst till dina data. Adobe Commerce och Magento Open Source har stöd för tvåfaktorsautentiseringsmetoder från flera leverantörer. |
| Januari 2022 | [Lägg till webbplatser, butiker och butiksvyer](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/add-websites-stores-views.html) | Video | Se hur alla installationer av Adobe Commerce och Magento Open Source stöder en hierarki av webbplatser, butiker och butiksvyer. Bygg och expandera hierarkin utifrån verksamhetens behov. |
| Januari 2022 | [Ändra en butiks-URL](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/change-store-url.html) | Video | Lär dig hur du ändrar bas-URL för din butik. (Innehållet i videon återspeglar version 2.1.0.) |
| Januari 2022 | [Konfigurera en butiksplatskarta](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/site-map-setup.html) | Video | Lär dig hur du enkelt lägger till en webbplatskarta i din Commerce-butik. |
| Januari 2022 | [Kampanjprisregler](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/promotions-price-rules.html) | Video | Lär dig hur du ställer in produktrelationer och använder prisregler för att utlösa rabatter baserat på olika villkor. |
| Januari 2022 | [Skapa en sida](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/frontend-development/create-new-page.html) | Video | Lär dig hur du skapar en sida som returnerar JSON med en parameter. |
| Januari 2022 | [Lägg till en JavaScript-modul](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/frontend-development/add-javascript-module.html) | Video | Lär dig hur du utvecklar en enkel JS-modul med hälsningen&quot;Hello World&quot;. |
| Januari 2022 | [Page Builder - översikt](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/page-builder-overview.html) | Video | Läs om hur Page Builder gör det enkelt att skapa innehållsrika sidor med skräddarsydda layouter som förbättrar ditt visuella berättande och ökar kundengagemanget och lojaliteten. |
| Januari 2022 | [Lägg till en tabell i en databas](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/add-new-db-table.html) | Video | Lär dig mer om den speciella mekanismen i Commerce som gör att du kan skapa databastabeller, ändra befintliga tabeller och lägga till data i dem, till exempel konfigurationsdata, som måste läggas till när en modul installeras. |
| Januari 2022 | [Skapa en modul](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/create-module.html) | Video | Modulen är en strukturell del av Commerce - hela systemet bygger på moduler. Det första steget i att skapa en anpassning är oftast att skapa en modul. |
| Januari 2022 | [Skapa ett produktattribut](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/add-product-attribute.html) | Video | Lär dig hur du lägger till ett produktattribut, som är en av de vanligaste åtgärderna i Commerce. Attribut är ett kraftfullt sätt att lösa många praktiska uppgifter som rör en produkt. |
| Januari 2022 | [Exempel på beroendeinjektion](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/dependency-injection.html) | Video | Lär dig mer om beroendeinjicering, ett designmönster som gör att ett objekt A kan deklarera sina beroenden till ett externt objekt B som tillhandahåller dessa beroenden. De beroenden som deklareras av A är vanligtvis klassgränssnitt och beroenden B är konkreta implementeringar för dessa gränssnitt. |
...
* Information om förhandsversionen av Adobe Target finns i [Versionsinformation om förhandsversionen av Adobe Target](https://experienceleague.adobe.com/docs/target/using/release-notes/target-release-notes.html).
* Aktuell versionsinformation finns i [Versionsinformation för mål](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html).
...
| Funktion | Beskrivning |
| ------- | ----------- |
| [!UICONTROL Bulksheets], [!UICONTROL Notification Center] | (22 januari) Alla e-postmeddelanden för kalkylblad som Advertising Cloud Search skickar när en kalkylbladsåtgärd har slutförts eller misslyckats hanteras nu av [!UICONTROL Notification Center].<br><br>[!UICONTROL Bulksheets] är en ny meddelandetyp med egna meddelandeinställningar i [!UICONTROL Notification Center]. E-postmeddelanden och webbmeddelanden är aktiverade som standard, men du kan ändra meddelandeinställningarna om du vill.<br><br>Formatet och innehållet i e-postmeddelanden använder mallen [!UICONTROL Notification Center] och innehåller en direktnedladdningslänk för den associerade kalkylbladsfilen eller felfilen. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Januari 2022 | [Advertising Cloud Tutorials](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/dsp/intro.html) | Videor | Det finns fem nya videokurser om Advertising Cloud DSP. |

...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Januari 2022 | [Grundläggande analyser för företagsanvändare har tagits bort](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/retire-fundamentals-for-business-users-course.html?lang=sv-SE) | Video | Läs om varför den ursprungliga kursen har tagits bort och om de nya ersättningskurserna som Adobe rekommenderar. |
...
| Januari 2022 | [Segmenthantering och delning i Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-management-and-sharing.html?lang=sv-SE) | Uppdaterad video | I den här uppdaterade videon får du tips på hur du delar och hanterar dina segment. |
...
| Januari 2022 | [Segmentjämförelse i Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-comparison-in-analysis-workspace.html?lang=sv-SE) | Uppdaterad video | Läs om hur segmentanalys, som ingår i Analysis Workspace i Adobe Analytics, förenklar analysen genom att undersöka vilka två analyssegment som helst i alla era dimensioner och mätvärden för att automatiskt identifiera de mest statistiskt signifikanta skillnaderna. |
...
* [Nu kommer communitymedlemmar år 2021](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/announcing-community-members-of-the-year-2021/td-p/436782?profile.language=sv)

  Vi vill skicka ett stort tack till alla som deltog i [Experience Manager-communityn](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community?profile.language=sv) 2021 och hjälpte andra med deras problem.

  Varje år hedrar Experience Cloud Community den medlem som har en högre servicegrad och erbjuder otroligt stöd till andra med utmärkelsen Community Member of the Year. Vi känner igen de offentliga insatserna och presenterar [@Asutosh_Jena_](https://experienceleaguecommunities.adobe.com/t5/user/viewprofilepage/user-id/7532759?profile.language=sv) och [@Vijayalakshmi_S](https://experienceleaguecommunities.adobe.com/t5/user/viewprofilepage/user-id/11077056?profile.language=sv) som medlemmar i communityn för 2021.

* [Experience League Content for January 2022](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/experience-league-content-for-month-of-january-2022/td-p/437137?profile.language=sv)
...
| Januari 2022 | [Skapa en sida](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/frontend-development/create-new-page.html?lang=sv-SE) | Video | Lär dig hur du skapar en sida som returnerar JSON med en parameter. |
| Januari 2022 | [Lägg till en JavaScript-modul](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/frontend-development/add-javascript-module.html?lang=sv-SE) | Video | Lär dig hur du utvecklar en enkel JS-modul med hälsningen&quot;Hello World&quot;. |
| Januari 2022 | [Page Builder - översikt](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/page-builder-overview.html?lang=sv-SE) | Video | Läs om hur Page Builder gör det enkelt att skapa innehållsrika sidor med skräddarsydda layouter som förbättrar ditt visuella berättande och ökar kundengagemanget och lojaliteten. |
...
| Januari 2022 | [Skapa en modul](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/create-module.html?lang=sv-SE) | Video | Modulen är en strukturell del av Commerce - hela systemet bygger på moduler. Det första steget i att skapa en anpassning är oftast att skapa en modul. |

...
De senaste uppdateringarna av AppMeasurement-versioner (version 2.2.4) finns i [Versionsinformation för AppMeasurement för JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=sv-SE).
...
| Januari 2022 | [Panel för tidsåtgång för mediauppspelning](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/media-analytics/measuring-media-analytics/media-playback-time-spent-panel.html?lang=sv-SE) | Video | Lär dig hur mediaanvändarna kan se hur mycket tid de tittar på medieuppspelningstiden är, baserat på hur lång tid de tittar på under dagen och på en vald granularitet. |
| Januari 2022 | [Strategier för kundsegmentering och metodtips i Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/customer-segmentation-strategies.html?lang=sv-SE) | Video | Delta i analysinsikterna för en analysstorsdag som fokuserar på kundsegmentering, strategier och bästa metoder. |
| Januari 2022 | [Konfigurera identifiering av betald sökning](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/configure-paid-search-detection.html?lang=sv-SE#) | Video | Lär dig hur du går igenom konfigurationen av avsnittet Betalsökningsidentifiering i Adobe Analytics Admin Console, inklusive några rekommendationer. |
| Januari 2022 | [Konfigurerar listvariabler](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/configuring-list-variables.html?lang=sv-SE) | Video | Lär dig hur och varför du konfigurerar och använder listvariabler i Adobe Analytics. Med listvariabler kan du ange mer än ett värde i en eVar. |
| Januari 2022 | [Konfigurerar trafikvariabler (props)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/configuring-traffic-variables-props.html?lang=sv-SE) | Video | Lär dig mer om konfiguration av trafikvariabler, som också kallas _props_, i Analytics Admin Console. |
| Januari 2022 | [Ändra inkommande data med bearbetningsregler](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/manipulating-incoming-data-with-processing-rules.html?lang=sv-SE) | Video | Läs mer om hur du bearbetar regler i Adobe Analytics och vad du kan använda dem till. Få tips, exempel och en varning om hur du använder bearbetningsregler. |
| Januari 2022 | [Använda segment som dimensioner i Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-as-dimensions-in-analysis-workspace.html?lang=sv-SE) | Uppdaterad video | Lär dig hur du jämför och visualiserar segment genom att använda dem som en dimension i Analysis Workspace. |
...
| Januari 2022 | [Använda segment för att begränsa data i Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-to-limit-data-in-analysis-workspace.html?lang=sv-SE) | Uppdaterad video | Lär dig hur du kan begränsa användare av ett projekt i Analysis Workspace till ett visst segment (eller segment) när de arbetar med verktyget. |
...
| Januari 2022 | [Användare, roller och behörigheter](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/users-roles-permissions.html?lang=sv-SE) | Video | Lär dig hur du skapar ett separat användarkonto för varje användare och tilldelar begränsad åtkomst baserat på deras affärsbehov. |
| Januari 2022 | [Tvåfaktorautentisering](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/two-factor-authentication.html?lang=sv-SE) | Video | Lär dig hur tvåfaktorsautentisering (2FA) förhindrar obehörig åtkomst till dina data. Adobe Commerce och Magento Open Source har stöd för tvåfaktorsautentisering från flera leverantörer. |
| Januari 2022 | [Lägg till webbplatser, butiker och butiksvyer](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/add-websites-stores-views.html?lang=sv-SE) | Video | Läs om hur alla Adobe Commerce- och Magento Open Source-installationer har stöd för en hierarki av webbplatser, butiker och butiksvyer. Bygg och expandera hierarkin utifrån verksamhetens behov. |
| Januari 2022 | [Ändra en butiks-URL](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/change-store-url.html?lang=sv-SE) | Video | Lär dig hur du ändrar bas-URL för din butik. (Innehållet i videon återspeglar version 2.1.0.) |
| Januari 2022 | [Konfigurera en butiksplatskarta](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/site-map-setup.html?lang=sv-SE) | Video | Lär dig hur du enkelt lägger till en webbplatskarta i din Commerce-butik. |
| Januari 2022 | [Kampanjprisregler](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/admin/promotions-price-rules.html?lang=sv-SE) | Video | Lär dig hur du ställer in produktrelationer och använder prisregler för att utlösa rabatter baserat på olika villkor. |
...
| Januari 2022 | [Lägg till en tabell i en databas](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/add-new-db-table.html?lang=sv-SE) | Video | Lär dig mer om den speciella mekanismen i Commerce som gör att du kan skapa databastabeller, ändra befintliga tabeller och lägga till data i dem, till exempel konfigurationsdata, som måste läggas till när en modul installeras. |

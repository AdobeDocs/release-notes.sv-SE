...
>[!IMPORTANT]
>
>Om du vill få ett månatligt e-postmeddelande om uppdateringar av den här sidan prenumererar du på produktuppdateringen [Adobe Priority](https://www.adobe.com/subscription/priority-product-update.html). Kolla in det som händer i Experience League. Nästa prioriterade produktuppdatering distribueras **januari 2023**, efter helgperioden. Stanna kvar på kanalen!
...
* [[!DNL Experience League] events](#events) (Uppdaterad **6** januari)
...
* [Admin Chat: Marknadsföring och kreativt](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,1qnTSsu1BE6bJ4ijFsYafg,COdPeWL3z0qsME9nhjnRwg,rt0Knsqbf0qXnCBbrsMKsQ,dwwihmlWl0aM4Se6G4bXTQ,_C3JizOF1USDb_UKZOC2rg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) - **6** - _Den här interaktiva sessionen är inriktad på att ansluta dig till andra administratörer, diskutera bästa praxis samt tips och tricks som hjälper dig att få ut det mesta av [!DNL Workfront] för dig och dina användare._
* [CS-anslutningar: Dela strategisk bästa praxis](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,Kn3p9Ut9vkCcycuFzBOJ4Q,5uLGVo1-uUS0_PY7S6QjmQ,vwcqrDXgIUyCK-lPjko8zA?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) - **9 januari** - _Söker du en möjlighet att ansluta till andra kunder och diskutera [!DNL Workfront]-funktioner? Gå med i CS Connections-serien! En månatlig möjlighet att kontakta andra kunder för att diskutera din organisations aktuella ämnen._
* [Nyheter i [!DNL Adobe Workfront] 23.1](https://webinars.on24.com/adobe_workfront/whatsnewin231?partnerref=EXL) - **10** januari - _Gå med i [!DNL Adobe Workfront]-produktteamet och läs mer om kommande funktioner och förbättringar i vår senaste version._
* [AEM Best Practices Analyzer för lokala miljöer och AMS-miljöer](https://aem-augs.adobe.com/events/details/adobe-experience-manager-aem-learning-chapter-presents-aem-gems-aem-best-practices-analyzer-for-on-premise-ams-environments/) - **18 januari** - _Lär dig mer om verktyget Adobe Experience Manager Best Practices Analyzer som innehåller analys- och rapporteringsfunktioner för AEM lokala instanser och AMS-instanser. Observera att det inte gäller för AEM as a Cloud Service._
...
Adobe rekommenderar att du [uppgraderar till den senaste versionen ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html) av Workfront för Experience Manager förbättrade anslutningsprogram.
...
| December 2022 | [URL-omdirigeringar](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/administration/url-redirection.html) | Video | Läs mer om de olika alternativen för att utföra URL-omdirigering i AEM. | AEM |
| November 2022 | [Inkludera tredjepartspaket i ditt AEM projekt](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/creating-your-first-osgi-bundle/include-third-party-jars.html) | Video | Lär dig hur du inkluderar OSGi-paketet från tredje part i ditt AEM. | AEM Forms |

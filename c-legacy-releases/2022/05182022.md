...
>[!NOTE]
>
>Om du vill få ett månatligt e-postmeddelande om uppdateringar av den här sidan prenumererar du på [Produktuppdatering Adobe Priority](https://www.adobe.com/subscription/priority-product-update.html). Kolla in det som händer i Experience League.
...
Utgivningsdatum: **18 maj 2022**

* Adobe Analytics [versionsinformation](https://experienceleague.adobe.com/docs/analytics/release-notes/latest.html)
* Adobe Analytics [produktdokumentation och självstudier](https://experienceleague.adobe.com/docs/analytics.html)
...
| Maj 2022 | [Navigera på den nya landningssidan](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/navigating-the-new-landing-page.html) | Video | Lär dig hur du får ut det mesta av den nya landningssidan i Analytics och dess funktioner. |
| Maj 2022 | [Panelerna och rapporterna för arbetsytan Nästa/Föregående och Sidsammanfattning](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/using-panels/next-previous-and-page-summary-workspace-panels-reports.html) | Video | Se de två nya paneltyperna i Analysis Workspace - Nästa/Föregående och Sidsammanfattning. Detta gör att arbetsytan kan kombineras med några av de populäraste [!UICONTROL Reports & Analytics] rapporter. |
| Maj 2022 | [Uppdateringar av Analysis Workspace landningssida](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/analysis-workspace-landing-page-updates.html) | Video | Läs om några av de stora förbättringarna och tilläggen på den nya landningssidan. Vi har tagit del av dina synpunkter från kunderna och försökt att införliva de viktigaste funktionerna som storleksändring av kolumner, nya kolumntyper, länkar till realtidsrapporter och robotrapporter och många andra. |
...
| Maj 2022 | [Schemalägg en begäran från Report Builder](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/report-builder/schedule-a-report-builder-request.html) | Video | Lär dig hur du ställer in ett grundläggande schema för en Report Builder-arbetsbok. |
...
* **Experience Manager as a Cloud Service**
  ...
  Titta på [Video om versionsöversikt, april 2022](https://video.tv.adobe.com/v/342612?quality=12) för en sammanfattning av funktioner som lagts till i version 2022.4.0 (april 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
* **Experience Manager Sites as a Cloud Service**
   ...
   * Nu kan du definiera datatyper för innehållsmodell som [översättningsbar](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/content-fragments/content-fragments-models.html#properties) med en kryssruta i innehållsmodellens redigerare. Översättningsregler och konfigurationer för Experience Manager uppdateras också automatiskt.
...
* **Experience Manager Assets as a Cloud Service**
   ...
   * Nu kan du [sortera taggar](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/organize-assets.html#use-tags-to-organize-assets) i taggväljarfönstret i stigande eller fallande ordning baserat på taggnamn, skapandedatum eller ändringsdatum.

* **Experience Manager Forms as a Cloud Service**

  _Nya funktioner_

   * **Kommunikation - Stöd för API:er för dokumenthantering i Forms as a Cloud Service SDK** - [API:er för dokumenthantering](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications.html) kan du kombinera, ordna om och validera PDF-dokument. Nu kan du använda Communications - Document Generation APIs i en lokal utvecklingsmiljö med hjälp av Experience Manager Forms as a Cloud Service SDK.
...
* **Experience Manager as a Cloud Service Foundation**
  ...
  Adobe rekommenderar att du uppdaterar maven-projektet med den senaste versionen av analysverktyget eller inkluderar analysverktyget om du inte har gjort det än. Se [dokumentation](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/build-analyzer-maven-plugin.html) för mer information.
...
* **Inspelat Experience Manager GEMs-webbinarium**
   ...
   * [_Integrera AEM och CIF för att skapa en engagerande e-handelsupplevelse_](https://adobe.ly/3jorz5r).
...
| Publicerad | Namn | Typ | Beskrivning | Program |
| -----------| ---------- | ---------- | ---------- | ------|
| Maj 2022 | [AEM as a Cloud Service version 2021.4.0 - uppdatering](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/2021/2021-4-0.html) | Video | Hör vad AEM produktteamet har att säga och lär dig mer om funktionerna och innovationerna i den senaste versionen av Adobe Experience Manager. | AEM Assets Essentials, Sites, Screens, Forms och Cloud Foundation |
| Maj 2022 | [Cloud 5 AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-5/cloud5-introduction.html) | Videor | Få all användbar information du behöver om AEM as a Cloud Service i korta videoklipp på 5 minuter eller mindre. Börja med säsongen 1. | AEM CS |
| Maj 2022 | [Visa flera PDF-dokument i en karusell](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/display-pdf-in-carousel.html) | Video | Läs mer om hur man kan visa flera PDF-dokument för formuläranvändaren innan man skickar in formuläret. | AEM Forms |
...
| Maj 2022 | [Distribuera koden](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/deploy-code.html) | Video | Lär dig hur du distribuerar koden till Production med Cloud Manager-pipelines AEM as a Cloud Service. | AEM CS, Cloud Manager |
...
| Maj 2022 | [Vattenstämplar](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/advanced/watermarks.html) | Video | AEM funktioner för as a Cloud Service vattenstämpel gör att anpassade bildåtergivningar kan vattenstämplas med vilken PNG-bild som helst. | AEM Assets |
...
Läs mer om [Stödlinjer för Experience Manager](https://www.adobe.com/products/xml-documentation-for-experience-manager/features.html).
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Maj 2022 | [Skapa beslutsregler](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/create-rules.html) | Video | Lär dig hur du skapar beslutsregler för beslutshantering. Regler eller _beslutsregler_ är en av de nödvändiga byggstenskomponenterna i personaliserade erbjudanden. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Maj 2022 | [Marketo SKompetensutbyte](https://experienceleague.adobe.com/docs/skill-exchange-events/events/marketo/aug2021/marketo-roadmap.html) | Videor | Börja med att lära dig mer om Marketo färdplan. Upptäck sedan hur viktigt det är att tänka på Marketo som produkt. Få råd om hur ni kan utnyttja potentialen i anpassade fält för programmedlemmar, tips och tricks för Marketo Engage med mera i den här nyligen publicerade [Marketo SKompetensutbyte](https://experienceleague.adobe.com/docs/skill-exchange-events/events/marketo/aug2021/marketo-roadmap.html) från augusti 2021, nu på Experience League. |
...
| Optimeringsmål | (25 maj) Video och egna placeringar kan nu inkluderas i paket med anpassade mål [!UICONTROL Highest ROAS] och [!UICONTROL Lowest CPA]. |
...
| Funktion | Beskrivning |
| ------- | ----------- |
| [!UICONTROL Campaigns] | Följande betafunktioner är tillgängliga för alla annonsörer:<ul><li>([!DNL Microsoft® Advertising] konton) Synkronisering, skrivskyddad synlighet och rapportstöd (inklusive genomskinliga data) för era befintliga annonskampanjer på [!DNL Microsoft® Audience Network], inklusive [!DNL Microsoft® Audience Ads].</li><li>([!DNL Google Ads] och [!DNL Microsoft® Advertising] konton) möjlighet att importera [!DNL Google Ads] kampanjer och kampanjstruktur till [!DNL Microsoft® Advertising] från [!UICONTROL Search] > [!UICONTROL Tools] > [!UICONTROL Import Campaigns Beta].<br><br>När du har importerat kampanjer kan du kontrollera status för importjobbet, granska felloggar och redigera, pausa eller ta bort importschemat.</li></ul> |
| [!UICONTROL Campaigns]<br><br>[!UICONTROL Portfolios] | ([!DNL Microsoft® Advertising] kampanjer) Följande anbudsstrategier är nu tillgängliga för alla användare:<ul><li>[!UICONTROL Target Impression Share]: Du kan konfigurera kampanjer med den här strategin och om du vill kan du ange en målvisningsresurs, en målannonsposition och en maximal kostnad per klick. Varning! Det här alternativet stöds ännu inte i hybridportföljer och kan inte läggas till i standardportföljer.</li><li>[!UICONTROL Maximize Clicks]: Du kan konfigurera kampanjer med den här strategin och om du vill kan du ange en maximal målkostnad per klick. Ni kan inkludera kampanjer med den här strategin i antingen standard- eller hybridportföljer. För att denna strategi ska kunna användas i en blandad portfölj måste portföljens mål endast omfatta [!DNL Adobe] egenskaper (mätvärden), och du måste göra det möjligt att överföra Advertising Cloud Search-mål till [!DNL Microsoft® Ads].</li></ul> |
| Integrering med Adobe Analytics | (7 maj) I det dataflöde som Advertising Cloud skickar till [!DNL Analytics], för [!DNL Google Ads] dynamiska sökannonser är bara tillgängliga på annonsgruppsnivå från och med den 7 maj 2022. |

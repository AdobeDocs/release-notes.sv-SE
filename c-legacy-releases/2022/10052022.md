...
# Versionsinformation för Experience Cloud - oktober 2022
...
* Kunderna kan konfigurera **incident- och proaktiva meddelandegrupper** för att få information från Adobe om incidenter eller rekommendationer relaterade till deras AEMaaCS-program. Mer information finns i [Användargrupp för meddelanden](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/onboarding/journey/user-groups.html).

...
| Mars 2022 | [Inledande konfiguration och konfiguration](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/aem-experts-series/setup.html) | Video | Lär dig hur du konfigurerar och konfigurerar den förbättrade anslutningen till Workfront för Experience Manager och frigör den kombinerade kraften hos AEM Assets och Workfront. | AEM Assets, Workfront |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Mars 2022 | [Så här skapar du en standardbildskärmsplacering](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/dsp/placement-create.html) | Video | Lär dig hur du skapar en standardvisningsplacering för en kampanj i Advertising Cloud DSP. |
...
| Mars 2022 | [Låt Acrobat hjälpa dig att skapa tillgängliga PDF-filer](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/accessible.html) | Video | I den här 60-sekundersvideosjälvstudiekursen får du lära dig hur du kontrollerar om en PDF är tillgänglig. |
...
| Mars 2022 | [Skydda dina PDF-filer med ett lösenord](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/protect.html) | Video | I den här 60-sekundersvideosjälvstudien lär du dig hur du skyddar en PDF så att ett lösenord krävs för att öppna eller redigera PDF. |

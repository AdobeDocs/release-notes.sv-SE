...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Juni 2022 | [linktext](https://experienceleague.adobe.com/?lang=sv&recommended=Target-D-1-2021.1) | Kurs | Lär dig hur du implementerar Adobe Target på din webbplats. Från och med administrativa ämnen som krav och användarbehörigheter omfattar kursen implementeringsmetoder, överväganden och bästa praxis. |
...
* Ny [Campaign v8.3-version](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/release-notes.html?lang=sv-SE)
* Ny [Campaign Standard 2.2-utgåva](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=sv-SE)
* Ny [Kontrollpanel, majversion](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html?lang=sv-SE#may-2022)

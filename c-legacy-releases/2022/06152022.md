...
[Experience League-event](https://experienceleague.adobe.com/events/) är en bra plats att lära sig, interagera och få svar från produktexperter på Adobe!

Se [Händelser](https://experienceleague.adobe.com/events/) på Experience League om du vill fortsätta att uppdatera.
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Juni 2022 | [Kom igång med CDP för administratörer i realtid](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-A-1-2022.1.rtcdp) | Kurs | Få en introduktion till de administratörsåtgärder du behöver göra för att komma igång med [!DNL Real-time Customer Data Platform]. Lär dig mer om användarhantering och hur du skapar kontakter med andra partner och system. | [!DNL Real-time CDP] |
| Juni 2022 | [Övervaka segmentaktiveringen](https://experienceleague.adobe.com/docs/platform-learn/tutorials/monitoring/monitoring-the-success-of-segment-activation.html) | Video | Lär dig två sätt att övervaka flödet av dina segment till destinationer. När du skickar segmentprofiler till aktiveringspartners är det viktigt att du ser information om hur överföringen fungerar, särskilt för att du ska kunna åtgärda problem. | [!DNL Real-time CDP] |
...
* **Experience Manager Sites as a Cloud Service**
   ...
   * En [ny konsol](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/headless/content-fragments/content-fragment-console.html) som är optimerad för headless-användning av innehållsfragment.
...
| Publicerad | Namn | Typ | Beskrivning | Program |
| -----------| ---------- | ---------- | ---------- | ------|
| Juni 2022 | [[!DNL Forms] Portalkomponenter](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/forms-portal-components.html) | Video | Lär dig hur du aktiverar [!DNL AEM Forms] [!UICONTROL Portal]-komponenter i Forms Cloud Service. | AEM FORMS CS |
| Juni 2022 | [Integrera AEM- och CIF-ramverket för att skapa en engagerande e-handelsupplevelse](https://experienceleague.adobe.com/docs/experience-manager-gems-events/gems/gems2022/aem-and-cif-framework-integration.html) | Video | Förstå hur Adobe CIF Framework kan användas för att skapa en enhetlig och innehållsrik och engagerande handelsupplevelse. | AEM och CIF |
...
| Juni 2022 | [Kontextmedvetna molnkonfigurationer](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/context-aware-fdm.html) | Video | Lär dig hur du definierar sammanhangsberoende molnkonfigurationer i AEM Forms i Cloud Service. | AEM Forms |
...
* [[!DNL Experience Manager Guides]](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/videos/overview.html) - självstudiekurser på Experience League
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Juni 2022 | [Komma igång med MBI](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/mbi/webinars/getting-started.html) | Video | Lär dig mer om huvudfunktionerna i MBI direkt från Commerce produktteam med en djupdykning i förkonfigurerade instrumentpaneler och tillgängliga anpassningsalternativ. |
| Juni 2022 | [Hantera datauppsättningar i MBI](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/mbi/webinars/manage-data-sets.html) | Video | Läs om några av de kraftfulla funktionerna i MBI Data Warehouse Manager, direkt från Adobe Commerce produktteam. Gå steget längre än att skapa grundläggande rapporter och lär dig hur du kan göra mer med dina data. |
...
| Juni 2022 | [Semesterberedskap med MBI](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/mbi/webinars/holiday-readiness.html) | Video | Lär dig vanliga användningsexempel och metoder för säsongsanalys för att hantera dem med hjälp av viktiga MBI-funktioner. |
...
* Nya [självstudiekurser och kurser](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html#tutorials-campaign) på Experience League
...
| Juni 2022 | [Konfigurera anrikningsaktiviteter](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/data-management/enrichment-activity.html) | Video | Lär dig hur du konfigurerar en berikande aktivitet baserat på information i leveransloggen. | Campaign v8 |
...
| Funktion | Beskrivning |
| ------- | ----------- |
| Anpassade rapporter | (31 maj; betafunktion) Advertising Cloud DSP kan nu importera förstapartssegment som består av autentiserade signaler som är byggda inom en kunddataplattform (CDP). |

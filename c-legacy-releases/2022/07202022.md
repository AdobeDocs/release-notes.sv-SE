...
Experience League event är en utmärkt plats att lära sig, interagera och få svar från produktexperter på Adobe! Se [Händelser](https://experienceleague.adobe.com/events/) på Experience League för att fortsätta uppdateras i juli 2022.

Uppdaterad **28 juli 2022**

| Händelse | Typ | Beskrivning |
| -----------|---------- | ----|
| [Adobe Target](https://atcommunityqacoffeebreak803.splashthat.com/?utm_source=email&amp;utm_medium=Outbound&amp;utm_campaign=coffee_talk_AT&amp;utm_content=220803) | Community Q&amp;A Coffee Break | Vi kommer att bli medlemmar av Adobe Premier Support Business Consultant Rachel Booth, även kallad `@rbooth115`. Hon loggas in på Adobe Target Community för att chatta direkt med dig på [den här tråden](https://experienceleaguecommunities.adobe.com/t5/adobe-target-discussions/at-community-q-amp-a-coffee-break-8-3-22-8am-pt-rachel-booth/td-p/461694) om dina frågor som rör hennes expertområden (personalisering, optimering, integrering). <br>**Datum:** onsdag den 3 augusti kl. 8.00 PDT - kl. 9 - [Information och registrering](https://atcommunityqacoffeebreak803.splashthat.com/?utm_source=email&amp;utm_medium=Outbound&amp;utm_campaign=coffee_talk_AT&amp;utm_content=220803) |
| [Fråga experterna: Datastreams och dataförberedelse](https://experienceleague.adobe.com/docs/experience-league-live-events/events/episodes/exl-live-episode-07-21-22.html) | EXPERIENCE LEAGUE LIVE | I det sista av de tre sessionerna om datainsamling för Adobe Experience Cloud kommer våra experter att ge en djupdykning i Adobe avancerade datainsamlingsfunktioner, inklusive funktioner som förbered data för datainsamling. I slutet av sessionen kommer deltagarna att känna sig säkra på de senaste och kraftfullaste funktionerna för att samla in data från digitala upplevelser <br>**Datum:** juli 21 kl. 9.00 PDT - [Information](https://experienceleague.adobe.com/docs/experience-league-live-events/events/episodes/exl-live-episode-07-21-22.html) |
...
* Adobe Experience Platform produktkort i Admin Console kommer att innehålla:
  ...
  För organisationer som för närvarande inte använder Experience Platform visas nu _Adobe Experience Platform_-produkten i Admin Console, inklusive de funktioner som listas ovan.
...
Som nämndes i versionsinformationen från maj (2022.5.0) togs alternativet &quot;Lägg till träd&quot; bort under fliken Distribuera på administratörsskärmen för replikeringsagenten. Paket med en trädhierarki av innehåll bör i stället replikeras med Hantera publikation eller Publish Content Tree-arbetsflödet.

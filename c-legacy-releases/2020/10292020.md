...
Tidigare kallades _Experience Cloud bastjänster_, [Experience Cloud-tjänster och administration](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html) -dokumentationen innehåller kundattribut, målgruppsbiblioteksaktivering ([!UICONTROL People]-tjänst), användar- och produkthantering samt cookies från Experience Cloud.

Inte uppdaterat.

Den senaste versionsinformationen finns i [Cumulative Release Notes for Experience Cloud-tjänster](https://experienceleague.adobe.com/docs/core-services/interface/release-notes/release-notes.html).
...
Mer information om Platform launch finns i [Versionsinformation för Experience Platform Launch](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html).
...
| -----------| ---------- | ---------- | ---------- |
| 23 november 2020 | [Konfigurerar filbaserad molnlagring eller mål för e-postmarknadsföring](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configuring-file-based-cloud-storage-or-email-marketing-destinations.html#destinations) | Video | Få tips under genomgången av konfigurationen av ett filbaserat mål i Adobe Real-time CDP. Detta gäller molnlagringsdestinationer (t.ex. S3 eller SFTP) och även mål för e-postmarknadsföring. |
...
>[!NOTE]
>
>Adobe rekommenderar att du besöker [Experience Manager ](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/home.html) regelbundet för att få aktuell information om releaser.
...
* [AEM släpper färdplan](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap.html): Visar kommande releaser för AEM as a Cloud Service och AEM som stöds lokalt och hanterade tjänster.
* [AEM släpper uppdateringar](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/aem-releases-updates.html): Visar de senaste versionerna för AEM as a Cloud Service och de tjänster som stöds på plats och i hanterade tjänster AEM versionerna och visar dokumentation för dessa versioner.
...
| 9 november 2020 | [Distribuera resurserna på den lokala AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/store-and-retrieve-af-with-2fa/deploy-this-sample.html#store-and-retrieve-af-with-2fa) | Video | Skapa databasen, distribuera det anpassade OSGi-paketet och importera de olika artefakterna på klientsidan för att få användningsfallet att köras på din lokala AEM. |
...
| 11 november 2020 | [Skapa serverutrymme för att hantera POST-anrop](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/store-and-retrieve-af-with-2fa/create-servlet.html#store-and-retrieve-af-with-2fa) | Artikel | Skapa en serverlet i AEM genom att utöka `SlingAllMethodsServlet` och visa en REST-slutpunkt för godkännande av begäranden om POST. |
...
| 8 oktober 2020 | [Personalization of Full Web Page Experiences](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/target/personalization-web-page.html) | Video | Lär dig hur du skapar en aktivitet som dirigerar om de webbsidor som finns på AEM till en ny sida med Adobe Target. |
...
| 8 oktober 2020 | [Exportera upplevelsefragment till Adobe Target](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/target/export-experience-fragment-target.html) | Video | Lär dig hur du exporterar en AEM Experience Fragment som Adobe Target Offers. |
...
| 28 september 2020 | [Asset compute-kurs](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.1.asset.compute) | Kurs | Den här kursen handlar om hur du kan utöka AEM as a Cloud Service Asset Compute mikrotjänster! Nu bör du ha möjlighet att konfigurera, utveckla, testa, felsöka och driftsätta skräddarsydda Asset compute-arbetare som kan användas av AEM as a Cloud Service Author-tjänsten. |
...
| 25 september 2020 | [Felsök en Asset compute-arbetare](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/test-debug/debug.html) | Artikel | Asset compute-arbetare kan felsökas på flera olika sätt, från enkla felsökningsloggsatser till kopplad VS-kod som fjärrfelsökare, till att dra loggar för aktiveringar i Adobe I/O Runtime som initierats från AEM as a Cloud Service. |
...
| 14 september 2020 | [Skapa ett Asset Compute-projekt](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/develop/project.html) | Artikel | Asset compute är Node.js-projekt som skapats med Adobe I/O CLI och som följer en viss struktur som gör att de kan användas i Adobe I/O Runtime och integreras med AEM as a Cloud Service. |
...
| 7 oktober 2020 | [Utbyggbarhet för Asset compute](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/overview.html) | Artikel | Självstudiekurser som visar hur man skapar en anpassad resursmultiplikator för AEM as a Cloud Service. |
...
| 14 november 2020 | [Skapa Advertising Cloud Site Entry-rapporter](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-site-entry-a4adc.html#analytics) | Video | Skapa en rapport från Advertising Cloud webbplats för att övervaka veckodag, tidpunkt på dagen, webbläsare och geografisk påverkan. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| 2 november 2020 | [Samla dokument i stora volymer med hjälp av GigaSign](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/develop/custom/gigasign.html#gather-high-volume-documents-using-gigasign) | Video | Med Gigasign kan du skicka, samla in och spåra dokument för signering till tusentals personer samtidigt. Det är utformat för stora mängder kommunikation med anställda och kunder. GigaSign utnyttjar Adobe Sign API för att ge samma funktioner som MegaSign, men har ytterligare stöd för flera signerare, mottagargrupper, mottagarroller, avtalsnamn, kopia med mera. |
| 29 september 2020 | [Snabbgenomgång av Adobe Sign](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/quick-tour.html) | Video | I den här videon ska vi göra en snabb rundtur i Adobe Sign med början på hemskärmen. |

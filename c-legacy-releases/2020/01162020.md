...
Produktdokumentation finns i [Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html).
...
Du behöver inte göra ändringar om du inte använder CNAME för datainsamling från första part, men använder CNAME för flera domäner (vänliga tredjepartsdomäner), och du använder inte Experience Cloud (Visitor) ID Service. Med Chrome 80-versionen ger Chrome automatiskt besökar-ID-cookies för Analytics ett SameSite-värde på `Lax,`, vilket förhindrar att de används i andra domäner. Om du vill fortsätta använda CNAME i alla domäner måste du kontakta Adobe kundtjänst och begära att de ändrar värdet för Samma plats för CNAME till `None.`.
...
* [!UICONTROL Reports & Analytics]: Ett problem med att Funnel-rapporten för produktkonvertering skulle stängas av och otydliga siffror har korrigerats. (AN-186901)
...
Se [Versionsinformation för AppMeasurement för JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html).
...
* **AEM6.5.3.0**
AEM 6.5, Service Pack 3.0 (6.5.3.0 släppt 12 december 2019) är en viktig uppdatering som innehåller viktiga kundkorrigeringar som släppts sedan den allmänna tillgängligheten av AEM 6.5, april 2019.
...
* **AEM6.4.7.0**
  ...
  AEM 6.4, Service Pack 7.0 (6.4.7.0 släppt 12 december 2019) är en viktig uppdatering som innehåller viktiga kundkorrigeringar som släppts sedan AEM 6.4, april 2018 blev allmänt tillgängligt.
...
* **AEM-datorprogram2.0.1.1**

  AEM-datorprogrammet 2.0.1.1 innehåller en uppdatering för enkel inloggning med Okta och möjlighet att ange platsen för tillfälliga filer i Inställningar. Stöd för AEM 6.3.x har tagits bort för skrivbordsapp 2.x i den här versionen.
...
* **NYTT: AEM as a Cloud Service**
  ...
  [Adobe Experience Manager](https://business.adobe.com/products/experience-manager/adobe-experience-manager.html) (AEM) är nu tillgänglig i as a Cloud Service.
...
* **Automatiserad formulärkonverteringstjänst**
  ...
  Automated Forms Conversion Service, tjänsten som automatiskt konverterar PDF forms till vackra mobilklara HTML Forms, blev tillgänglig för allmän användning den 12 december 2019.
   ...
   * [Konvertera PDF forms till anpassningsbara formulär](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html)

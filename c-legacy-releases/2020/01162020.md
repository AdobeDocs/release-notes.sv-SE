...
Se [Versionsinformation för AppMeasurement för JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=sv-SE).
...
* **Adobe Asset Link 1.1 upphör med stödet för AEM 6.3.x**
   ...
   * [Adobe Asset Link](https://helpx.adobe.com/se/enterprise/admin-guide.html/enterprise/using/adobe-asset-link.ug.html)

### Produktreleaser

* **NYTT: AEM as a Cloud Service**

  [Adobe Experience Manager](https://business.adobe.com/se/products/experience-manager/adobe-experience-manager.html) (AEM) är nu tillgänglig i as a Cloud Service.

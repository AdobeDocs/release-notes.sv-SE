...
| 14 september 2020 | [Skapar introduktionskassor](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/creating-onboarded-traits.html) | Video | Lär dig tips om hur du skapar praktik i Audience Manager. |
...
| 28 september 2020 | [Introduktion till AEM Asset Compute Microservices](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.1.asset.compute) | Kurs | I den här kursen utforskas hur du kan utöka AEM as a Cloud Service Asset compute mikrotjänster. Nu bör du ha möjlighet att konfigurera, utveckla, testa, felsöka och driftsätta skräddarsydda Asset compute-arbetare som kan användas av AEM as a Cloud Service Author-tjänsten. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| 30 september 2010 | [Snabbgenomgång av Adobe Sign](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/quick-tour.html) | Video | Ta en snabb genomgång av Adobe Sign gränssnitt för att komma igång. |

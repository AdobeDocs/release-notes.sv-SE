...
Se [AppMeasurementet för JavaScript versionsinformation](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=sv-SE). Version 2.20.0 släpptes 5 mars 2020.
...
* Korrigerade ett fel i [Data Explorer](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/data-explorer/data-explorer-overview.html?lang=sv-SE) där vissa kunder inte kunde se innehåll i grundläggande informationsavsnitt och operatorer i uttrycksverktyget när de skapade egenskaper baserade på [!UICONTROL Data Explorer]-signaler. (AAM-53130)
...
* Flera tillgänglighetsförbättringar i hela gränssnittet. (AAM-48952, AAM-48969, AAM-48979, AAM-48993, AAM-49048, AAM-49057, AAM-49058, bud-49392)
...
* **Konfigurera AEM Assets med Brand Portal**
  ...
  AEM Assets har nu konfigurerats med [!UICONTROL Brand Portal] till Adobe I/O, vilket innebär att en IMS-token för auktorisering av Brand Portal-klienten anskaffas. Tidigare konfigurerades den i Classic-gränssnittet med hjälp av [!UICONTROL Legacy OAuth Gateway.]
...
* **AEM Webbseminarier om kunskapsbyggaren**
...
|----------| -----------| ---------- |  
| [!UICONTROL AEM Commerce] | Video - [Skapar flera kategori- och produktsidor](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content-and-commerce/home.html?lang=sv-SE) | Lär dig hur du skapar ett minimalt Adobe Experience Manager (AEM) CIF-projekt som utgångspunkt för kundprojekt med CIF Core Components. Använd tema och CSS-format på komponenter och inspektera ett nytt AEM CIF-projekt som genereras av arkitypen. Läs också om hur CSS och JavaScript som används av CIF huvudkomponenter är organiserade. |
| [!UICONTROL AEM Forms] | Artikel - [Autentisera till AEM författare med OKTA](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/single-sign-on-with-okta.html?lang=sv-SE) | Lär dig hur du konfigurerar appen på OKTA-portalen och om de inställningar som du vanligtvis använder när du registrerar nya program. |
| [!UICONTROL AEM Commerce] | Självstudie - [Anpassa CIF kärnkomponenter](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content-and-commerce/home.html?lang=sv-SE) | Granska flera olika tilläggspunkter från CIF Core Components och AEM i allmänhet. CIF Core Components innehåller en standarduppsättning med Commerce-komponenter som kan användas för att snabba upp ett projekt som integrerar Adobe Experience Manager (AEM) och Magento. |
| [!DNL Adobe Campaign] - Målgrupper | Video - [Skapa en publik..](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/profiles-and-audiences/audience-destinations/creating-audiences-using-segment-builder.html?lang=sv-SE) | Skapa en målgrupp i Campaign Standarden med Adobe [!UICONTROL Experience Platform Segment Builder]. Du kan komma åt den här funktionen direkt i Adobe Campaign Standard via modulerna [!UICONTROL Audiences]. |
...
| [!DNL Adobe Campaign] | Video - [Big data management på Snowflake](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/administrating/fda/big-data-segmentation-on-snowflake.html?lang=sv-SE) | Dra nytta av Snowflake-kontakten i Adobe Campaign Classic. |

...
| 5 juni 2020 | [SPA Editor-projekt](https://experienceleague.adobe.com/docs/experience-manager-learn/spa-react-tutorial/create-project.html?lang=sv-SE) | Artikel | Lär dig hur du använder AEM-projektarketypen för att generera ett Maven-projekt med flera moduler som utgångspunkt för ett React-program som är integrerat med AEM SPA Editor. |
...
| Rapporter | (Endast för Adobe Experience Platform-kunder) En ny flerkanalsrapport i Advertising Cloud Search ger en enhetlig vy över medieutgifter i olika DSP och sökningar, med dagliga nyckeltal för DSP och sökkampanjer. |

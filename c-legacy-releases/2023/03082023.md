...
Se till att alla Adobe är certifierade. Adobe är glada över att kunna meddela att den nya Experience Cloud-webbplatsen [Certification](https://experienceleague.adobe.com/docs/certification/certification/overview.html?lang=sv-SE) har startats på Experience League.
...
Och mycket mer! Gå till [Adobe-certifiering](https://experienceleague.adobe.com/docs/certification/certification/overview.html?lang=sv-SE) på Experience League och påbörja certifieringsresan idag!
...
Se den senaste [versionsinformationen](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2023/02082023.html?lang=sv-SE#status) om du vill se status för Adobe.
...
Information om de senaste uppdateringarna finns i [Versionsinformationen för februari 2023](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2023/02082023.html?lang=sv-SE#status).
...
| -----------| ---------- | ---------- | ---------- |
| Februari 2023 | [Ingen målgruppsstorlek i [!DNL Microsoft Bing] AEP-mål](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21544.html?lang=sv-SE) | Ny artikel | Lär dig varför [!DNL Bing] inte visar målgruppsstorlek för de AEP-segment som skickas till AEP-målet [!DNL Bing]. |
| Februari 2023 | [Hur många miljöer (dev, staging, production) som levereras med RTCDP-licensen?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21590.html?lang=sv-SE) | Ny artikel | Läs mer om antalet miljöer och sandlådor som ingår i RTCDP-licensen. |
...
| -----------| ---------- | ---------- | ---------- | ------|
| Mars 2023 | [Snabba utvecklingsmiljöer](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/rde/overview.html?lang=sv-SE) | Videor | Lär dig mer om Rapid Development Environment (RDE), hur du konfigurerar och använder den och hur du förstår utvecklingscykeln med hjälp av RDE. | AEM CS |
| Mars 2023 | [Resursdelningskomponent ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/sharing/assets-share/asset-share-commons-asset-kits.html?lang=sv-SE) | Video | Lär dig hur du använder funktionen Resursdelnings-resurs för att generera skräddarsydda, delningsbara webbsidor som listar resurser från AEM Assets-mappar eller -samlingar. | AEM Assets |

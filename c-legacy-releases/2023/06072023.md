---
title: Versionsinformation - juni 2023
...
**Händelseuppdatering för juni 2023:** På sidan [Experience League-händelseinspelningar](https://experienceleague.adobe.com/docs/events/experience-league-recorded-events/overview.html) kan du använda vänsternavigering för att bläddra bland tidigare händelser efter serietyp och program.
...
Se till att alla Adobe är certifierade. Besök den nya Experience Cloud-webbplatsen [Certification](https://experienceleague.adobe.com/docs/certification/program/overview.html) på Experience League.
...
Se [Versionsinformation från mars 2023](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2023/03082023.html#status) för Adobe-status om du vill visa de senaste uppdateringarna.
...
Hjälp om gemensamma komponenter för Experience Cloud-gränssnittet finns i [handboken för gränssnitt och administration för Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html) (innehåller [!UICONTROL Customer Attributes], [!DNL Experience Cloud Assets] och [!UICONTROL Audiences]).
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Maj 2023 | [Bevilja åtkomstbehörighet till Data Warehouse](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21666.html) | Lär dig vilken behörighet som ska läggas till för att ge Datan Warehouse åtkomstbehörighet. |
...
* [as a Cloud Service uppdateringar för Experience Manager](https://experienceleague.adobe.com/docs/events/aemcs-release-update-recordings/overview.html) - Titta på funktionsvideoöversikter över aktuella och tidigare versioner av [!DNL Experience Manager as a Cloud Service].
...
* Stöd för nytt protokoll (DASH - Dynamic Adaptive Streaming over HTTP) har startats för adaptiv strömning i Dynamic Media (med CMAF aktiverat):<!-- OLD. UPDATE FOR JUNE 7 -->
...
>[!IMPORTANT]
>
>Adobe rekommenderar att du [uppgraderar till den senaste 1.9.10-versionen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html) av Workfront for Experience Manager förbättrad anslutning. <!-- NEW. LEAVE IN FOR JUNE 7 -->

_Kända fel_

* När projektlänkade mappar konfigureras med AEM 6.4, sparar [!DNL Experience Manager] inte värdena för **undermappar** och **Skapa länkad mapp i projekt med portfölj**-fält. Värdet för fältet **sub-folders** uppdateras till **undefined**. Värdet för **Skapa länkad mapp i projekt med portfölj** uppdateras automatiskt till **Standard Portfolio** när konfigurationen har sparats. <!-- NEW. LEAVE IN FOR JUNE 7 -->
...
| Juni 2023 | [GraphQL videoserie](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/modeling-basics.html) | Video | Lär dig hur du definierar och använder [!UICONTROL Content Fragments] i Adobe Experience Manager (AEM) för GraphQL. | AEM CS |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|--------|---------|---------|
| Maj 2023 | [Omdirigering till anpassad inloggningssida från ett AEM OAuth-flödesfel](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21954.html) | Ny artikel | Lär dig varför det finns ett behov av att dirigera om till en anpassad inloggningssida vid ett AEM `OAuth`-flödesfel och hur du gör det. |
...
| Maj 2023 | [Aktivera Brand Portal med autentiseringsuppgifter för OAuth-server-till-server](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22074.html) | Ny artikel | Lär dig varför kunder bör använda JWT-inloggningsmetoden i stället för [!DNL OAuth Sever-to-Server]-inloggningsmetoden för att skapa Adobe [!UICONTROL IMS Technical Account Configuration]. |
| Maj 2023 | [AEM utloggningsproblem även efter SAML SSO-autentisering](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22065.html) | Ny artikel | Lär dig lösningen på problemet där användare inte kan logga ut när AEM autentiseras med SAML enkel inloggning (SSO). |
...
* [!DNL Campaign Control Panel] maj-utgåvan, med underdomäners SSL-certifikatdelegering till Adobe. [Läs mer...](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html)
...
| Juni 2023 | [Hantera, redigera och använda fragment](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/email-channel/manage-author-use-fragments.html) | Video | Lär dig hantera, redigera och använda fragment i [!DNL Journey Optimizer]. |
...
| Juni 2023 | [Navigera i användargränssnittet i Marketo Engage](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/fundamentals/ui-navigation.html) | Video | Lär dig navigera i användargränssnittet och bekanta dig med din väg runt plattformen [!DNL Marketo Engage]. |
...
| Publicerad | Namn | Typ | Beskrivning | Program |
| -----------| ---------- | ---------- | ---------- |---------- |
| Juni 2023 | [Bortredigering: Det rätta sättet](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/redaction.html) | Video | I den här 60-sekundersvideosjälvstudiekursen lär du dig det rätta sättet att ta bort känslig information från PDF. | Acrobat Pro |
| Juni 2023 | [Dela en PDF för att kommentera](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/share-comment.html) | Video | I den här 60-sekundersvideosjälvstudiekursen får du lära dig hur du delar PDF för att snabbt samla in feedback från flera personer i en och samma fil. | Acrobat |
...
| Juni 2023 | [Skapa en PDF från Microsoft Word](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/word-to-pdf.html) | Video | I den här 60-sekundersvideosjälvstudiekursen lär du dig hur du skapar en PDF från Microsoft Word. | Acrobat |
| Juni 2023 | [Anpassa PDF till ett standardformat](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/conform.html) | Video | I den här 60-sekundersvideosjälvstudiekursen får du lära dig hur du validerar PDF-innehåll mot PDF standardkriterier som PDF/X, PDF/A eller PDF/E. | Acrobat Pro |
| Juni 2023 | [Skapa PDF-filer med Acrobat](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/create-from-acrobat.html) | Video | I den här 60-sekundersvideosjälvstudien kan du lära dig hur du skapar PDF från [!DNL Microsoft 365] filer direkt i Acrobat skrivbordsapp. | Acrobat |
...
| Juni 2023 | [Lägger till användare](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/add-users-to-your-account.html) | Video | Lär dig hur du lägger till och hanterar användare för Acrobat Sign. Användarhantering sker i Admin Console. | Acrobat Sign |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Juni 2023 | [Datainsamling för vidarebefordran av händelser i flera sandlådor](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-ingestion/multi-sandbox-event-forwarding.html) | Självstudiekurs om utkast | Lär dig hur data som samlas in med Experience Platform Web och Mobile SDK kan konfigureras för att samla in en enda händelse och vidarebefordras till flera AEP-sandlådor. |

...
| Publicerad | Namn | Typ | Beskrivning |
|---------|--------|---------|---------|
| September 2023 | [Det går inte att skicka Adobe Analytics-data via Flutter AEP Core Libraries](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22809.html) | Ny artikel | Lär dig hur du löser problem med att skicka data i Adobe Analytics via Flutter AEP Core Libraries (Mobile SDK) med hjälp av trackAction/trackState API. |

...
# Versionsinformation för Experience Cloud - april 2023
...
* [Certifiering i Adobe](#certification) (**Nytt!**)
...
| Mars 2023 | [Hur skyddas AEP-data när de överförs till olika mål?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21593.html) | Ny artikel | Lär dig mer om datasäkerhetsåtgärder för AEP när du skickar data till olika destinationer. |
...
| Mars 2023 | [AAM API-måttdefinitioner för Trait Population ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21616.html) | Ny artikel | Läs mer om API-mått för AAM trait-populationen. |
...
* Möjlighet att hantera blockerande nya kunder på Experience Manager as a Cloud Service genom att konfigurera anslutningsprogrammet.
...
| April 2023 | [Så här uppdaterar du baslinjeuppsättningen för  [!DNL Apache] och [!DNL Dispatcher] konfigurationer](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/local-development-environment-set-up/dispatcher-tools.html#how-to-update-the-baseline-set-of-apache-and-dispatcher-configurations) | Video | Lär dig hur du uppdaterar eller synkroniserar Apache och Dispatcher-konfigurationer som ingår i Dispatcher-verktygen. Den här åtgärden säkerställer att lokal utveckling med Dispatcher SDK-installation inte blockeras och att CM-pipelines inte misslyckas. | AEM CS |
| April 2023 | [Autentisera AEM författare med OKTA](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/authentication/okta-saml-integration.html) | Video | Förstå olika konfigurationsinställningar för enkel inloggning med OKTA. | AEM 6.5 |
...
| Mars 2023 | [Hur kommer jag åt din AEM i AEM as a Cloud Service med cURL?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21737.html) | Ny artikel | Lär dig hur du får åtkomst till din AEM i AEM as a Cloud Service med cURL. |
...
| April 2023 | [Kom igång med API-nät](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-developer-app-builder/api-mesh/getting-started-api-mesh.html) | Video | Upptäck hur du använder API-nät på [!DNL Adobe Commerce] och [!DNL Adobe App Builder]. Lär dig hur du installerar [!DNL Adobe App Builder], arbetar med projekt, skapar en omvänd grafisk proxy med mera. <p>Relaterat: Ett nytt [entityId-exempel](https://experienceleague.adobe.com/docs/commerce-merchant-services/catalog-service/mesh.html) lades till i produktdokumentationen för _API Mesh för katalogtjänsten_. |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|----|----|-----------|
| Mars 2023 | [Hur hämtar jag utförliga MTA-loggar?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21659.html) | Ny artikel | Lär dig hur du aktiverar utförliga MTA-loggar. |

...
| Mars 2023 | [Är det möjligt för en kund med AEP-aktiveringslicens att använda händelsevidarebefordran?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21592.html?lang=sv-SE) | Ny artikel | Lär dig hur en kund med en AEP-aktiveringslicens använder händelsevidarebefordran. |
| Mars 2023 | [Hur skyddas AEP-data när de överförs till olika mål?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21593.html?lang=sv-SE) | Ny artikel | Lär dig mer om datasäkerhetsåtgärder för AEP när du skickar data till olika destinationer. |
...
| Mars 2023 | [AAM API-måttdefinitioner för Trait Population ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21616.html?lang=sv-SE) | Ny artikel | Läs mer om API-mått för AAM trait-populationen. |
...
| April 2023 | [SPA - översikt](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/spa-editor/remote-spa/overview.html?lang=sv-SE) | Video | Besök den självstudiekurs i flera delar för utvecklare som vill utöka en befintlig React-baserad (eller Next.js) SPA med redigerbart AEM med AEM SPA Editor. | AEM CS |
...
| April 2023 | [Förhandsgranskning av innehållsfragment](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/how-to/preview.html?lang=sv-SE) | Video | Lär dig hur du använder förhandsgranskning av innehållsfragment för alla författare för att snabbt se hur innehållsändringar påverkar AEM Headless-upplevelser. | AEM CS |
...
| April 2023 | [Autentisera AEM författare med OKTA](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/authentication/okta-saml-integration.html?lang=sv-SE) | Video | Förstå olika konfigurationsinställningar för enkel inloggning med OKTA. | AEM 6.5 |
...
| Mars 2023 | [Hur kommer jag åt din AEM i AEM as a Cloud Service med cURL?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21737.html?lang=sv-SE) | Ny artikel | Lär dig hur du får åtkomst till din AEM i AEM as a Cloud Service med cURL. |
...
| April 2023 | [Kom igång med API-nät](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-developer-app-builder/api-mesh/getting-started-api-mesh.html?lang=sv-SE) | Video | Upptäck hur du använder API-nät på [!DNL Adobe Commerce] och [!DNL Adobe App Builder]. Lär dig hur du installerar [!DNL Adobe App Builder], arbetar med projekt, skapar en omvänd grafisk proxy med mera. <p>Relaterat: Ett nytt [entityId-exempel](https://experienceleague.adobe.com/docs/commerce-merchant-services/catalog-service/mesh.html?lang=sv-SE) lades till i produktdokumentationen för _API Mesh för katalogtjänsten_. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| April 2023 | [Importera och redigera e-postinnehåll från HTML med meddelanderedigeraren](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/email-channel/import-and-author-html-email-content.html?lang=sv-SE) | Uppdaterad video | Lär dig hur du importerar befintligt HTML-innehåll, ändrar designen, lägger till spegelsideslänkar och avbryter prenumerationen samt hur du kodar ditt innehåll. |
| April 2023 | [Beslutshantering - frekvens](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/frequency-capping.html?lang=sv-SE) | Video | Förstå hur frekvensbegränsning för Offer decisioning fungerar. Lär dig hur du konfigurerar frekvensbegränsning för en anpassad händelse och hur du konfigurerar steg genom att definiera frekvensen. |

...
[!DNL Experience League] Live Events är diskussioner med Adobe experter och specialgäster som är viktiga när det gäller att ge dig Adobe-teknik. Se följande schema och delta live eller se tidigare inspelade händelser.

| Händelsedatum | Händelsenamn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| 23 september 2021 | [Experttips som får dina semesterkampanjer att sticka ut](https://www.youtube.com/channel/UCN-7ZEctit8Qu01BWeHQ0Fw) | Livevideohändelse | Precis som det aldrig är för tidigt att börja handla på semester är det aldrig för tidigt att börja planera för en verkligt framgångsrik kampanj för semestermarknadsföring. Med Adobe Campaign kan ni utforma, planera och genomföra kampanjer som får alla era helgdagar att komma till rätta.<br>Men vet du alla tips för att köra kampanjer som avslutar året med en grop? Besök oss för en livediskussion med tre Adobe-experter som har massor av kollektiv expertis på att göra just det. [Information..](https://www.youtube.com/watch?v=bsU1lAv0xes) |
...
Mer videofilmer finns på [Experience League Channel](https://www.youtube.com/channel/UCN-7ZEctit8Qu01BWeHQ0Fw) på YouTube.
...
| Stöd för booleska fält | CJA har nu stöd för booleska fält. [Läs mer](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/behavior.html?lang=sv-SE) | 16 september 2021 |
...
* Ett problem har korrigerats med att AppMeasurementet inte lästes in i appwebbläsare på iOS-enheter. (AN-247942)
...
| September 2021 | [Hitta ditt ID för datafeed](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/data-feeds/find-your-data-feed-id.html?lang=sv-SE) | Video | Ibland kan du behöva kontakta Adobe om det inte går att leverera en datafeed eller om du behöver skicka om en datafeedfil. Det blir bekvämt för kundsupportteamet att hantera sådana förfrågningar om ID:t för [!UICONTROL Data feed] tillhandahålls av kunden. |
...
| September 2021 | [Introduktion till [!UICONTROL Admin Console]](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/admin-console.html?lang=sv-SE) | Video | En översikt på hög nivå över arbetsflödet för åtkomstkontrollhierarkin för Experience Platform. |
...
* **[!DNL Experience Manager as a Cloud Service]**
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * [!UICONTROL Unified Storage Connector]. Använd [!UICONTROL Unified Storage Connector] för att externalisera data som bearbetas i kundhanterade databaser. Du kan till exempel:
         ...
         * Lagra data från Experience Manager [!UICONTROL Workflows] (Experience Manager [!UICONTROL Workflow Variables]) som innehåller känsliga personuppgifter (SPD) i en kundhanterad databas.
      ...
      * [!UICONTROL Analytics for Adaptive Forms]. Du kan nu hämta in och spåra slutanvändarens beteende via Adobe [!UICONTROL Analytics for Adaptive Forms] för att samla in slutanvändarinsikter. Det hjälper er att fatta välgrundade beslut baserat på data för att förbättra slutanvändarens upplevelse.
...
| September 2021 | [Fel vid anslutning till Experience Manager](https://experienceleague.adobe.com/docs/campaign-standard-learn/troubleshooting/error-aem-connection.html?lang=sv-SE) | CAMPAIGN STANDARD / EXPERIENCE MANAGER | Lär dig hur du löser felet `GetAEMContentList` för tjänsten `nms:delivery` vid anslutning från Campaign Standard till Experience Manager. |
...
| — | Den nya betataggen för Advertising Cloud JavaScript använder tjänsten Adobe Experience Cloud ID (ECID) och den gamla `ef_id` och `gsurferid` för att mäta konverteringar. Den nya taggen skapar [cookies från första part från Experience Cloud s_ecid](https://experienceleague.adobe.com/docs/core-services/interface/administration/ec-cookies/cookies-first-party.html?lang=sv-SE) och ger bättre integrering med andra Experience Cloud-produkter.<br><br>Den gamla Advertising Cloud JavaScript-taggen med ITP-mappning kommer att bli inaktuell i september 2021.<br><br>Din kontoansvarige på Adobe kommer att kontakta dig med mer information och implementeringsinstruktioner. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| September 2021 | [Lägger till formulärfält till PDF utan taggar](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/accessibility-series/accessibilitysession6.html?lang=sv-SE) | Video | Denna on-demand-session går vidare till att skapa manuella formulärfält och ytterligare egenskaper för formulärfält. |
| September 2021 | [Lägga till formulärfält i taggade PDF](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/accessibility-series/accessibilitysession5.html?lang=sv-SE) | Video | Denna on-demand-session fokuserar på att lägga till formulärfält till ett PDF som redan är taggat. |
...
| September 2021 | [Skapa en PDF med foton på ett ögonblick](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/photo.html?lang=sv-SE) | Video | I den här 60-sekundersvideosjälvstudiekursen får du lära dig hur du drar och släpper ett gäng JPG på Acrobat-ikonen för att skapa ett PDF. Klicka på Ja om du vill skapa en flersidig PDF. Sedan kan du dra fler JPG filer till sidpanelen för att lägga till fler sidor i PDF. |

...
* **[!DNL Experience Manager as a Cloud Service]**
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * Microsoft® Azure datalageranslutning: Nu kan du [ansluta formulärdatamodellen till Microsoft® Azure Storage](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/use-form-data-model/configure-azure-storage.html). Med den här funktionen kan du hämta och lagra adaptiva formulärdata i Microsoft® Azure Storage som en BLOB.

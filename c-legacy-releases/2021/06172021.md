...
## ![Ikon](/assets/ec_appicon_24.png) Experience Cloud Central UI-komponenter {#ecloud}
...
| ------- | ------- | ------- |
| Stöd för enkel inloggning för Adobe Federated ID | 17 juni 2021 | Om du använder Federated ID:n kan du logga in på Experience Cloud utan att behöva ange en e-postadress eller ett lösenord. Om du vill använda den här funktionen lägger du till **#/sso:@domain** i Experience Cloud-URL:en. <br><br>Anta till exempel att du äger domänen **adobeccustomer.com** och vill logga in på Adobe Analytics. URL:en skulle vara: **https://experience.adobe.com/#/sso:@adobecustomer.com/analytics**. |
| Experience League Search | 1 juni 2021 | Dokumentationssökningen i Experience League har förbättrats. Navigera till [Experience League](https://experienceleague.adobe.com/docs/?lang=sv-SE) och använd fältet **[!UICONTROL Search]** för att hitta självstudiekurser, dokumentation, kurser med mera. |
...
* **17 maj 2021:** [Versionsinformation om datainsamling i Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html?lang=sv-SE) (tidigare Experience Platform Launch)
...
**Fler resurser för Offera decisioningen**
...
* Åtgärdade problem med att vissa data inte skickades i Datan Warehouse (AN-259951; AN-259712; AN-260107; AN-259953)

#### Ytterligare korrigeringar i Adobe Analytics eller CJA

AN-246344; AN-250035; AN-250354; AN-252482; AN-254661; AN-254965; AN-255424; AN-4 256515; AN-257232; AN-257572; AN-257893; AN-258393; AN-259203; AN-259513; AN-2 59614; AN-259665; AN-259931; AN-260074; AN-260085; AN-260147; AN-260190; AN-26 0198; AN-260290; AN-260306 (CJA); AN-260508; AN-260625; AN-260793; AN-260861; AN-2 60938; AN-260945; AN-261149; AN-261317
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Sites as a Cloud Service**
     ...
     Nu kan du verifiera innehåll på ett nytt [förhandsgranskningssteg](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/previewing-content.html?lang=sv-SE) för att simulera det slutliga utseendet och känslan på samma sätt som på Publish-nivå. Den här nya funktionen aktiveras av guiden Hanterade publikationer i Experience Manager Sites, där du kan välja ett publiceringsmål mellan [!UICONTROL Publish] och [!UICONTROL Preview]. Det går sedan att komma åt upplevelser på [!UICONTROL Preview] via en dedikerad URL. Efter valideringen på [!UICONTROL Preview] kan du publicera innehåll från [!UICONTROL Author] till [!UICONTROL Publish] som vanligt. Om du aktiverar tjänsten [!UICONTROL Preview] i Experience Manager as a Cloud Service miljöer kommer den gradvis att byggas ut under de kommande veckorna.
...
* [En-stop-shop för alla bloggar i Experience Manager](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/bd-p/adobe-experience-manager-discussions)
...
* [Adobe Summit 2021 Sneaks med Dan Levy](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2021-sneaks-with-dan-levy/td-p/405865): En gång om året kan anställda på Adobe, från ingenjörer och datavetare till UX-designers och produktchefer, dela med sig av innovativa idéer för att utveckla hur varumärken interagerar med sina kunder. Följ oss på Adobe Sneaks, där vi delar de sju främsta projekten och utnyttjar den senaste tekniken inom områden som AI och lågkodsappar.
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Juni 2021 | [GraphQL beständiga frågor](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/graphql-persisted-queries.html?lang=sv-SE) | Video | Lär dig hur du aktiverar, skapar, uppdaterar och kör beständiga frågor i Experience Manager. |
...
* **Adobe Campaign Classic v7 21.1.3:** Läs mer i [Versionsinformation om Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=sv-SE).

* **Adobe Campaign Standard 21.2:** Läs mer i [Campaign Standardens versionsinformation](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=sv-SE).

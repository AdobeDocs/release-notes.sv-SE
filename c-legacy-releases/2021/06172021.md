...
* **17 maj 2021:** [Versionsinformation om datainsamling i Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html) (tidigare Experience Platform Launch)
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Sites as a Cloud Service**
     ...
     Nu kan du verifiera innehåll på ett nytt [förhandsgranskningssteg](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/previewing-content.html) för att simulera det slutliga utseendet och känslan på samma sätt som på Publish-nivå. Den här nya funktionen aktiveras av guiden Hanterade publikationer i Experience Manager Sites, där du kan välja ett publiceringsmål mellan [!UICONTROL Publish] och [!UICONTROL Preview]. Det går sedan att komma åt upplevelser på [!UICONTROL Preview] via en dedikerad URL. Efter valideringen på [!UICONTROL Preview] kan du publicera innehåll från [!UICONTROL Author] till [!UICONTROL Publish] som vanligt. Om du aktiverar tjänsten [!UICONTROL Preview] i Experience Manager as a Cloud Service miljöer kommer den gradvis att byggas ut under de kommande veckorna.
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Juni 2021 | [GraphQL beständiga frågor](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/graphql-persisted-queries.html) | Video | Lär dig hur du aktiverar, skapar, uppdaterar och kör beständiga frågor i Experience Manager. |
...
* **Adobe Campaign Classic v7 21.1.3:** Läs mer i [Versionsinformation om Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html).

* **Adobe Campaign Standard 21.2:** Läs mer i [Campaign Standardens versionsinformation](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html).

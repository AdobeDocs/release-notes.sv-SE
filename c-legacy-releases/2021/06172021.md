...
* **26 maj 2021:** [Versionsinformation för Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html)
...
* Uppdaterad april 2021 - [Versionsinformation för Offer Decisioning](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html#new)
...
| Juni 2021 | [Implementera interna sökvariabler med Web SDK](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-use-cases/internal-site-search/implement-internal-search-variables-using-web-sdk.html) | Video | Lär dig hur du använder Web SDK för att implementera Adobe Analytics-variabler för en intern användning av söktermspårning. Se dataflödet från sidan till Experience Edge och sedan till Adobe Analytics. |
...
* **Experience Manager as a Cloud Service**
   ...
   * **Adobe Experience Manager as a Cloud Service Foundation**
      ...
      * [API-borttagning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/deprecated-apis.html): En lista över de senaste inaktuella API:erna.
   ...
   * **Experience Manager Sites as a Cloud Service**
     ...
     Du kan nu verifiera innehåll på ett nytt [förhandsgranskningssteg](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/previewing-content.html) för att simulera det slutliga utseendet och känslan på samma sätt som på publiceringsnivån. Den här nya funktionen aktiveras av guiden Hanterade publikationer i Experience Manager Sites, där du kan välja ett publiceringsmål mellan [!UICONTROL Publish] och [!UICONTROL Preview]. Det går sedan att komma åt upplevelser på [!UICONTROL Preview] via en dedikerad URL. Efter valideringen på [!UICONTROL Preview] kan du publicera innehåll från [!UICONTROL Author] till [!UICONTROL Publish] som vanligt. Om du aktiverar tjänsten [!UICONTROL Preview] i Experience Manager as a Cloud Service-miljöer kommer den gradvis att byggas ut under de närmaste veckorna.
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Juni 2021 | [GraphQL beständiga frågor](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/graphql-persisted-queries.html) | Video | Lär dig hur du aktiverar, skapar, uppdaterar och kör permanenta frågor i Experience Manager. |
| Juni 2021 | [Skapar din första servlet i AEM Forms](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/creating-your-first-osgi-bundle/create-servlet.html) | Artikel | Bygg din första försäljningsserver så att du kan sammanfoga data med en formulärmall. |
...
* **Adobe Campaign Standard 21.2:** Läs mer i [Campaign Standard versionsinformation](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html).
...
| Juni 2021 | [Konfigurera trötthetshantering med filter](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/sending-messages/fatigue-management/fatigue-management-using-filters.html) | Campaign Standard | (Video) Lär dig hur du implementerar trötthetshantering i Adobe Campaign med hjälp av filter. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Juni 2021 | [Adobe Acrobat för Google Drive](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/integrations/acrobatandgoogle.html) | Video | Få tillgång till tidsbesparande PDF-verktyg och e-signaturarbetsflöden direkt inifrån Google Drive-appen. |

...
* [Versionsinformation för Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html) (släppt: **21 april 2021**)
...
* Korrigerade ett problem i [Allmänna rapporter](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reporting/general-reports.html#reporting), där en användare skulle välja ett datum i kontrollen **[!UICONTROL For Dates Through]** men rapportdata skulle flyttas en dag. (AAM-57702)
* Korrigerade ett problem i [Administration > Grupper](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/administration-overview.html#create-group), där användare fick ett _Din grupp sparades, men ett fel uppstod när gruppbehörigheterna_ sparades när gruppbehörigheter sparades på grund av timeout. (AAM-57406, AAM-57411)
...
| April 2021 | [Om datastyrning i CDP i realtid för Audience Manager-användare](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-data-gov-for-aam-users.html#other-integrations) | Video | I den här videon visas hur Audience Manager-användare kan använda funktionerna för datastyrning i [!UICONTROL Real-time Customer Data Platform], och en jämförelse görs med vad som var tillgängligt i Audience Manager. Här beskrivs [!UICONTROL Data Usage and Labeling Enforcement] (DULE)-ramverket och var i Platform det kan tillämpas. |
...
| 12 april 2021 | [Skapa en utlösarhändelse i Campaign Standard](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/integrations/triggers/create-a-trigger-event.html) | Campaign Standard | Lär dig hur du skapar en utlösarhändelse i Campaign Standard, som är länkad till en befintlig Experience Cloud-utlösare. |
...
| April 2021 | [Översikt över genereringstaggen för Adobe-dokument](https://experienceleague.adobe.com/docs/document-services/tutorials/docgen/docgentemplates/taggeroverview.html) | Video | Lär dig hur du taggar [!DNL Word]-mallar med Adobe Document Generation Tagger för användning med Adobe Document Generation API. |

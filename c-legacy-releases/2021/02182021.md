...
* [Versionsinformation för Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html?lang=sv-SE). (27 januari 2021)
* [Versionsinformation om Experience Platform Launch](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html?lang=sv-SE). (13 januari 2021)
...
| 4 februari 2021 | [Visa identitetsdiagram](https://experienceleague.adobe.com/docs/platform-learn/tutorials/identities/view-identity-graphs.html?lang=sv-SE) | Video | Så här använder du identitetsdiagramvisningsfunktionen för att söka, utforska och filtrera identitetsdiagram för validering och felsökning. |
...
| 5 februari 2021 | [Skapar Source för korsenhetsdata och autentiserar](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/setup-and-admin/data-sources/creating-a-cross-device-data-source-and-authenticating.html?lang=sv-SE#setup-and-admin) | Video | Lär dig hur du skapar en Source för korsenhetsdata för att lagra CRM-ID:n och data när du hämtar CRM-data från din första part till Audience Manager. I den här videon visas hur du gör det och konfigurerar metoden `setCustomerIDs()` i Experience Platform Launch för inloggningar. |
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * **Headless Content Management Service**
         ...
         * [RemotePage-komponenten](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/remote-page.html?lang=sv-SE): Stöd har lagts till för att visa och redigera externa SPA i AEM med.
...
| 8 februari 2021 | [AEM Sites - WKND-självstudiekurs](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/overview.html?lang=sv-SE) | Självstudiekurs | Välkommen till en självstudiekurs i flera delar som utformats för utvecklare som inte använt Experience Manager tidigare. Den här självstudiekursen går igenom implementeringen av en Experience Manager-sajt för ett påhittat livsstilsmärke, WKND. |
| 1 februari 2021 | [Publicera Assets](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/sharing/publish.html?lang=sv-SE) | Video | Lär dig hur du publicerar resurser och deras återgivningar från Experience Manager Author till AEM Publish. |
| 4 februari 2021 | [Lokal utveckling](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/local-development-environment.html?lang=sv-SE) | Video | Lär dig hur du hämtar och konfigurerar en lokal utvecklingsmiljö med Experience Manager as a Cloud Service SDK. |
| 4 februari 2021 | [Projektstruktur](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/project-structure.html?lang=sv-SE) | Video | Upptäck de bästa sätten att strukturera ett Experience Manager Maven-projekt för AEM as a Cloud Service. |
| 4 februari 2021 | [Migrera Dispatcher-konfigurationer](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/dispatcher-configuration.html?lang=sv-SE) | Video | Översikt över skillnaderna i Dispatcher-konfigurationer samt tips och tricks för att migrera Dispatcher från Adobe Managed Services (AMS) till Experience Manager as a Cloud Service. |
| 2 februari 2021 | [Introduktion till AEM SDK](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/aem-sdk.html?lang=sv-SE) | Video | Använda och konfigurera SDK för Experience Manager as a Cloud Service. |
| 2 februari 2021 | [Vad är AEM Cloud-tjänst](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/what-is-aem-as-a-cloud-service.html?lang=sv-SE) | Video | Se vad Experience Manager as a Cloud Service är och hur det skiljer sig från andra versioner av Adobe Experience Manager. |
| 2 februari 2021 | [Cloud Manager roll](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/cloud-manager.html?lang=sv-SE) | Video | Utforska syftet med [!UICONTROL Cloud Manager] och hur det fungerar med Experience Manager as a Cloud Service. |
...
| 2 februari 2021 | [Analysera testresultat](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/analyze-test-results.html?lang=sv-SE) | Video | Utforska eventuella kompileringsfel i koden och om koden följer vedertagna standarder för Experience Manager as a Cloud Service |
| 2 februari 2021 | [Konfigurera pipelines](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/configure-pipelines.html?lang=sv-SE) | Video | Utforska olika typer av rörledningar i Cloud Manager och hur du konfigurerar dem för ett framgångsrikt projekt. |
| 2 februari 2021 | [Hantera Dispatcher-konfigurationer](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/dispatcher-configurations.html?lang=sv-SE) | Video | Använd vedertagna metoder och exempel för att utforska hur dispatchern arbetar med Experience Manager som Cloud Service och Cloud Manager. |
| 2 februari 2021 | [Kontinuerliga integreringar och Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/continuous-integration.html?lang=sv-SE) | Video | Förstå vedertagna standarder och kontinuerlig integrering med Adobe Cloud Manager. |
| 2 februari 2021 | [Sammanfoga AEM-projekt för distribution med Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/merge-projects.html?lang=sv-SE) | Video | Se hur flera projekt kan sammanfogas till ett enda projekt för distribution till Experience Manager as a Cloud Service med Cloud Manager. |
...
| 8 januari 2021 | [Adobe Cloud Manager-program](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/programs.html?lang=sv-SE) | Video | Cloud Manager-program representerar Experience Manager-miljöer som stöder logiska uppsättningar av affärsinitiativ, som vanligtvis motsvarar en köpt Service level agreement (SLA). |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| 8 februari 2021 | [Översikt över landning - stödresurs](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/overview.html?lang=sv-SE) | Utbildningscenter | Välkommen till utbildningssidan för Adobe Sign. Du hittar ett brett urval av undervisningsmaterial som fokuserar på Adobe Sign. Våra självstudiekurser, webbinarier och användningsfall är utformade för att snabbt få både nybörjare och administratörer att komma igång med Adobe Sign. |
...
| 29 januari 2021 | [CCE Quick Reference Guides](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/cceoverview/overview-ref.html?lang=sv-SE) | Snabbstödlinjer | Få snabb tillgång till referensguider som lär dig nya funktioner i Creative Cloud. |

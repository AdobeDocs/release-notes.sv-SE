...
* **Inloggningsuppdatering:** En uppdatering till Experience Cloud tar bort introduktionsskärmen för Experience Cloud-inloggning. Från och med 4 februari skickas du direkt från `https://experience.adobe.com/login` till inloggningsskärmen i Adobe.
...
* [Versionsinformation för Experience Platform Launch](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html). (13 januari 2021)
...
| 10 februari 2021 | [Konfigurera Azure-blobbmålet](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configure-the-azure-blob-destination.html#destinations) | Video | Lär dig hur du går igenom de steg som krävs för att konfigurera och konfigurera Azure Blob Storage-mål i Real-time Customer Data Platform (CDP i realtid). |
...
| 13 januari 2021 | [Introduktion till Offera decisioningen Komma igång med för marknadsförare](https://video.tv.adobe.com/v/330520?quality=12&learn=on) | Video | Och introduktion till Offera decisioningen Getting Started with för marknadsförare. |
...
Läs mer om de senaste funktionerna, förbättringarna och korrigeringarna i versionsinformationen för [Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html).
...
| ----------- | ---------- | ----- |
| Analysis Workspace - komponentval | 4 februari 2021 | Komponenten för nedrullningsbar/släppzon i [!UICONTROL Quick Insights] har lagts till i alla släppzoner i [!UICONTROL Workspace]. Den här förbättringen gör att du kan välja från en nedrullningsbar lista med kompatibla komponenter eller fortsätta att använda utrymmet som en släppzon. |
| CJA API | 18 februari 2021 | CJA API:erna är nu tillgängliga. Med dessa API:er kan du programmässigt redigera komponenter och hämta rapporter. Mer information finns i [CJA API-dokumentationen](https://www.adobe.io/cja-apis/docs). |
...
| 5 februari 2021 | [Skapar Source för korsenhetsdata och autentiserar](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/setup-and-admin/data-sources/creating-a-cross-device-data-source-and-authenticating.html#setup-and-admin) | Video | Lär dig hur du skapar en Source för korsenhetsdata för att lagra CRM-ID:n och data när du hämtar CRM-data från första part till Audience Manager. I den här videon visas hur du gör det och ställer in metoden `setCustomerIDs()` i Experience Platform Launch för inloggningar. |
...
>[!NOTE]
>
>Adobe rekommenderar att du besöker sidan [Experience Manager release updates and roadmap](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/home.html) för att få aktuell information om releaser.
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * **Headless Content Management Service**
         ...
         * [RemotePage-komponenten](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/remote-page.html): Stöd har lagts till för att visa och redigera externa SPA i AEM.
...
* [as a Cloud Service versionsinformation för Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/home.html)
...
* [Experience ManagerAssets Dynamic Media versionsinformation](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/release-notes/s7rn2017.html)
...
| 8 februari 2021 | [AEM Sites - WKND-självstudiekurs](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/overview.html) | Självstudiekurs | Välkommen till en självstudiekurs i flera delar för utvecklare som är nybörjare i Experience Manager. Den här självstudiekursen går igenom implementeringen av en Experience Manager-sajt för ett fiktivt livsstilsmärke, WKND. |
| 1 februari 2021 | [Publish Assets](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/sharing/publish.html) | Video | Lär dig hur du publicerar resurser och deras återgivningar från författaren till Experience Manager till AEM Publish. |
...
| 4 februari 2021 | [Migrera Dispatcher-konfigurationer](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/dispatcher-configuration.html) | Video | Översikt över skillnaderna i Dispatcher-konfigurationer samt tips och tricks för migrering av Dispatcher från Adobe Managed Services (AMS) till Experience Manager as a Cloud Service. |
...
| 2 februari 2021 | [Vad är AEM Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/what-is-aem-as-a-cloud-service.html) | Video | Upptäck vad Experience Manager as a Cloud Service är och hur det skiljer sig från andra versioner av Adobe Experience Manager. |
...
| 2 februari 2021 | [Kontinuerliga integreringar och Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/continuous-integration.html) | Video | Förstå bästa praxis och kontinuerlig integrering med Adobe Cloud Manager. |
| 2 februari 2021 | [Sammanfoga AEM projekt för distribution med Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/merge-projects.html) | Video | Se hur flera projekt kan sammanfogas till ett och samma projekt för distribution till Experience Manager as a Cloud Service med Cloud Manager. |
...
| 2 februari 2021 | [Innehållspublicering](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/content-publishing.html) | Video | Se hur innehållspublicering i Experience Manager as a Cloud Service fungerar, inklusive koncept för innehållsdistribution och Adobe. |
...
* [as a Cloud Service stödlinjer för Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html)
...
* [Versionsinformation om Campaign Classic](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html)
...
| 29 januari 2021 | [Snabbreferensguider för CCE](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/cceoverview/overview-ref.html) | Snabbstödlinjer | Få snabb tillgång till referensguider som hjälper dig att lära dig nya funktioner i Creative Cloud. |

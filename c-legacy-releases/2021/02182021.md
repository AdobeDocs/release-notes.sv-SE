...
* [Versionsinformation för Experience Platform Launch](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html?lang=sv-SE). (13 januari 2021)
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * **Headless Content Management Service**
         ...
         * [RemotePage-komponenten](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/remote-page.html?lang=sv-SE): Stöd har lagts till för att visa och redigera externa SPA i AEM.
...
| 8 februari 2021 | [AEM Sites - WKND-självstudiekurs](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/overview.html?lang=sv-SE) | Självstudiekurs | Välkommen till en självstudiekurs i flera delar för utvecklare som är nybörjare i Experience Manager. Den här självstudiekursen går igenom implementeringen av en Experience Manager-sajt för ett fiktivt livsstilsmärke, WKND. |
| 1 februari 2021 | [Publish Assets](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/sharing/publish.html?lang=sv-SE) | Video | Lär dig hur du publicerar resurser och deras återgivningar från författaren till Experience Manager till AEM Publish. |
...
| 4 februari 2021 | [Migrera Dispatcher-konfigurationer](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/dispatcher-configuration.html?lang=sv-SE) | Video | Översikt över skillnaderna i Dispatcher-konfigurationer samt tips och tricks för migrering av Dispatcher från Adobe Managed Services (AMS) till Experience Manager as a Cloud Service. |
...
| 2 februari 2021 | [Vad är AEM Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/what-is-aem-as-a-cloud-service.html?lang=sv-SE) | Video | Upptäck vad Experience Manager as a Cloud Service är och hur det skiljer sig från andra versioner av Adobe Experience Manager. |
...
| 2 februari 2021 | [Kontinuerliga integreringar och Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/continuous-integration.html?lang=sv-SE) | Video | Förstå bästa praxis och kontinuerlig integrering med Adobe Cloud Manager. |

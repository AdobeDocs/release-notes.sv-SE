...
[Experience Cloud tjänster och administration](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=sv-SE) innehåller kundattribut, målgruppsbibliotek ([!UICONTROL People] tjänst), aktivering, användar- och produkthantering samt Experience Cloud cookies.
...
| -----------| ---------- | ---------- | ---------- |
| 26 februari 2021 | [Övervaka dataflöde i Adobe Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/data-monitoring.html?lang=sv-SE#data-ingestion) | Lär dig övervaka och spåra data som hämtas in till Adobe Experience Platform med hjälp av plattformens gränssnitt och API. |
| 10 februari 2021 | [Konfigurera Azure-blobbmålet](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configure-the-azure-blob-destination.html?lang=sv-SE#destinations) | Video | Lär dig gå igenom de steg som krävs för att konfigurera och konfigurera Azure Blob Storage-destinationen i kunddataplattformen i realtid (CDP i realtid). |
...
| 3 februari 2021 | [Översikt över överföring av gruppdata](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/batch-ingestion-overview.html?lang=sv-SE) | Video | Översikt över batchdatainmatning i Adobe Experience Platform. Lär dig hur du importerar batchdata med API:t. |
...
| 31 januari 2021 | [Läs in data i JupyterLab-anteckningsböcker](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-science-workspace/load-data-in-jupyterlab-notebooks.html?lang=sv-SE) | Video | Läs mer om JupyterLab i Data Science Workspace. |
| 12 januari 2021 | [Skapa kopplingsprofiler](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/create-merge-policies.html?lang=sv-SE) | Video | Lär dig hur du skapar sammanfogningsprinciper i Adobe Experience Platform. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| 11 februari 2021 | [Autentiserar till AEM as a Cloud Service från ett externt program](https://experienceleague.adobe.com/?lang=sv&recommended=ExperienceManager-D-1-2020.1.aemcs) | Kurs | Lär dig hur ett externt program kan använda [!UICONTROL Local Development Access Tokens] och [!UICONTROL Service Credentials] för att programmässigt autentisera till Experience Manager as a Cloud Service via HTTP. |
| 11 februari 2021 | [Relatera och inte relatera Assets](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/relate-unrelate.html?lang=sv-SE) | Video | Lär dig hur du upprättar och hanterar relationer mellan resurser i Experience Manager. |
...
| 2 februari 2021 | [Arkitektur för AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/architecture.html?lang=sv-SE) | Video | Utforska den underliggande arkitekturen och viktiga delar av Experience Manager as a Cloud Service. Gör djupdykningar i Cloud Manager och API:erna. |
...
| 28 januari 2021 | [Tokenbaserad autentisering till AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/authentication/overview.html?lang=sv-SE#authentication) | Video | Lär dig hur ett externt program kan autentisera och interagera med Experience Manager as a Cloud Service via HTTP med hjälp av åtkomsttoken. |
...
| 8 januari 2021 | [Adobe Cloud Manager-miljöer](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/environments.html?lang=sv-SE) | Video | Cloud Manager-miljöer består av Experience Manager Author, Experience Manager Publish och Dispatcher. Olika miljöer har stöd för roller och kan användas med olika CI/CD-pipeline. Cloud Manager-miljöer har vanligtvis en produktionsmiljö, en scenmiljö och en utvecklingsmiljö. |
...
| 8 januari 2021 | [Tokenbaserad autentisering](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/authentication/overview.html?lang=sv-SE#authentication) | Video | Cloud Manager-program representerar Experience Manager-miljöer som stöder logiska uppsättningar av affärsinitiativ, som vanligtvis motsvarar en köpt Service level agreement (SLA). |

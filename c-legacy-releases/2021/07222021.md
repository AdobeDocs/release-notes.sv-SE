...
* **Versionsinformation om Experience Platform-taggar** (tidigare Experience Platform Launch) [&#x200B; &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html?lang=sv-SE)1 maj 2021
...
* [Versionsinformation för Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html?lang=sv-SE)
...
| Juli 2021 | [Digital Document Publishing med Adobe PDF Embed API](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/ddppdfembedapi.html?lang=sv-SE) | Artikel | Genom att bädda in ett PDF-visningsprogram på dina webbsidor kan du göra det möjligt för användare att visa dokument utan att behöva signera om din HTML och CSS eller förhindra åtkomst till din webbplats. |

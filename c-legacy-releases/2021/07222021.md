...
| ------- | ------- | -------|
| Experience Cloud ![Global sökning](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=sv-SE#globally-search-for-objects-and-entities) | 5 juli 2021 | I den här versionen läggs Journey Orchestration till i sökningen efter affärsobjekt i Experience Cloud, t.ex. segment, datauppsättningar, scheman med mera. |
...
* **Versionsinformation om Experience Platform-taggar** [1 maj 2021](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html?lang=sv-SE) (tidigare Experience Platform Launch)
...
| Juli 2021 | [Komma igång med CDP för marknadsförare i realtid](https://experienceleague.adobe.com/?lang=sv&recommended=ExperiencePlatform-U-1-2021.1.rtcdp) | Kurs | Här får du lära dig allt du behöver för att komma igång med att använda Real-time Customer Data Platform (CDP i realtid) som yrkesverksamma. |
...
Adobe rekommenderar att du besöker [Experience Manager och skickar uppdateringar och färdplaner](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/home.html?lang=sv-SE) regelbundet för att hålla dig uppdaterad om versionsinformation.
...
* **Experience Manager as a Cloud Service**
   ...
   * **Cloud Manager i AEM as a Cloud Service**
      ...
      * På sidan med miljöinformation visas nu flera domännamn för Publish- och Preview-tjänster. Se [Miljöinformation](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-environments.html?lang=sv-SE).
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * [Adobe Asset Link 3.0](https://helpx.adobe.com/se/enterprise/using/adobe-asset-link.html) för Adobe Photoshop, Adobe Illustrator och Adobe InDesign samt Adobe [Adobe Asset Link 2.0](https://helpx.adobe.com/se/enterprise/using/adobe-asset-link-for-xd.html) för Adobe XD är tillgängligt. Det stöder Assets Essentials och möjligheten att automatiskt ansluta till Experience Manager as a Cloud Service eller Assets Essentials.
...
* [as a Cloud Service versionsinformation för Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html?lang=sv-SE)

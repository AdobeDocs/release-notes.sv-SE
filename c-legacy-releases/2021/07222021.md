...
| ------- | ------- | -------|
| Experience Cloud ![Global sökning](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html#globally-search-for-objects-and-entities) | 5 juli 2021 | I den här versionen läggs Journey Orchestration till i sökningen efter affärsobjekt i Experience Cloud, t.ex. segment, datauppsättningar, scheman med mera. |
...
Den senaste versionsinformationen om systemstatusen för Adobe finns i versionsinformationen för [21 maj 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html).
...
* **Versionsinformation om Experience Platform-taggar** [1 maj 2021](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html) (tidigare Experience Platform Launch)
...
* Ett problem med att Workspace-projekt inte öppnades (timeout) har åtgärdats. (AN-247248)
...
AN-160022; AN-186365; AN-234768 (CJA); AN-253041; AN-255098; AN-256319; AN-25656 6; AN-256903; AN-257111; AN-259614; AN-259960; AN-260422; AN-260926; AN-260962; AN-261310; AN-261442; AN-261483 (CJA); AN-261589; AN-261949; AN-262025; AN-2622 95; AN-262330; AN-262348; AN-262356; AN-262461; AN-262462; AN-262465; AN-26288 8; AN-262944; AN-262952; AN-262974; AN-263027; AN-263105; AN-263175; AN-263183; AN-263244; AN-263888; AN-263930; AN-263953
...
Adobe rekommenderar att du besöker [Experience Manager och skickar uppdateringar och färdplaner](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/home.html) regelbundet för att hålla dig uppdaterad om versionsinformation.
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Guides as a Cloud Service**
      ...
      * **Komponentinnehållshanteringssystemet som är inbyggt i molnet** - Experience Manager Guides är tillgängligt as a Cloud Service. Skaffa en miljö där du kan skapa, hantera och leverera dokumentation och innehåll i stor skala.
   ...
   * **Cloud Manager i AEM as a Cloud Service**
      ...
      * På sidan med miljöinformation visas nu flera domännamn för Publish- och Preview-tjänster. Se [Miljöinformation](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-environments.html).
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * [Adobe Asset Link 3.0](https://helpx.adobe.com/se/enterprise/using/adobe-asset-link.html) för Adobe Photoshop, Adobe Illustrator och Adobe InDesign samt Adobe [Adobe Asset Link 2.0](https://helpx.adobe.com/enterprise/using/adobe-asset-link-for-xd.html) för Adobe XD är tillgängligt. Det stöder Assets Essentials och möjligheten att automatiskt ansluta till Experience Manager as a Cloud Service eller Assets Essentials.
   ...
   * **Experience Manager Sites as a Cloud Service**
      ...
      * Publish till förhandsgranskningsnivå visas nu som sidstatus i användargränssnittet för Sites Admin.
      * Publish to Preview Tier nu surface preview URL at end the action and persistent the URL in page properties for later reference.
...
* [as a Cloud Service versionsinformation för Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html)
...
* [Magento Commerce och öppna Source](https://devdocs.magento.com/guides/v2.4/release-notes/bk-release-notes.html)
...
| Juli 2021 | [Skapa ett sekretessavtal med Adobe Document Services API:er](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/nda.html) | Artikel | Lär dig hur du skapar en Microsoft® Word-mall för företagets sekretessavtal. Adobe kostnadsfritt tillägg för Microsoft® Word, Adobe Document Generation Tagger, hjälper dig att infoga taggar för att ange dynamiska värden. Du får också lära dig hur du skickar JSON-data till mallen och skapar ett dynamiskt PDF. Du kan sedan skicka e-postmeddelandet med PDF eller visa det för dina medarbetare i webbläsaren, beroende på dina affärskrav och mål. |
| Juli 2021 | [Hantera säljförslag och kontrakt med API:er för Adobe Document Services](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/sales.html) | Artikel | Lär dig hur du använder dynamiska data och arbetsflöden för att skapa en effektiv process för att skapa säljförslag. |
| Juli 2021 | [Hantera fakturor med Adobe-API:t för dokumentgenerering](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/invoices.html) | Artikel | Lär dig hur du använder Adobe Document Generation API för att automatiskt generera fakturor, lösenordsskydda PDF och leverera en faktura till varje kund. Allt som krävs är lite kunskap om Node.js, JavaScript, Express.js, HTML och CSS. |

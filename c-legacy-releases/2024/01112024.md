...
Förutom de nyligen släppta [trafikfilterreglerna](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/security/traffic-filter-rules-including-waf.html?lang=en), som innehåller de valfria brandväggsreglerna för webbprogram (WAF), finns det en möjlighet att använda [!UICONTROL Configuration Pipeline] för att deklarera och distribuera andra typer av CDN-konfigurationer. Adobe vill veta mer om dina användningsfall, inklusive följande:

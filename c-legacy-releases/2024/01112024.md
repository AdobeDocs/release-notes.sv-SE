...
| ----------| ---------- | ---------- | ---------- |---------- |
| December 2023 | Mobile SDK | [Implementera Adobe Experience Cloud i mobilappar, självstudiekurs](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/overview.html?lang=sv-SE) | Uppdaterad självstudiekurs (flera artiklar) | Lär dig hur du implementerar Adobe [!DNL Experience Cloud]-program i din mobilapp med Adobe [!DNL Experience Platform Mobile SDK]. |
| December 2023 | Platform, Journey Optimizer | [Skapa och skicka push-meddelanden](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-push.html?lang=sv-SE) | Artikel | Lär dig hur du skapar push-meddelanden för mobilappar med [!DNL Experience Platform Mobile SDK] och [!DNL Journey Optimizer]. |
| December 2023 | Mobile SDK, Journey Optimizer | [Skapa och skicka meddelanden i appen](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-inapp.html?lang=sv-SE) | Artikel | Lär dig hur du skapar meddelanden i appen för mobilappar med [!DNL Experience Platform Mobile SDK] och [!DNL Journey Optimizer]. |
| December 2023 | Platform, Journey Optimizer | [Skapa och visa erbjudanden med Beslutshantering](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-offers.html?lang=sv-SE) | Artikel | Lär dig hur du visar erbjudanden från [!DNL Journey Optimizer] [!UICONTROL Decision Management] i dina mobilappar med [!DNL Experience Platform Mobile SDK]. |
| December 2023 | Administrering | [Lägg till produktadministratörer](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/add-product-administrators.html?lang=sv-SE) | Video | Lär dig hur du lägger till nya administratörer för Adobe [!DNL Experience Platform] i [!DNL Admin Console]. Administratörer kan lägga till och hantera ytterligare administratörer, användare, utvecklare och API-autentiseringsuppgifter. |
| December 2023 | Administrering | [Lägg till utvecklare och ge behörigheter till API-autentiseringsuppgifter](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/add-developers.html?lang=sv-SE) | Video | Lär dig hur du lägger till utvecklare i Adobe Experience Platform-baserade program som [!DNL Real-Time Customer Data Platform] och [!DNL Journey Optimizer]. |
| December 2023 | Administrering | [Lägg till användare och hantera behörigheter](https://experienceleague.adobe.com/docs/platform-learn/tutorials/admin/add-users.html?lang=sv-SE) | Uppdaterad video | Lär dig hur du lägger till användare och hanterar behörigheter i Adobe Experience Platform-baserade program som [!DNL Real-Time Customer Data Platform] och [!DNL Journey Optimizer]. |
| December 2023 | Datainsamling | [Skapa en datastream](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/initial-configuration/create-datastream.html?lang=sv-SE) | Video | Lär dig hur du skapar ett datastam i Experience Platform. |
| December 2023 | Datainsamling | [Konfigurera en taggegenskap](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/initial-configuration/configure-tags.html?lang=sv-SE) | Video | Lär dig hur du konfigurerar en taggegenskap i [!UICONTROL Data Collection]-gränssnittet. |
| December 2023 | Datainsamling | [Installera Adobe Experience Platform Mobile SDK](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/app-implementation/install-sdks.html?lang=sv-SE) | Artiklar | Lär dig implementera Adobe [!DNL Experience Platform Mobile SDK] i en mobilapp. |
| December 2023 | Profiler | [Skapa ett beräknat attribut för summan av inköp](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/create-a-computed-attribute-for-sum-of-purchases.html?lang=sv-SE) | Video | Lär dig hur du använder beräknade attribut för att summera de inköpsbelopp som en användare har gjort i flera försäljningskanaler. |
| December 2023 | Datainsamling | [Skapa en taggegenskap](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/create-a-property.html?lang=sv-SE) | Uppdaterad video | Lär dig hur du skapar taggegenskaper för att hantera marknadsföringstaggarna på din webbplats. |
...
| Publicerad | Namn | Typ | Beskrivning |
| ----------| ---------- | ---------- |---------- |
| December 2023 | [Importera exempeldata till Adobe [!DNL Experience Platform]](https://experienceleague.adobe.com/docs/platform-learn/tutorials/import-sample-data.html?lang=sv-SE) | Uppdaterad artikel | Lär dig hur du konfigurerar en sandlådemiljö i Experience Platform med exempeldata. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Januari 2024 | [Dela ett skrivskyddat projekt i [!UICONTROL Analysis Workspace]](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/view-only-projects-in-analysis-workspace.html?lang=sv-SE) | Video | Lär dig hur du delar skrivskyddade [!UICONTROL Workspace]-projekt till användare, och förstå vilka funktioner som är tillgängliga för den här behörighetsnivån. |
| December 2023 | [En praktisk checklista för granskning av din datamordlista](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/admin-tips/audit-your-data-dictionary.html?lang=sv-SE) | Artikel | Förbättra effektiviteten och tillförlitligheten med vår checklista för Adobe [!DNL Analytics] och [!DNL Customer Journey Analytics] [!UICONTROL Data Dictionary]. |
| December 2023 | [Introduktion till konverteringsvariabler (eVars)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/dimensions/introduction-to-conversion-variables-evars.html?lang=sv-SE) | Video | Läs om hur konverteringsvariabler, som också kallas eVars, används i Adobe [!DNL Analytics], inklusive hur de relaterar till konverteringshändelser och skiljer sig från trafikvariabler. |
| December 2023 | [Grundläggande konfiguration av Analytics-tillägget i Experience Platform Tags](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/via-adobe-launch/basic-configuration-of-the-analytics-launch-extension.html?lang=sv-SE) | Video | Se hur du konfigurerar tillägget [!DNL Analytics] i [!DNL Experience Platform]-taggar för en grundläggande plats. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| December 2023 | [CJA-sökningar efter sök- och profildata](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/connections/cja-lookup-data.html?lang=sv-SE) | Video | Lär dig hur du lägger till sökdata i uppslags- och profildatauppsättningar och planerar och mappar nyckelfält. |
...
Du kan använda [Real User Monitoring (RUM) Data Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/content-requests.html?lang=sv-SE#real-user-monitoring-for-aem-as-a-cloud-service) för att aktivera klientsidessamling för AEM as a Cloud Service.
...
Förutom de nyligen släppta [trafikfilterreglerna](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/security/traffic-filter-rules-including-waf.html?lang=sv-SE), som innehåller de valfria brandväggsreglerna för webbprogram (WAF), finns det en möjlighet att använda [!UICONTROL Configuration Pipeline] för att deklarera och distribuera andra typer av CDN-konfigurationer. Adobe vill veta mer om dina användningsfall, inklusive följande:
...
* Med [Cloud Manager anpassade behörigheter](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-permissions.html?lang=sv-SE) kan du skapa anpassade behörighetsprofiler med konfigurerbara behörigheter för att begränsa åtkomst till program, pipelines och miljöer för [!DNL Cloud Manager]-användare.
...
* Bygg behållare har nu stöd för Node.js version 18 för [frontpipelines](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/developing-with-front-end-pipelines.html?lang=sv-SE).
* För nyligen skapade Cloud Manager-program är [det associerade New Relic-underkontot](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/user-access-new-relic.html?lang=sv-SE) inte aktiverat som standard.
...
* Uppdateringar av [byggmiljön](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details.html?lang=sv-SE) som [annonserats och påbörjats med oktober 2023-utgåvan av Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/cloud-manager/2023/2023-10-0.html?lang=sv-SE) har slutförts.
   * Stöd för nod 18 har lagts till för [frontendpipelines och helstacksrörledningar](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html?lang=sv-SE).
   ...
   * Maven uppdaterades till version 3.8.8.
      ...
      * [Adobe rekommenderar](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details.html?lang=sv-SE)-användare att uppdatera sina Maven-databaser så att HTTPS används i stället för HTTP.
...
| December 2023 | [ACC: Token för push-meddelanden har inte tagits emot på MKT-servern (marknadsföring)](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23273.html?lang=sv-SE) | Ny artikel | Lär dig lösningen när du har ett Adobe Campaign Classic-problem där push-meddelandetoken inte tas emot på MKT-servern (marketing). |
| December 2023 | [ACS: Det går inte att ansluta till Adobe [!DNL SFTP] med filöverföringsaktivitet](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23272.html?lang=sv-SE) | Ny artikel | Lär dig lösningen i Adobe Campaign Standard när du ser ett problem där du inte kan ansluta till Adobe [!DNL SFTP] när du använder en filöverföring/nedladdningsaktivitet. |
...
| December 2023 | [Begränsning av konfiguration av flera arbetsflöden för marknadsföringskampanjer](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23013.html?lang=sv-SE) | Ny artikel | Upptäck varför fel inträffar i kampanjer och hur en justering av [!UICONTROL Nature Property] till *[!UICONTROL Not Specified]* kan lösa problemet effektivt. |
| December 2023 | [[!DNL X-Env-sender]  skiljer sig från domänen ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23053.html?lang=sv-SE) | Ny artikel | Lär dig mer i den här detaljerade guiden om hur du åtgärdar problemet när en [!DNL X-Env-sender] skiljer sig från domänen genom att granska vägen till rätt externt konto. |
| December 2023 | [Kunden kan inte ta bort poster från det anpassade schemat](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23001.html?lang=sv-SE) | Ny artikel | Lär dig hur du felsöker problem med borttagning av data i anpassade scheman. |
| December 2023 | [Utlösare för pipeline bearbetas inte](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23014.html?lang=sv-SE) | Ny artikel | Lär dig om en snabb lösning för att korrigera rörliga utlösare som inte bearbetas genom att köra kommandon på varje behållare i den aktuella instansen. |

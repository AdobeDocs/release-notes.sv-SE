...
| Publicerad | Program | Namn | Typ | Beskrivning |
| ----------| ---------- | ---------- | ---------- |---------- |
| Februari 2024 | AEM Sites | [Journalföring och AEM-händelser](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/examples/journaling.html) | Video | Lär dig hur du hämtar den första uppsättningen AEM Events från tidskriften och utforskar information om varje händelse. |
| Februari 2024 | AEM Sites | [AEM Events-bearbetning med Adobe I/O Runtime Action](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/examples/event-processing-using-runtime-action.html) | Video | Lär dig hur du bearbetar mottagna AEM-händelser med Adobe I/O Runtime Action. |
| Februari 2024 | AEM Sites | [Adobe I/O Runtime Action och AEM Events](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/examples/runtime-action.html) | Video | Lär dig hur du tar emot AEM Events med Adobe I/O Runtime Action och se händelseinformation som nyttolast, huvuden och metadata. |
...
| Februari 2024 | AEM CS | [AEM Eventing](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/overview.html?lang=en) | Flera videor | Lär dig mer om AEM Eventing, vad det är, varför och när du ska använda det och exempel på det. |
...
* **Nytt!** [!DNL Campaign Web Interface]: [Nyheter](https://experienceleague.adobe.com/docs/campaign-web/v8/whats-new.html?lang=sv-SE) | [Produktdokumentation](https://experienceleague.adobe.com/docs/campaign-web/v8/campaign-web-home.html)
...
* [!DNL Campaign] Webbgränssnitt: [Nyheter](https://experienceleague.adobe.com/docs/campaign-web/v8/whats-new.html?lang=sv-SE) - [Produktdokumentation](https://experienceleague.adobe.com/docs/campaign-web/v8/campaign-web-home.html?lang=en)

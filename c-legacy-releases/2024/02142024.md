...
| Januari 2024 | [[!DNL OOTB] funktionen `nms.eventHisto.GetMirrorUrl` returnerar inga [!DNL URL] eller returnerar felaktiga [!DNL URL]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23477.html?lang=sv-SE) | Ny artikel | Lär dig hur du löser problemet när du arbetar i ett arbetsflöde med en [!DNL JS]-aktivitet och anropar [!DNL Out-of-the-box (OOTB)] function `nms.eventHisto.GetMirrorUrl`, returnerar ingen [!DNL URL] eller returnerar felaktig [!DNL URL]. |
| Januari 2024 | [Åtkomst till [!DNL SFTP] mappar `/usr/local/neolane/nl6` eller `/usr/local/neolane/nl6/var/`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23493.html?lang=sv-SE) | Ny artikel | Lär dig mer om vad du ska göra om du behöver komma åt [!DNL SFTP] mappar `/usr/local/neolane/nl6` eller `/usr/local/neolane/nl6/var/` i [!DNL Adobe Campaign Classic]. |

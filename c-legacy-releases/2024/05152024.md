...
| ------- | ------- |
| Hjälpsida för prenumeration | <ul><li>En dedikerad hjälpsida som vägleder nya prenumeranter att skapa sin proaktiva meddelandeprofil och sina inställningar.</li><li>Adobe Status översiktssida > Hjälp-menyn har ett nytt menyalternativ ([!UICONTROL How to subscribe]) som pekar på den nya sidan.</li><li>Alla Adobe-ytor som refererar till [!DNL Adobe Status] prenumerationer pekar nu på den nya hjälpsidan.</li></ul> |

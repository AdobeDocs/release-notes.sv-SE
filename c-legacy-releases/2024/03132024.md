...
Lär dig mer om [Content Supply chain](https://business.adobe.com/se/solutions/adobe-genstudio.html), Adobe totallösning för att snabba upp och förenkla ditt innehåll med generativ AI och intelligent automatisering.

+++Information

| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Februari 2024 | [Supply chain-självstudiekurser för innehåll](https://experienceleague.adobe.com/docs/content-supply-chain-learn/tutorials/overview.html?lang=sv-SE) | Videor | Se supply chain självstudiekurser på Experience League. Innehåll supply chain är Adobe totallösning för att snabba upp och förenkla innehåll för supply chain med generativ AI och intelligent automatisering. |
...
* **Varaktiga bloggar av AEM Community-användare**
   * [Så här utlöser du Oak Index via AEM JMX för att starta processen att tillämpa de ändrade indexdefinitionerna](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/how-to-trigger-oak-index-via-aem-jmx-to-start-the-process-of/ba-p/650118?profile.language=sv)
   * [Så här migrerar du inte taxonomier till AEM Assets](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/how-not-to-migrate-taxonomies-to-aem-assets/ba-p/648931?profile.language=sv)
   * [Utforskar AEM dolda ström: Låser upp OSGi-markeringar](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/exploring-aem-s-hidden-power-unlocking-osgi-marvels/ba-p/648162?profile.language=sv)
   * [Problem med att inte indexera AEM 6.5.5 *Åtgärdat*](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/aem-6-5-5-not-indexing-problem-fixed/ba-p/639836?profile.language=sv)
...
| Februari 2024 | AEM Cloud Manager | [AEM Champion Best Practices and Tips - Förbereda och planera en migrering till AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html?lang=sv-SE) | Video | Utforska expertråd och metodtips från er andra AEM-mästare Wilson Faure. I den här videon går han igenom allt krångligt med planering och förberedelser för migrering till AEM as a Cloud Service. |
| Februari 2024 | Experience Manager Sites | [Cloud 5 - Edge-arbetare](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-edge-workers.html?lang=sv-SE) | Video | Upptäck vikten av kvalificerade medarbetare i AEM Sites och Edge Delivery Services och hur ni kan integrera dem med era back end-system. |

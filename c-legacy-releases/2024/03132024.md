...
Lär dig mer om [innehållsleveranskedjan](https://business.adobe.com/solutions/adobe-genstudio.html), Adobe-från-till-end-lösning som snabbar upp och förenklar ditt innehåll med generativ AI och intelligent automatisering.
...
| Februari 2024 | Taggar | [Skapa taggregler](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/build-rules.html) | Video | Lär dig hur du skapar regler så att du kan köra kommandon i taggar. Händelser och villkor avgör när saker ska göras medan åtgärder avgör vad som ska göras. |
...
* **Dynatrace-kunder kan övervaka sin AEM** - [Läs hur](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/dynatrace.html) de begär anslutning till din Dynatrace-miljö för övervakning av programprestanda. New Relic APM, som är tillgängligt för alla kunder, slutar samla in data om Dynatrace är aktiverat.

_Tidigt Adobe-program_

* **RDE-stöd för Front-End-kod som använder webbplatsteman och webbplatsmallar** - [RDE:er ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/rapid-development-environments.html) har nu stöd för front-end-kod som baseras på [webbplatsteman](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/site-creation/site-themes.html) och [webbplatsmallar](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/site-creation/site-templates.html) för tidiga användare. Med RDE:er görs detta med hjälp av ett kommandoradsdirektiv i stället för en [frontendpipeline](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/site-creation/enable-front-end-pipeline.html). Skicka ett e-postmeddelande till [aemcs-rde-support@adobe.com](mailto:aemcs-rde-support@adobe.com) om du vill prova det och ge feedback.

### [!DNL Cloud Manager]

_Nya funktioner_

* Cloud Manager validerar nu förfallodatumen inte bara för [huvudcertifikatet](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html), utan även för mellanliggande certifikat.
...
* **Självbetjäningsåterställning av innehåll** - [En ny självbetjäningsfunktion för innehållsåterställning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/operations/restore.html) erbjuder nu återställning av säkerhetskopiering i upp till sju dagar och är tillgänglig för tidiga användare i utvärderingssyfte med:
...
>[!IMPORTANT]
>
>Adobe rekommenderar att du [uppgraderar till den senaste 1.9.16-versionen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html) av Workfront for Experience Manager förbättrad anslutning.
...
* **Vi presenterar de fullständiga AEM sessionerna och labb på Adobe Summit 2024** - Utforska den omfattande listan över sessioner och workshops för Adobe Summit 2024 AEM den ultimata färdplanen för en djupare AEM upplevelse. Se [https://adobe.ly/3HD1mw3](https://adobe.ly/3HD1mw3).
...
* **Senaste bloggar av AEM användare**
   * [Så här utlöser du Oak Index via AEM JMX för att börja tillämpa de ändrade indexdefinitionerna](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/how-to-trigger-oak-index-via-aem-jmx-to-start-the-process-of/ba-p/650118)
   ...
   * [Utforskar AEM dold strömförsörjning: Låser upp OSGi-nivåers](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/exploring-aem-s-hidden-power-unlocking-osgi-marvels/ba-p/648162)
   * [AEM 6.5.5 Inte indexeringsproblem *Åtgärdat*](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/aem-6-5-5-not-indexing-problem-fixed/ba-p/639836)
...
| Februari 2024 | AEM Cloud Manager | [AEM Champion Best Practices and Tips - Förbereda och planera en migrering till AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html) | Video | Utforska expertråd och metodtips från din AEM kamrat Wilson Faure. I den här videon går han igenom allt krångligt med planering och förberedelser för migrering till AEM as a Cloud Service. |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|--------|---------|---------|
| Februari 2024 | [[!DNL CDN] mallen i [!UICONTROL Application Setup] sparar inte](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23756.html) | Ny artikel | Lär dig mer om lösningen när mallen [!DNL CDN] i [!UICONTROL Application Setup] inte kan sparas. |
| Februari 2024 | [JDK 11 orsakar `NoClassDefFoundError` [!DNL AEM]  6.5](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23581.html) | Ny artikel | Lär dig hur du installerar [!DNL CXF]-paketen externt för att lösa problemet med `NoClassDefFoundError` efter en uppgradering till [!DNL Java™] 11 med [!DNL AEM] 6.5x. |
| Februari 2024 | [Så här kvalificerar du en [!DNL AEM as Cloud Service] supportanmälan](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23750.html) | Ny artikel | Läs mer om hur ni kvalificerar en biljett så att supporten snabbt kan behandla och förstå problemet och vilken information som krävs. |
| Februari 2024 | [Läs om hur du ändrar servern och [!DNL JVM] tidszonen till Europa/Paris i [!DNL AEM as a Cloud Service]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23702.html) | Ny artikel | Läs om hur du ändrar tidszonen Server och [!DNL JVM] till Europa/Paris i [!DNL AEM as a Cloud Service]. |
| Februari 2024 | [Arbetsflödena är inställda på&quot;inte redigerbara&quot; efter koddistributionen](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23531.html) | Ny artikel | Lär dig mer om hur du löser problemet [!DNL AEM] där [!UICONTROL Workflow] visas som&quot;Inte redigerbar&quot; när du har skapat ett arbetsflöde i [!DNL AEM] följt av en koddistribution. Som bästa praxis bör du se till att dina [!UICONTROL Workflow]-modeller i kodbasen är konsekventa i flera miljöer, så att du inte behöver återskapa [!UICONTROL Workflows] per miljö. |
| Februari 2024 | [[!DNL DDoS] attack eller bot overloading [!DNL AEM] med trafik](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23718.html) | Ny artikel | Läs om hur du felsöker problemet genom att aktivera loggning på Dispatcher-nivå och vidtar åtgärder för att förbättra Dispatcher cachning, vilket hjälper till att undvika avbrott orsakade av trafiktoppar. |
| Februari 2024 | [Vanliga problem med tillgångsförslag och lösningar](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23717.html) | Ny artikel | Lär dig mer om de vanligaste [!DNL AEM] frågorna om Assets-konsumtion och hur du analyserar dem, inklusive hög bearbetning, stora volymer, stora [!DNL DAM]-databaser och många samtidiga författare. |
| Februari 2024 | [Maximal gräns för variationer, prestanda och lagringsprincip för [!UICONTROL Content Fragments]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23715.html) | Ny artikel | Lär dig om den maximala gränsen för antalet tillåtna variationer inom en [!UICONTROL content fragment], om flera varianter bidrar till webbplatsens långsamhet och om det finns någon bevarandeprincip för borttagen [!UICONTROL content fragments]. |
| Februari 2024 | [[!UICONTROL Request for Deletion]-arbetsflöde utlöstes vid innehållsborttagning](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23690.html) | Ny artikel | Lär dig mer om när en användare loggar in och tar bort en sida eller resurs i [!DNL AEM], så utlöses arbetsflödet [!UICONTROL Request for Deletion]. |
| Februari 2024 | [[!DNL HTML] filen som lagras i  [!DNL CRX] öppnas inte i webbläsaren, hämtas i stället](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23689.html) | Ny artikel | En [!DNL HTML]-fil som lagras direkt i databasen [!DNL Oak] öppnas inte i webbläsaren. Istället hämtas den i [!DNL AEM 6.1 SP2] och senare versioner. |
| Februari 2024 | [[!DNL Adobe Experience Manager]: `WARN` meddelande av `Scheduler job requested thread pool with name org-apache-sling-sitemap`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23665.html) | Ny artikel | Lär dig mer om problemet när [!DNL AEM 6.5] startas visas `WARN` meddelanden flera gånger i `error.log`. |
| Februari 2024 | [[!DNL Adobe Experience Manager]: Noden med `sling:resourceType=wcm/msm/components/ghost`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23664.html) | Ny artikel | Lär dig mer om problemet när det i vissa fall finns noder med värdet `sling:resourceType`, `wcm/msm/components/ghost`. I den här artikeln beskrivs hur noden skapas. |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|----|----|-----------|
| Februari 2024 | [Det går inte att visa fönstret med leveransmallar korrekt när det är anslutet till [!DNL Campaign Console] via [!DNL VPN]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23622.html) | Ny artikel | Lär dig mer om lösningen för problemet när du ansluter till [!DNL Adobe Campaign Console] via [!DNL VPN], du kan inte se leveransmallsdata i fönstret. |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|----|----|-----------|
| Februari 2024 | [Kapsla in funktioner när uttryck skapas med operatorn &quot;+&quot; ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23749.html) | Ny artikel | Lär dig hur ett funktionsanrop måste kapslas in med parenteser när du använder operatorn &quot;+&quot;. |
...
* Den senaste informationen finns i [mars 2024 - aktuell versionsinformation](https://experienceleague.adobe.com/docs/marketo/using/release-notes/current.html)
...
I [Adobe Pass versionsinformation](https://experienceleague.adobe.com/docs/pass.html) finns information om programversioner, systemkrav, begränsningar, korrigerade problem och kända fel.

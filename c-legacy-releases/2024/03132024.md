...
Lär dig mer om [Content Supply chain](https://business.adobe.com/solutions/adobe-genstudio.html), Adobe totallösning för att snabba upp och förenkla ditt innehåll med generativ AI och intelligent automatisering.

+++Information

| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Februari 2024 | [Supply chain-självstudiekurser för innehåll](https://experienceleague.adobe.com/docs/content-supply-chain-learn/tutorials/overview.html) | Videor | Se supply chain självstudiekurser på Experience League. Innehåll supply chain är Adobe totallösning för att snabba upp och förenkla innehåll för supply chain med generativ AI och intelligent automatisering. |
...
>[!IMPORTANT]
>
>Adobe rekommenderar att du [uppgraderar till den senaste 1.9.16-versionen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html) av den förbättrade anslutningen för Workfront for Experience Manager.
...
| Februari 2024 | Experience Manager Sites | [Dokumentversioner](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions.html) | Video | Lär dig hur du versionshanterar dokument som har skapats med AEM dokumentredigering. |
...
| Februari 2024 | AEM Headless | [Anpassade fält](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-custom-field.html?lang=en) | Video | Lär dig skapa anpassade fält i AEM Content Fragment Editor. |
...
| Februari 2024 | AEM Cloud Manager | [AEM Champion Best Practices and Tips - Förbereda och planera en migrering till AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html) | Video | Utforska expertråd och metodtips från er andra AEM-mästare Wilson Faure. I den här videon går han igenom allt krångligt med planering och förberedelser för migrering till AEM as a Cloud Service. |
| Februari 2024 | Experience Manager Sites | [Cloud 5 - Edge-arbetare](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-edge-workers.html?lang=en) | Video | Upptäck vikten av kvalificerade medarbetare i AEM Sites och Edge Delivery Services och hur ni kan integrera dem med era back end-system. |
...
| Februari 2024 | [Arbetsflödena är inställda på&quot;inte redigerbara&quot; efter koddistributionen](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23531.html) | Ny artikel | Lär dig mer om hur du löser problemet [!DNL AEM] där [!DNL AEM] visas som&quot;Inte redigerbar&quot; när du har skapat ett arbetsflöde i [!UICONTROL Workflow] följt av en koddistribution. Som bästa praxis bör du se till att dina [!UICONTROL Workflow]-modeller i kodbasen är konsekventa i flera miljöer, så att du inte behöver återskapa [!UICONTROL Workflows] per miljö. |

...
Se [kommande aktiviteter](https://experienceleague.adobe.com/events/) eller bläddra i [händelseinspelningar](https://experienceleague.adobe.com/en/docs/events/experience-league-recorded-events/overview) på Experience League.
...
* Cloud Manager validerar nu förfallodatumen inte bara för [huvudcertifikatet](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction), utan även för mellanliggande certifikat.
...
* Det går inte att lägga till avslutande citattecken när du använder Workfront för att söka efter mappar i Experience Manager i `SERVER_ERROR`.

>[!NOTE]
>
>AEM 6.4 upphör nu med utökat stöd. Mer information finns i Adobe [perioder för teknisk support](https://helpx.adobe.com/se/support/programs/eol-matrix.html). Sök efter [versioner som stöds här](https://experienceleague.adobe.com/en/docs).

>[!IMPORTANT]
>
>Adobe rekommenderar att du [uppgraderar till den senaste 1.9.18-versionen](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install) av Workfront for Experience Manager förbättrad anslutning.
...
| April 2024 | AEM Forms | [Infoga data i SharePoint-listan med arbetsflödessteget invoke FDM](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/forms/one-drive/submit-data-sharepoint-list-workflow) | Video | I den här artikeln beskrivs stegen som krävs för att infoga data i SharePoint-listan med hjälp av FDM-steget _invoke_ i AEM arbetsflöde. |
...
| Mars 2024 | AEM CS | [AEM Champion Best Practices and Tips - Åtgärdar vanliga problem vid migrering till AEM as a Cloud Service](https://experienceleague.adobe.com/en/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration-challenges) | Video | Upptäck ovärderliga insikter och bästa metoder som delas av er AEM expert Wilson Faure. I den här videon tar han sig in i vanliga utmaningar som uppstår under övergången till AEM as a Cloud Service, med rekommendationer och experttips som underlättar en smidig och framgångsrik övergång. |
| Mars 2024 | AEM Sites | [Cloud 5 - Publish, avpublicera evenemang i [!DNL Edge Delivery Services]](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-publish-events) | Video | Utforska händelser som utlöses vid publicering och avpublicering i [!DNL Edge Delivery Services] samt användningsexempel och exempel för användning av dessa händelser. |
...
| Mars 2024 | Adobe Cloud Manager | [Lägg till eget domännamn](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/cloud-manager/custom-domain-names) | Video | Lär dig hur du lägger till ett anpassat domännamn på AEM as a Cloud Service webbplats. |
...
Nya [!DNL Workfront] självstudier visar fönsterhändelser på Experience League.

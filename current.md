...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Februari 2026 | [Adobe Analytics-introduktion](https://experienceleague.adobe.com/sv/docs/analytics/analyze/admin-overview/onboard) | Video | Anlita viktiga Adobe-plattformar som stöder Adobe Analytics och hjälper er att lyckas. |
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Februari 2026 | [!DNL AEM CS] | [Översikt över utvecklingsagenten](https://experienceleague.adobe.com/sv/docs/experience-manager-cloud-service/content/ai-in-aem/agents/development/overview) | Video | Läs om hur utvecklingsagenten i AEM analyserar misslyckade pipelines i Cloud Manager och skapar loggar som föreslår kodkorrigeringar och snabbar upp felsökningen. |
| Februari 2026 | [!DNL AEM Assets] | [Adobe-ögonblicksbild](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-snapshot.html?lang=sv-SE) | Video | Adobe Snapshot är ett visuellt demonstrationsverktyg som illustrerar kraftfulla Dynamic Media för optimerad och dynamisk bildleverans. |
| Februari 2026 | [!DNL AEM CS] | [Återställning av innehåll i AEM as a Cloud Service](https://experienceleague.adobe.com/sv/docs/experience-manager-learn/cloud-service/cloud-manager/content-restore) | Video | Lär dig hur du återställer innehåll i AEM as a Cloud Service med den här stegvisa självstudiekursen. Förstå när och hur man effektivt återskapar tidigare innehåll och säkerställer innehållets integritet. |
...
| Januari 2026 | [[!DNL Site-Wide Analysis Tool] rapporten kunde inte öppnas med *400 Ogiltig begäran - begäranhuvud eller cookie för stor* fel](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-27906) | Nya artiklar | Lär dig mer om lösningarna på problemet när [!DNL Site-Wide Analysis Tool]-rapporten inte kan öppnas och visar ett *400-fel med felaktig begäran* eftersom begäranderubriker eller cookies överskrider serverkonfigurationsgränserna i Adobe Commerce Cloud. |
| Januari 2026 | [Felsökning för avancerad rapportering för Adobe Commerce](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-29603) | Nya artiklar | Läs om hur du diagnostiserar och löser problem med avancerad rapportering i Adobe Commerce. |
| Januari 2026 | [[!DNL Cloudflare] timeout och omdirigeringsproblem i Adobe Commerce](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-29759) | Nya artiklar | Lär dig mer om lösningar på problemet när [!DNL Cloudflare]-konfigurationen orsakar timeout och omdirigeringsproblem i Adobe Commerce-miljöer. |
| Januari 2026 | [Databasöverföringen förlorar anslutningen till [!DNL MySQL]](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-29843) | Nya artiklar | Lär dig mer om lösningarna på problemet när databasöverföringen förlorar anslutningen till [!DNL MySQL]. |
| Januari 2026 | [Fel vid aktivering av bildoptimering i Adobe Commerce](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-29890) | Nya artiklar | Lär dig mer om lösningarna på problemet när [!DNL Fastly] Bildoptimering ([!DNL Fastly] IO) är inaktiverat som standard med ett meddelande till kontakten [!DNL Fastly] som aktiverar bildoptimering. |
| Januari 2026 | [Mappbehörighetsproblemet `var/export` i Adobe Commerce för molninfrastruktur](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-29895) | Nya artiklar | Lär dig mer om lösningar på problemet när produktdata inte kan exporteras på grund av filbehörighetsproblem på servern i mappen `var/export/email`. |
...
* Den senaste versionsinformationen finns i [[!DNL Adobe Target] versionsinformation](https://experienceleague.adobe.com/sv/docs/target/using/release-notes/release-notes)
...
* [!DNL Web User Interface]: 27 januari 2026 - [Versionsinformation](https://experienceleague.adobe.com/sv/docs/campaign-web/v8/release-notes/release-notes) | [Produktdokumentation](https://experienceleague.adobe.com/sv/docs/campaign-web/v8/campaign-web-home)
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|----|----|-----------|
| Januari 2026 | [Korrigerar antalet inaktiva profiler i Adobe Campaign Managed Cloud](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-29761) | Ny artikel | Lär dig mer om lösningarna på problemet när flera målmappningar delar samma loggschema, vilket orsakar oväntade ökningar av antalet aktiva profiler i Adobe Campaign Managed Cloud. |
| Januari 2026 | [Campaign Standard: A/B Testing-leveranser väntar fortfarande medan vinnaren väljs](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-29793) | Ny artikel | Lär dig mer om lösningarna på problemet när A/B-tester är klara innan alla varianter levereras till mottagarna. |
| Januari 2026 | [Campaign Classic: Om arbetsflöden exporteras kraschar instansen](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-29792) | Ny artikel | Lär dig mer om lösningarna på problemet när en anpassad kampanjarbetsgång i ett paket kraschar instansen. |
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Februari 2026 | [!DNL Journey Optimizer] | [Skicka direktutskick med resor](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channels/direct-mail-channel/direct-mail-in-journeys.html?lang=sv-SE) | Video | Upptäck hur ni kan utnyttja Direct Mail-kanalen i Adobe Journey Optimizer för att automatisera och schemalägga direktreklam under era resor. |
...
| Februari 2026 | [!DNL Journey Optimizer] | [Skapa en uppslagsdatauppsättning](https://experienceleague.adobe.com/sv/docs/journey-optimizer-learn/trigger-journey-on-form-submission/lookup-dataset) | Video | Skapa en uppslagsdatauppsättning för användning under resan. |
| Februari 2026 | [!DNL Journey Optimizer] | [Skapa push-meddelanden för webben](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channels/push-channel/create-web-push-notifications.html?lang=sv-SE) | Video | Lär dig skapa push-meddelanden på webben i Adobe Journey Optimizer. Nå ut till fler än bara mobila enheter och engagera användarna direkt i webbläsarna. |
...
| Februari 2026 | [!DNL Journey Optimizer] | [Boka ett möte](https://experienceleague.adobe.com/sv/docs/brand-concierge/content/getting-started/meeting-booking) | Video | Läs om bokningen av mötesfunktionerna i Adobe Brand Concierge. I den här videosjälvstudien beskrivs hur kundupplevelsen kan se ut, administratörskonfiguration för att ansluta en kalender och en titt på vissa instrumentpaneler och rapporter. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Februari 2026 | [Använda Account Qualification Agent](https://experienceleague.adobe.com/sv/docs/journey-optimizer-b2b-learn/tutorials/buying-groups/account-qualification-agent) | Video | Lär dig hur du använder Account Qualification Agent i Journey Optimizer B2B edition. |
...
Se [2026.01 - Versionsinformation](https://experienceleague.adobe.com/sv/docs/genstudio-for-performance-marketing/user-guide/release-notes#latest) för GenStudio for Performance Marketing

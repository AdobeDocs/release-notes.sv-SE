...
| -----------| ---------- | ---------- | ---------- |
| Februari 2024 | [Tutorials för innehållsleveranskedja](https://experienceleague.adobe.com/docs/content-supply-chain-learn/tutorials/overview.html) | Videor | Visa självstudiekurser för innehållsleveranskedjan på Experience League. Innehållsförsörjningskedjan är en totallösning för Adobe som snabbar upp och förenklar innehållsförsörjningskedjan med generativ AI och intelligent automatisering. |
...
* [30 januari 2024](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2024/02142024.html#status)
...
* Information om medlemskap i användargrupper är nu tillgänglig för varje roll när du visar en användares lista över roller på fliken Roller. The **[!UICONTROL Remove Role]** är inaktiverat för användare som har tilldelats en roll via en användargrupp.
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Februari 2024 | Taggar | [Lägga till och konfigurera taggtillägg](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/add-and-configure-extensions.html) | Video | Lär dig hur du lägger till och konfigurerar tillägg i taggegenskapen. Tillägg är färdigpaketerade&quot;appar&quot; som du installerar på din webbplats för att ge dig den spårning, personalisering eller andra funktioner du behöver. |
| Februari 2024 | Taggar | [Skapa dataelement](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/create-data-elements.html) | Video | Lär dig hur du skapar dataelement för att lagra värden som hämtas från datalagret och gör dem tillgängliga för regler och tillägg i taggegenskapen. |
| Februari 2024 | Taggar | [Skapa märkordsregler](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/build-rules.html) | Video | Lär dig hur du skapar regler så att du kan köra kommandon i taggar. Händelser och villkor avgör när saker ska göras medan åtgärder avgör vad som ska göras. |
| Februari 2024 | Taggar | [Bygga och publicera ett taggbibliotek](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/build-and-publish-a-library.html) | Video | Lär dig hur du skapar ett bibliotek i taggegenskaperna och gör ändringar i utvecklings-, staging- och produktionsmiljöer. Lär dig hur du kan använda flera utvecklingsmiljöer för att hjälpa flera team att uppdatera egenskapen i parallella arbetsflöden. |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|----|----|-----------|
| Februari 2024 | [[!UICONTROL Default Value Ingestion] in [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23641.html) | Ny artikel | Lär dig mer om hur du behöver ange ett standardvärde vid förtäring i [!DNL Adobe Experience Platform (AEP)], särskilt för [!DNL upsert] måste du använda explicita mappningar i dataöverföringsprocessen. |
...
| Publicerad | Program | Namn | Typ | Beskrivning |
| ----------| ---------- | ---------- | ---------- |---------- |
| Februari 2024 | Experience Manager Assets | [Starta arbetsflöden automatiskt](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/auto-start-workflows.html) | Video | Lär dig hur autostartarbetsflöden förbättrar materialbearbetningen i [!DNL AEM as a Cloud Service] genom att automatiskt anropa ett anpassat arbetsflöde vid överföring eller ombearbetning när resursbearbetningen är klar. |
| Februari 2024 | Experience Manager Sites | [Konfigurera dokumentredigering](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/set-up.html) | Video | En guide om hur du ställer in dokumentredigering för författare. |
| Februari 2024 | Experience Manager Sites | [Dokumentarbetsflöden](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-workflows.html) | Video | Lär dig hur du använder dokumentarbetsflöden med AEM dokumentredigering. |
| Februari 2024 | Experience Manager Sites | [Dokumentversioner](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions.html) | Video | Lär dig hur du versionshanterar dokument som har skapats med AEM. |
| Februari 2024 | AEM CS | [Cloud 5 - tredjepartssökning](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-3rd-party-search.html) | Video | Se hur tredjepartssökning bäst kan integreras i Edge Delivery Services. |
| Februari 2024 | Experience Manager Assets | [AEM Assets event for PIM integration](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/examples/assets-pim-integration.html) | Video | Lär dig hur du integrerar AEM Assets med ett tredjepartssystem, t.ex. ett PIM-system (Product Information Management) eller PLM-system (Product Line Management), för att uppdatera metadata för tillgångar med hjälp av AEM IO-händelser. |
| Februari 2024 | AEM Headless | [Anpassade fält](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-custom-field.html?lang=en) | Video | Lär dig hur du skapar anpassade fält i AEM Content Fragment Editor. |
...
| Februari 2024 | AEM CS | [Cloud 5 - Real User Monitoring (RUM)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-rum.html?lang=en) | Video | Utforska den analys av Real user monitoring (RUM) som Adobe erbjuder AEM sajter som levereras med Edge Delivery Services och hur RUM kan användas för att förbättra en webbplats. |
| Februari 2024 | Experience Manager Forms | [Generera PDF med data från blankettinlämning som bygger på kärnkomponenter](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/generate-pdf-from-core-component-form-submission.html) | Video | Sammanfoga data från inskickade kärnkomponentbaserade formulär med XDP-mallar i arbetsflödet. |
| Februari 2024 | AEM Cloud Manager | [AEM Champion Best Practices and Tips - Förbereda och planera en övergång till AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html) | Video | Utforska expertråd och metodtips från din AEM kamrat Wilson Faure. I den här videon navigerar han i de knepiga rutinerna med planering och förberedelser för migrering till AEM as a Cloud Service. |
| Februari 2024 | Experience Manager Sites | [Cloud 5 - Edge-arbetare](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-edge-workers.html?lang=en) | Video | Upptäck vikten av gränsarbetare i AEM Sites och Edge Delivery Services och hur ni kan integrera dem med era back end-system. |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|--------|---------|---------|
| Februari 2024 | [[!DNL CDN] mall i [!UICONTROL Application Setup] sparar inte](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23756.html) | Ny artikel | Lär dig mer om lösningen när [!DNL CDN] mall i [!UICONTROL Application Setup] kan inte sparas. |
| Februari 2024 | [JDK 11 orsakar `NoClassDefFoundError` [!DNL AEM] 6.5](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23581.html) | Ny artikel | Läs om hur du installerar [!DNL CXF] paket externt för att lösa problemet med `NoClassDefFoundError` efter en uppgradering till [!DNL Java™] 11 [!DNL AEM] 6,5x. |
| Februari 2024 | [Så här kvalificerar du en [!DNL AEM as Cloud Service] Supportbiljett](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23750.html) | Ny artikel | Läs mer om hur ni kvalificerar en biljett så att supporten snabbt kan behandla och förstå problemet och vilken information som krävs. |
| Februari 2024 | [Läs om hur du ändrar servern och [!DNL JVM] tidszon till Europa/Paris i [!DNL AEM as a Cloud Service]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23702.html) | Ny artikel | Läs om hur du ändrar servern och [!DNL JVM] tidszon till Europa/Paris i [!DNL AEM as a Cloud Service]. |
| Februari 2024 | [Arbetsflödena är inställda på&quot;inte redigerbara&quot; efter koddistributionen](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23531.html) | Ny artikel | Lär dig hur du löser problemet med [!DNL AEM] problem där efter att ha skapat ett arbetsflöde i [!DNL AEM] följt av en koddistribution, [!UICONTROL Workflow] visas som&quot;Inte redigerbar&quot;. Som bästa praxis bör du behålla [!UICONTROL Workflow] i kodbasen som är konsekvent i olika miljöer, så du behöver inte skapa om [!UICONTROL Workflows] per miljö. |
| Februari 2024 | [[!DNL DDoS] överlastning av attacker eller robotar [!DNL AEM] med trafik](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23718.html) | Ny artikel | Lär dig hur du felsöker det här problemet genom att aktivera loggning på Dispatcher-nivå och vidtar åtgärder för att förbättra Dispatcher-cachning, vilket hjälper till att undvika avbrott orsakade av trafiktoppar. |
| Februari 2024 | [Vanliga problem med tillgångsintag och lösningar](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23717.html) | Ny artikel | Läs om de vanligaste [!DNL AEM] Scenarier om tillgångsintag och hur de analyseras, inklusive hög bearbetning, stora volymer, stora [!DNL DAM] -databaser och många samtidiga författare. |
| Februari 2024 | [Högsta tillåtna gräns för variationer, prestanda och lagringspolicy för [!UICONTROL Content Fragments]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23715.html) | Ny artikel | Läs om maxgränsen för antalet tillåtna variationer inom en enda [!UICONTROL content fragment], om flera varianter bidrar till webbplatsens långsamhet och om det finns någon lagringspolicy för borttagna [!UICONTROL content fragments]. |
| Februari 2024 | [[!UICONTROL Request for Deletion] arbetsflöde som utlöses när innehåll tas bort](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23690.html) | Ny artikel | Lär dig mer om när en användare loggar in och tar bort en sida eller resurs i [!DNL AEM], &quot;[!UICONTROL Request for Deletion]&quot; aktiveras. |
| Februari 2024 | [[!DNL HTML] fil som lagras i [!DNL CRX] öppnas inte i webbläsaren, hämtas i stället](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23689.html) | Ny artikel | A [!DNL HTML] -filen som lagras direkt i [!DNL Oak] databasen öppnas inte i webbläsaren. Istället laddas den ned i [!DNL AEM 6.1 SP2] och senare versioner. |
| Februari 2024 | [[!DNL Adobe Experience Manager]: `WARN` meddelande om `Scheduler job requested thread pool with name org-apache-sling-sitemap`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23665.html) | Ny artikel | Läs mer om problemet när [!DNL AEM 6.5] startup, `WARN` visas flera gånger i `error.log`. |
| Februari 2024 | [[!DNL Adobe Experience Manager]: Noden med `sling:resourceType=wcm/msm/components/ghost`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23664.html) | Ny artikel | Lär dig mer om problemet i vissa fall, noder med en `sling:resourceType` värde för `wcm/msm/components/ghost` finns. I den här artikeln beskrivs hur noden skapas. |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|--------|---------|---------|
| Februari 2024 | [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/support-tools/patches/patches-available-in-qpt-tool-overview.html) | Nya artiklar | Nya artiklar om hur du använder korrigeringsfiler som finns i [!DNL QPT] 1.1.4, [!DNL QPT] 1.1.45 och [!DNL QPT] 1.1.46 publicerades och finns i respektive avsnitt. |
| Februari 2024 | [Flera rader i databasen för samma enhet](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/database/multiple-rows-in-database-for-same-entity.html) | Nya artiklar | Den här artikeln innehåller en lösning på problemet där det finns flera rader för samma enhets-ID i databasen. |
| Februari 2024 | [Recommendations [!DNL JS] fel efter uppgradering till Adobe Commerce version 2.4.5](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/recommendations-js-errors-after-upgrade-to-adobe-commerce-version-2-4-5.html) | Nya artiklar | I den här artikeln finns en fix för när det efter uppgraderingen till Adobe Commerce (alla distributionsmetoder) finns [!DNL JS] fel i konsolen som rör Recommendations-produktmoduler/enheter. |
...
* [!DNL Campaign Web Interface]: [Nyheter](https://experienceleague.adobe.com/docs/campaign-web/v8/whats-new.html?lang=en) | [Produktdokumentation](https://experienceleague.adobe.com/docs/campaign-web/v8/campaign-web-home.html)

* [!DNL Campaign] v8.6: [Versionsinformation](https://experienceleague.adobe.com/docs/campaign/campaign-v8/releases/release-notes.html) | [Produktdokumentation](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaign-home.html?lang=en)
...
| Februari 2024 | Webbanvändargränssnitt för Campaign | [Utforska gränssnittet Campaign Web User](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/getting-started/explore-the-web-ui.html) | Video | Lär dig hur du får åtkomst till och navigerar i Campaign Web User Interface och hur du anpassar lagerlistorna. Upptäck den AI-baserade kunskapsassistenten. |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|----|----|-----------|
| Februari 2024 | [Kan inte se fönstret med leveransmallar korrekt när det är anslutet till [!DNL Campaign Console] via [!DNL VPN]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23622.html) | Ny artikel | Läs mer om lösningen på problemet när du ansluter till [!DNL Adobe Campaign Console] via [!DNL VPN]kan du inte se leveransmallsdata i fönstret. |
...
### Nytt [!DNL Journey Optimizer] supportdatabas

Nya artiklar och uppdateringar av befintliga artiklar för [!DNL Journey Optimizer].

| Publicerad | Namn | Typ | Beskrivning |
|---------|----|----|-----------|
| Februari 2024 | [Kapsla in funktioner när du skapar uttryck med operatorn &quot;+&quot;](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23749.html) | Ny artikel | Lär dig hur ett funktionsanrop måste kapslas in med parenteser när du använder operatorn &quot;+&quot;. |
...
| Publicerad | Program | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |---------- |
| Februari 2024 | [!DNL Adobe Firefly] | [Upptäck Adobe Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/discover.html?lang=en) | Video | Upptäck Adobe Firefly framtiden för kreativitet med generativ AI, utformad för kommersiell säkerhetsanvändning och innovation. |
| Februari 2024 | [!DNL Adobe Firefly] | [Landningssida](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/landing-page.html?lang=en) | Video | Lär dig hur du börjar använda Adobe Firefly. |
| Februari 2024 | [!DNL Adobe Firefly] | [Generativ fyllning](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-fill.html?lang=en) | Video | Lär dig hur du använder Generativ fyllning för att lägga till, expandera eller ta bort innehåll från bilder på ett icke-förstörande sätt med enkla textrutor. Generativ fyllning gör att du kan förbättra din kreativitet och skapa extraordinära projekt. |
| Februari 2024 | [!DNL Adobe Firefly] | [Generativ omfärgning](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-recolor.html?lang=en) | Video | Lär dig hur du omedelbart förhandsgranskar olika färgvariationer för produktförpackningar, affischer eller bilder i vektorfiler. Med en generativ omfärgning kan du färga om så snabbt du kan skriva. Experimentera med idéer utanför väggen, designa runt olika teman eller paletter och ta fram olika varianter i en handvändning. |
| Februari 2024 | [!DNL Adobe Firefly] | [Exempel på hur du använder Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/examples.html?lang=en) | Video | Lär dig hur du kan använda Firefly för att skapa inspirerande PowerPoint-presentationer, humörtavlor, idéer, skärmsläckare med mera. |
| Februari 2024 | [!DNL Adobe Firefly] | [Texteffekter](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/text-effects.html?lang=en) | Videor | Lär dig hur du skapar unik och inspirerande text för dina projekt med enkla textmeddelanden. Med texteffekter kan du öka din kreativitet och skapa extraordinär text för dina projekt. |

...
**Uppdateringar från 21 oktober 2025**: Mer information finns i [[!DNL Experience Platform] versionsinformationen](https://experienceleague.adobe.com/en/docs/experience-platform/release-notes/latest).
...
| Oktober 2025 | [!DNL Experience Platform] | [Journey Agent - översikt](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/ai-assistant/journey-agent-overview) | Video | Journey Agent använder AI för att skapa, analysera och optimera B2B/B2C-resor via ett konversationsgränssnitt. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Oktober 2025 | [Introduktion till klassificeringsuppsättningar](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/components/classifications/introduction-to-classification-sets) | Video | Lär dig hur klassificeringsuppsättningar ger dig ytterligare rapporter och insikter om dina data. |
| Oktober 2025 | [Använd klassificeringsuppsättningar i Adobe Analytics](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/components/classifications/use-classification-sets) | Video | Lär dig hur du använder klassificeringsmetoder i Adobe Analytics. |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|--------|---------|---------|
| September 2025 | [Så här aktiverar du **Logga rapportbyggardatablocket till webbkonsolen** och hämta begäranden/svar i Report Builder](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27442) | Ny artikel | Lär dig hur du använder felsökningsinställningar i Report Builder och hur du kan logga klient-/serverdata till webbkonsolen. |
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Oktober 2025 | [!DNL AEM Assets] | [Snabbare införande genom utbildning och aktivering](https://experienceleague.adobe.com/en/perspectives/accelerating-adoption-through-training-and-enablement) | Perspektiv | Få rekommendationer om hur man skapar och delar intuitiva självbetjäningsverktyg för användare. För Digital Asset Managers. |
...
| Oktober 2025 | [!DNL AEM Assets] | [GenAI-metadata](https://experienceleague.adobe.com/en/docs/experience-manager-learn/assets/metadata/genai-metadata) | Video | Läs om hur AEM Assets as a Cloud Service använder Adobe GenAI för att generera och förstärka metadata för mediefiler för att underlätta hantering och identifiering av innehåll. |
| Oktober 2025 | [!DNL AEM Assets] | [Attributbaserad åtkomstkontroll i Content Hub](https://experienceleague.adobe.com/en/docs/experience-manager-learn/assets/content-hub/attribute-based-access-control) | Video | Lär dig hur du ställer in och styr åtkomst till resurser i AEM Assets Content Hub med hjälp av attributbaserad åtkomstkontroll (ABAC). |
| Oktober 2025 | [!DNL AEM CS] | [Om Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/experience-hub/experience-hub) | Video | Ta reda på mer om sidan Adobe Experience Hub. |
| Oktober 2025 | [!DNL AEM CS] | [Dela resurser och samlingar i AEM Assets Content Hub](https://experienceleague.adobe.com/en/docs/experience-manager-learn/assets/content-hub/share) | Video | Lär dig hur du delar resurser och samlingar med teammedlemmar i AEM Assets Content Hub, vilket främjar effektivt lagarbete och säker delning av resurser. |
...
| Oktober 2025 | [!DNL AEM Forms] | [Listrutan Cascading](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/build-forms/universal-editor/cascading-drop-down-list/introduction) | Självstudiekurs | Använd API-integrering för att dynamiskt fylla i en nedrullningsbar lista. |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|--------|---------|---------|
| September 2025 | [Teckensnitt återges inte korrekt i AEM 6.5 HTML5 Forms](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27574) | Ny artikel | Läs mer om lösningarna på problemet när XDP-mallar återges som HTML5 Forms i AEM 6.5 Forms. Teckensnitten kan inte visas korrekt, särskilt på datorer utan de teckensnitt som krävs installerade lokalt. |
| September 2025 | [Problem med förhandsgranskning av video i AEM 6.5 + DMS7](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27496) | Ny artikel | Lär dig mer om lösningarna på problemet när en AEM 6.5-författare är konfigurerad att replikera till DMS7, men resurser kan inte förhandsgranskas med DMS7-visningsprogram. |
| September 2025 | [Undertexter/undertexter kan läggas till i videofilmer i AEM, men de behandlas inte/replikeras till DMS7](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27586) | Ny artikel | Lär dig mer om lösningar på problemet när undertexter kan läggas till i videofilmer i AEM, men få inte behandling/replikering till DMS7. |
| September 2025 | [Dynamic Media Assets Delivery API-kort är inaktiverat i Developer Console](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27210) | Ny artikel | Lär dig mer om lösningar på problemet när Assets Delivery API-kortet inte är synligt eller tillgängligt i Adobe Developer Console i Adobe Experience Manager (AEM) Dynamic Media/Scene7-miljöer där OpenAPI är aktiverat. |
| September 2025 | [Konfigurera en anpassad domän för leverans av dynamiska mediefiler i AEM Cloud](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27330) | Ny artikel | Lär dig hur du konfigurerar en anpassad domän för Dynamic Media-leverans i Adobe AEM Cloud. |
| September 2025 | [Massöverföring av bilder till AEM Dynamic Media misslyckas med felet *Inte ett filformat som stöds*](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27467) | Ny artikel | Lär dig mer om lösningarna på problemet när massbildöverföringar till Adobe Experience Manager (AEM) Dynamic Media eller Scene7 misslyckas med fel som *inte ett filformat som stöds* eller *inte ett giltigt format*, även om bilderna är giltiga JPG-/JPEG-filer. |
| September 2025 | [Det går inte att läsa in eller hämta videoklipp och återgivningar i AEM Brand Portal](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27490) | Ny artikel | Lär dig mer om lösningarna på problemet när videor som publiceras från Adobe Experience Manager (AEM) till Brand Portal utlöser ett *fel som inte kan läsa in data* vid åtkomst, eller dynamiska återgivningar som hämtas som skadade eller ofullständiga filer. |
| September 2025 | Knappen [**[!UICONTROL Quick Publish]**saknas i AEM Cloud-tjänsten på grund av att administratörsprofilen har bytt namn ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27545) | Ny artikel | Lär dig mer om lösningarna på problemet när användare som tilldelats administratörsproduktprofilen förlorar åtkomst till knapparna **[!UICONTROL Quick Publish]** och **[!UICONTROL Manage Publish]** om standardprofilnamnet ändras i Admin Console i Adobe Experience Manager (AEM) as a Cloud Service - Webbplatser. |
| September 2025 | [HTTP 503-fel på grund av inkompatibel S3-anslutning i AEM SP22/SP23 ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27567) | Ny artikel | Lär dig mer om lösningarna på problemet när AEM inte är tillgängligt efter uppgradering till Service Pack 2 eller 23 med S3-datastore aktiverat. |
| September 2025 | [Adobe Experience Manager: Kopiera och klistra in en behållare visar duplicerade komponenter](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27594) | Ny artikel | Lär dig mer om lösningarna på problemet i AEM 6.5.20 och AEM 6.5.21. När du kopierar en behållarkomponent och klistrar in den i sidredigeraren kan det se ut som om den inklistrade behållaren har sina inre komponenter duplicerade. |
| September 2025 | [Åtkomst nekad vid användning av kommandot `aio app use` i AEM via Adobe I/O](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27689) | Ny artikel | Lär dig mer om lösningarna på problemet i Adobe Experience Manager (AEM) som är integrerat med Adobe I/O. Ett *403 Forbidden* -fel visas när du försöker använda kommandot `aio app use`. |
| September 2025 | [Assets hoppades över i DXML-efterbearbetning på grund av cachelagring i AEM Guides](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27717) | Ny artikel | Lär dig mer om lösningar på problemet när resurser i AEM Guides inte bearbetas korrekt, till exempel saknade metadata, brutna ämneslänkar eller ofullständiga utdatainställningar. |
| September 2025 | [Enkel inloggning misslyckas efter uppgradering av AEM från SP18 till SP22](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27221) | Ny artikel | Läs mer om lösningarna på problemet efter att du uppgraderat Adobe Experience Manager (AEM) från Service Pack 18 till Service Pack 2, så slutar enkel inloggning (SSO) att fungera. |
| September 2025 | [Det går inte att söka efter specialtecken i Adobe Experience Manager](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27562) | Ny artikel | Lär dig mer om lösningar på problemet i AEM när sökning misslyckas när metadata för resurser innehåller specialtecken som hakparenteser (`[` eller `]`). |
| September 2025 | [Tidsgränsen för inaktiv SSO-session fungerar inte i AEM](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27606) | Ny artikel | Lär dig mer om lösningar på problemet i Adobe Experience Manager (AEM) - lokalt när tidsgränsen för inaktiv session inte fungerar när du loggar in via en anpassad enkel inloggningsinställning (SSO). |
| September 2025 | [Otillräcklig servervalidering i AEM-profiluppdatering](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27715) | Ny artikel | Lär dig mer om lösningar på problemet i Adobe Experience Manager (AEM) när författaren av CMS tillåter profiluppdateringar via [!UICONTROL Touch UI] utan att tvinga fram robust validering på serversidan. |
| September 2025 | [Adobe Sign-schemaläggaren körs inte på publiceringsinstansen i AEM 6.5 adaptive Forms](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27561) | Ny artikel | Lär dig mer om lösningar på problemet när schemaläggaren i Adobe Sign inte körs på publiceringsinstansen i AEM 6.5 adaptive Forms. |
| September 2025 | [AEM Admin-gränssnittet fungerar inte efter URL- eller IP-ändring](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27568) | Ny artikel | Lär dig mer om lösningarna på problemet när användargränssnittet i AEM Admin kan bli oåtkomligt efter migrering till en ny server eller uppdatering av IP- eller FQDN (fullständigt kvalificerat domännamn). |
| September 2025 | [Inaktuella resursvarningar inträffar efter snabb publicering i AEM 6.5 Forms](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27573) | Ny artikel | Lär dig mer om lösningarna på problemet när du snabbt publicerar på sidor med adaptiv Forms i AEM 6.5 Managed Services. Det finns föråldrade resursmeddelanden även om dessa resurser precis publicerats. |
| September 2025 | [Teckensnitt återges inte korrekt i AEM 6.5 HTML5 Forms](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27658) | Ny artikel | Läs mer om lösningarna på problemet när XDP-mallar återges som HTML5 Forms i AEM 6.5 Forms. Teckensnitten kan inte visas korrekt, särskilt på datorer utan de teckensnitt som krävs installerade lokalt. |
| September 2025 | [Assets visar inte förhandsgranskning i AEM DAM](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27420) | Ny artikel | Läs mer om lösningarna på problemet när Assets som överförts till Adobe Experience Manager (AEM) Managed Services inte visar förhandsvisningar eller miniatyrbilder i Prod/Dev/Stage-miljöerna. |
| September 2025 | [Brand Portal-fel i publiceringsserverloggar](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27511) | Ny artikel | Lär dig mer om lösningar på problemet när Brand Portal-fel inträffar i publiceringsserverloggar. |
| September 2025 | [Utgångna resurser och [!DNL DMwOpenAPI]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27607) | Ny artikel | Lär dig mer om tillgängliga alternativ för anpassning/konfigurering för att anpassa beteendet för förfallodatum i AEM Assets och [!DNL DMwOpenAPI]. |
| September 2025 | [AEM Forms FDM-fel: `Data Model [table_name] not present in the source`](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27470) | Ny artikel | Lär dig mer om lösningarna på problemet när felet `Data model: [table_name] not present in the source` i AEM Forms inträffar när det inte finns några matchningar mellan redigerings- och publiceringsmiljöerna eller om det saknas metadata i databasen. |
| September 2025 | [Det går inte att skapa dokumentfragment i AEM Forms 6.5](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27500) | Ny artikel | Lär dig mer om lösningar på problemet när brev inte kan genereras på grund av att dokumentfragment saknas i AEM Forms 6.5 på [!DNL WebSphere]. |
| September 2025 | [AEM Forms [!DNL JEE] PDF-generering misslyckas på grund av teckensnittsproblem](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27506) | Ny artikel | Lär dig mer om lösningar på problemet när PDF inte kan genereras i AEM Forms 6.5 på grund av felaktiga inställningar för teckensnittskatalog i AEM Forms 6.5. |
| September 2025 | [*WFLYEJB0378: Det gick inte att hämta ett tillstånd inom 5 MINUTES*-fel i AEM Forms  [!DNL JEE] ([!DNL JBoss])](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27518) | Ny artikel | Lär dig mer om lösningarna på problemet när du anropar AEM Forms på [!DNL JEE]-tjänster (t.ex. via axeln/SOAP-slutpunkter), misslyckas ibland anrop med ett timeout-fel. |
| September 2025 | [Fel *ALC-DSC-099-000* vid import av LCA i AEM Forms](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27572) | Ny artikel | Läs mer om lösningarna på problemet när du importerar ett `.lca`-program till AEM Forms. Felet *ALC-DSC-099-000* uppstod på grund av ett *401* -problem med obehörig åtkomst. |
| September 2025 | [Fragment som inte löses i [!UICONTROL Output Service] OSGi API i AEM](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27703) | Ny artikel | Lär dig mer om lösningar på problemet i Adobe Experience Manager Forms as a Cloud Service (AEMFaaCS) när fragmentreferenser i XDP-filer inte kan lösas när du använder OSGi-API:t [!UICONTROL Output Service]. |
| September 2025 | [Åtgärda 404 fel för AEM [!DNL Maven] databas](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27517) | Ny artikel | Lär dig mer om lösningar på problemet i Adobe Experience Manager (AEM) On-Premise v6.5 Development-miljöer när ett *404* -fel inträffar vid åtkomst till [!DNL Maven]-databasen på `https://repo.adobe.com/nexus/content/groups/public`. |
| September 2025 | [AEM skapar inte live-kopior av Experience Fragments](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27079) | Ny artikel | Lär dig mer om lösningarna på problemet när Adobe Experience Manager (AEM) inte kan skapa live-kopior av Experience Fragments. |
| September 2025 | [Åtkomstproblem med `/apps/groovyconsole` i AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27124) | Ny artikel | Lär dig mer om lösningarna på problemet när försök att bevilja åtkomst till sökvägen `/apps/groovyconsole` misslyckas som [!DNL Groovy Console]. |
| September 2025 | [Åtgärdar problem med klientdomänroutning i AEM as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27285) | Ny artikel | Lär dig mer om lösningar på problemet i AEMaaCS när klientdomänroutning misslyckas när dispatchergrupper är felkonfigurerade, vilket gör att begäranden standardställs till fel servergrupp. |
| September 2025 | [Ikonen Punktlista tar bort innehåll vid kapsling av listor i nytt AEM Guides-gränssnitt](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27314) | Ny artikel | Läs mer om lösningarna på problemet i användargränssnittet i Adobe Experience Manager-guiderna (AEM) när du använder punktlistikonen för att skapa kapslade listor för att ta bort befintligt innehåll. |
| September 2025 | [GraphQL `includeVariations` returnerar tomt med filter i AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27468) | Ny artikel | Lär dig mer om lösningar på problemet i AEMaaCS när parametern `includeVariations:true` i en GraphQL-fråga returnerar tomma resultat när ett ytterligare filter (till exempel: `_path`) används. |
| September 2025 | [Dynatrace visar inte CPU och minnesanvändning i AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27476) | Ny artikel | Läs om lösningarna på problemet i AEMaaCS när Dynatrace inte visar CPU- och minnesstatistik för Author- och Publish-instanser. |
| September 2025 | [Utgående API-anrop använder inkonsekventa IP-adresser i AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27478) | Ny artikel | Lär dig mer om lösningar på problemet i AEMaaCS när utgående HTTP-begäranden från anpassad [!DNL Sling Servlets] som använder [!DNL Apache HttpClient] inte når externa slutpunkter. |
| September 2025 | [Publicerade resurser returnerar 404 på Edge Delivery Services (AEMaaCS)](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27519) | Ny artikel | Lär dig mer om lösningarna på problemet när publicerade resurser returnerar *404 (Hittades inte)*-fel på Edge Delivery Services. |
| September 2025 | [`TagManager.resolve` returnerar null i AEM as a Cloud Service Publisher](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27532) | Ny artikel | Lär dig mer om lösningar på problemet i AEMaaCS Publisher-miljö när anrop till `TagManager.resolve` returnerar null, men samma logik fungerar korrekt i AEM 6.5 eller författarmiljön. |
| September 2025 | [Anpassade svarshuvuden visas inte i AEM Publish-instanser](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27551) | Ny artikel | Lär dig mer om lösningar på problemet när anpassade svarshuvuden inte visas i AEM Publish-instanser. |
| September 2025 | [Det går inte att kopiera resurser eller mappar med dubblettnamn i det nya AEM-gränssnittet](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27552) | Ny artikel | Lär dig mer om lösningar på problemet i AEMaaCS - Assets när det nya användargränssnittet blockerar kopieringsåtgärder när det redan finns ett objekt med samma namn i målmappen. |
| September 2025 | [Visningsförinställningar visas inte i AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27566) | Ny artikel | Lär dig mer om lösningar på problemet i AEMaaCS - Assets när sidan [!UICONTROL Viewer Presets] inte kan läsa in förinställningar och visar ett skadat användargränssnitt. |
...
| September 2025 | [Fel vid import av ett metadatamatchemaformulär i [!UICONTROL Asset View]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27535) | Ny artikel | Lär dig mer om lösningar på problemet i AEMaaCS när du försöker importera ett anpassat metadatamatchschema till [!UICONTROL Asset View]. Processen misslyckas om formuläret innehåller fälttyper som inte stöds. |
| September 2025 | [Åtgärda inaktuella miljövariabler i AEM Cloud Manager](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27437) | Ny artikel | Lär dig mer om lösningar på problemet i AEMaaCS - webbplatser där vissa egenskaper inte visar ändringarna när du försöker uppdatera en konfigurationsfil. |
| September 2025 | [AEM: IP-tillåtelselista **[!UICONTROL Save]** fungerar inte i Cloud Manager](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27421) | Ny artikel | Lär dig mer om lösningarna på problemet i AEMaaCS när du lägger till eller uppdaterar IP-tillåtelselista i Cloud Manager, knappen **[!UICONTROL Save]** är fortfarande inaktiverad eller ändringarna tillämpas inte efter att du klickat på **[!UICONTROL Update]**. |
| September 2025 | [Åtgärda *403*-fel vid överföring av innehållsfragment via AEM API](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27438) | Ny artikel | Lär dig mer om lösningar på problemet i AEMaaCS när ett *403 Forbidden* -fel inträffar när innehållsfragment överförs till `/sites/cf/fragments` API:t. |
| September 2025 | [Formuläret för resurshämtningsrapport misslyckas på grund av ett tomt datumfält i AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27540) | Ny artikel | Lär dig mer om lösningar på problemet i AEMaaCS - Assets när fältet **[!UICONTROL Adjust Date]** inte är markerat som obligatoriskt i [!UICONTROL Asset Download Report], vilket orsakar överföringsfel. |
| September 2025 | [Det går inte att ta bort inaktiva användare från användargrupper och arbetsflöden i AEM Cloud](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27541) | Ny artikel | Läs mer om lösningar på problemet i AEMaaCS - Webbplatser där användare som är inaktiverade i Identity Management System (IMS) fortfarande får e-postmeddelanden om arbetsflöden. |
| September 2025 | [**[!UICONTROL Add to Cart]**fungerar inte för konfigurerbara produkter på  [!DNL Venia] webbplatsen](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27554) | Ny artikel | Lär dig mer om lösningarna på problemet när funktionen **[!UICONTROL Add to Cart]** för konfigurerbara produkter misslyckas på demowebbplatsen [!DNL Venia] som skapats med AEMaaCS när [!DNL AEM Reference Demos Add-on] används. |
| September 2025 | [Felsöka precisionsfel i stora tal-beräkningar med Adaptive Forms i Adobe Experience Manager 6.5](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27642) | Ny artikel | Lär dig mer om lösningarna på problemet när Adaptive Forms i AEM 6.5 inte ger korrekta resultat för beräkningar med stora tal och fyrdecimal precision. |
| September 2025 | [Experience Fragment-erbjudande som visar en oönskad domänsökväg i Adobe Target](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27491) | Ny artikel | Lär dig mer om lösningarna på problemet när du integrerar [!UICONTROL Experience Fragments] från Adobe Experience Manager (AEM) med Adobe Target, så visar den [!UICONTROL View Offer Content]-URL som visas i Adobe Target en oönskad domänsökväg. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Oktober 2025 | [Adobe LLM Optimizer](https://experienceleague.adobe.com/en/docs/llm-optimizer/using/home) | Självstudiekurs | Lyft varumärket med Adobe LLM Optimizer. Spåra omnämnanden, identifiera insikter och dominera AI-driven sökning. Ta kontroll över din synlighet - börja optimera nu! |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Oktober 2025 | [Projekt- och miljöhantering i Adobe Commerce Cloud](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/adobe-commerce-cloud/project-environment-management) | Video | Lär dig mer om Adobe Commerce Clouds projekt- och miljöhanteringsgränssnitt. |
...
| September 2025 | [Distributionsfel vid uppgradering till [!DNL OpenSearch] 1.3 Adobe Commerce i molninfrastruktur](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-25526) | Nya artiklar | Lär dig mer om lösningarna på problemet när det uppstår distributionsfel efter uppgradering av [!DNL OpenSearch] från version 1.2 till 1.3 i Adobe Commerce i molninfrastruktur. |
| September 2025 | [Åtgärd krävs: Kritisk säkerhetsuppdatering för Adobe Commerce (APSB25-88)](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27397) | Nya artiklar | Lär dig mer om programfixen för att åtgärda säkerhetsluckan CVE-2025-54236 i Adobe Commerce. |
| September 2025 | [Konfigurera [!DNL Fastly] hastighetsbegränsningar i Adobe Commerce för molninfrastruktur](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27428) | Nya artiklar | Lär dig mer om lösningarna på problemet när [!DNL Fastly]s hastighetsbegränsande inställning i Adobe Commerce för fördröjning av molninfrastruktur returnerar HTTP-fel *429 (gränsen överskreds)* när tröskelvärdena överskrids. |
| September 2025 | [Adobe Commerce [!DNL REST] Injektionsändringar för API-konstruktorparametrar - Handbok för marknadsföringsutvecklare](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27501) | Nya artiklar | Lär dig mer om hur [!DNL REST] API:er hanterar konstruktorparameterinjektion i Adobe Commerce och Magento Open Source. |
| September 2025 | [Fel vid stängning av ofullständiga order i Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27512) | Nya artiklar | Lär dig mer om lösningarna på problemet när felet *Produkten som begärdes inte finns. Kontrollera produkten och försök igen.* inträffar när försök görs att stänga order som refererar till borttagna eller uppdaterade produkter i Adobe Commerce i molninfrastrukturen. |
| September 2025 | [Adobe Commerce: [!DNL MySQL] Frågor som har fastnat i **Väntar på certifieringsläge** orsakar prestandaproblem](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27579) | Nya artiklar | Lär dig mer om lösningarna på problemet när längre perioder i läget **Väntar på certifiering** i [!DNL MySQL] orsakar prestandamässiga flaskhalsar i Adobe Commerce. |
| September 2025 | [Åtgärda saknade `customer_grid_flat`-tabellfel i Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27592) | Nya artiklar | Lär dig mer om lösningarna på problemet när det i tabellen `customer_grid_flat` saknas fel i Adobe Commerce 2.4.5 när överlappande omindexeringsprocesser både tar bort och återskapar `customer_gridtable` samtidigt, vilket orsakar `SQLSTATE[ 42S02]` -fel. |
| September 2025 | [E-postmeddelanden markeras som skräppost eller levereras inte i Adobe Commerce-molnet](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27596) | Nya artiklar | Lär dig mer om lösningarna på problemet när e-postmeddelanden med välkomstmeddelanden eller orderbekräftelser landar i skräppost eller inte levereras i Adobe Commerce i molninfrastruktur. |
| September 2025 | [Verifierar klusterstorleksändring i Adobe Commerce via New Relic](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27611) | Nya artiklar | Lär dig hur du validerar om ett kluster har ändrat storlek i New Relic för Adobe Commerce på Managed Services. |
| September 2025 | [`Invalid customer address ID`-fel i Adobe Commerce](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27622) | Nya artiklar | Lär dig mer om lösningar på problemet när felet `Invalid customer address ID` inträffar på grund av inkonsekventa data i tabellen `quote` i Adobe Commerce. |
| September 2025 | [Det går inte att ansluta till en Adobe Commerce-integreringsmiljö (SSH-/prestandaproblem)](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27623) | Nya artiklar | Lär dig mer om lösningarna på problemet när du inte kan ansluta till en Adobe Commerce Integration-miljö eller har prestandaförluster. |
| September 2025 | [Det går inte att ansluta till [!DNL RabbitMQ] i Adobe Commerce i molninfrastruktur](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27688) | Nya artiklar | Lär dig mer om lösningarna på problemet när tjänsten [!DNL RabbitMQ] inte kan ansluta, vilket resulterar i ett anslutningsfel som inte stöds i Adobe Commerce i miljöer för utveckling av molninfrastruktur eller integrering. |
| September 2025 | [Flera rader i databasen för samma entitet](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27726) | Nya artiklar | Lär dig mer om lösningar på problemet där det finns flera rader för samma enhets-ID i databasen. |

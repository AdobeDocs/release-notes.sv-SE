...
Se [Versionsinformation för AppMeasurement för JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html). Version 2.19.0 släpptes 21 februari 2020.
...
| Funktion | Beskrivning |
|----|----|
| [Aktivitetsanvändningsrapportering](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/activity-usage-reporting.html) | [!UICONTROL Activity Usage Report] hjälper dig att visa och spåra aktivitetsanvändningen för din Audience Manager-instans, vilket ger dig en tydlig uppfattning om hur din aktivitetsanvändning ser ut jämfört med ditt avtalsenliga åtagande. |
...
* Korrigerade ett fel som gjorde att användargränssnittet bröts vid navigering genom det algoritmiska modellgenereringsflödet (AAM-37942).
...
* **Självstudiekurser för Experience Manager as a Cloud Service**

  Kom igång snabbt med [självstudiekurserna för Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html).
...
Se [Generera flera interaktiva kommunikationer med hjälp av batch-API:t](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/generate-multiple-interactive-communication-using-batch-api.html).

* **Plattformar som stöds för AEM Forms i JEE**

  Stöd för Oracle 19c för AEM Forms på JEE-kunder har lagts till.
Se [Plattformar som stöds för AEM Forms i JEE](https://experienceleague.adobe.com/docs/experience-manager-65/forms/install-aem-forms/jee-installation/aem-forms-jee-supported-platforms.html).

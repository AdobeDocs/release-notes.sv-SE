...
* [Versionsinformation om Experience Platform Data Collection](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html?lang=sv-SE) (tidigare Experience Platform Launch) - uppdaterad **2 april 2021**
...
| Maj 2021 | [Anpassa menyer i rapporter och analyser](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/customize-menus.html?lang=sv-SE) | Video | Lär dig hur du använder rapporter och analyser för att få tillgång till dina data. Även om Analysis Workspace rekommenderas för analys kan det vara bra att använda rapporter och analyser för att anpassa menyerna så att du snabbt får tillgång till exakt de data du behöver. |
| Maj 2021 | [Anpassa kalenderinställningar i Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/customize-calendar-settings.html?lang=sv-SE#administration) | Video | Lär dig några tips och tricks samt hur du anpassar din kalender i Adobe Analytics. |
| Maj 2021 | [Konfigurera alternativen Inget värde i datavyer](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/configure-no-value-options-in-data-views.html?lang=sv-SE) | Video | Under konfigurationen av [!UICONTROL Data Views] i Customer Journey Analytics kan du välja om _inget värde_ ska visas i dina rapporter och ändra hur du vill visa värdets namn. |
| Maj 2021 | [Inkludera eller exkludera mätvärden i datavyer](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/include-or-exclude-metric-values-in-data-views.html?lang=sv-SE) | Video | Lär dig hur du skapar och konfigurerar nya mätvärden som är delmängder av andra mätvärden, samt de användningsexempel som kan göra detta till ett kraftfullt analysverktyg i [!UICONTROL Data Views]. |
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Administratörer kan konfigurera Experience Manager att ta bort resurskällan efter att ha gjort en massresursinmatning. Se [massinläsning av resurser](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html?lang=sv-SE#asset-bulk-ingestor).
      * När du utför en hälsokontroll för att importera resurser i grupp ger Experience Manager nu mer information om orsaker till fel. Se [massinläsning av resurser](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html?lang=sv-SE#asset-bulk-ingestor).
...
* **[Adobe Summit 2021 Sneaks med Dan Levy](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2021-sneaks-with-dan-levy/td-p/405865?profile.language=sv)**

  En gång om året har alla anställda på Adobe, från ingenjörer och datavetare till UX-designers och produktchefer, möjlighet att dela innovativa idéer för att utveckla hur varumärken interagerar med sina kunder. Följ oss på Adobe Sneaks, där de sju främsta projekten delas, där alla trycker på den senaste tekniken inom områden som AI (Artificial Intelligence) och lågkodsappar. Se [alla sessioner här](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2021-complete-aem-session-list/td-p/398344?profile.language=sv).

* **[Experience League Communities startar Gamification](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/experience-league-communities-launches-the-gamification/td-p/405366?profile.language=sv)**

  Adobe är *entusiastiskt* att släppa [*ett helt nytt sätt att göra saker*](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-cloud-blogs/new-experience-league-community-game-features-and-faqs/ba-p/405291?profile.language=sv) här i Experience League Community! Se [fullständig information här](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/experience-league-communities-launches-the-gamification/td-p/405366?profile.language=sv).

* **[Adobe Summit 2021 | Fullständig sessionslista för Experience Manager &#x200B;](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2021-complete-aem-session-list/td-p/398344?profile.language=sv)**

  På begäran av Adobe-kunder finns en sammanställd lista över alla Experience Manager-sessioner på **Adobe Summit 2021**.

* **[Vi presenterar den nya processen att skicka in Experience Manager-funktionsförfrågningar](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/announcing-the-new-process-to-submit-experience-manager-feature/td-p/380425?profile.language=sv)**
...
| 12 april 2021 | [Skapa en utlösarhändelse i Campaign Standard](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/integrations/triggers/create-a-trigger-event.html?lang=sv-SE) | Campaign Standard | Video | Lär dig hur du skapar en utlösarhändelse i Campaign Standard, som är länkad till en befintlig Experience Cloud [!UICONTROL Trigger]. |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Maj 2021 | [Styr din PDF onlineupplevelse och samla in analyser](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfembed/controlpdfexperience.html?lang=sv-SE#part1) | Artikel | Lär dig hur du använder API:t Adobe PDF Embed för att styra utseendet, möjliggöra samarbete och samla in analyser om hur användare interagerar med PDF:er, inklusive hur lång tid som tillbringats på en sida och sökningar. (Fyra delar.) |

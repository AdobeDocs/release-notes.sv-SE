...
| September 2023 | [Översikt över stöd för partnerdata i Real-Time CDP](https://experienceleague.adobe.com/docs/platform-learn/tutorials/partner-data-support/partner-data-support-overview.html?lang=sv-SE) | Video | Läs om hur [!DNL Real-Time Customer Data Platform] stöder fullständig funnel-marknadsföring med partnerdata för databerikning från första part och prospektering eftersom cookies från tredje part fortfarande är inaktuella. |
...
| September 2023 | AEM Forms | [Lagra inskickade formulär i Azure Storage](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/store-form-data-in-azure-storage.html?lang=sv-SE) | Video | Lär dig hur du gör REST-anrop för att lagra skickade AEM Forms-data i Azure Storage. |

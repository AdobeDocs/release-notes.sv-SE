...
| September 2023 | AEM Forms | [Lagra inskickade formulär i Azure Storage](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/store-form-data-in-azure-storage.html?lang=en) | Video | Lär dig hur du gör REST-anrop för att lagra skickade AEM Forms-data i Azure Storage. |

...
| -----------| ---------- | ---------- | ---------- |---------- |
|May 2023|[Configure the [!DNL Adobe Target] destination in [!DNL Real-Time Customer Data Platform]](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/target/configure-the-target-destination.html?lang=sv-SE)|Video |Learn how to configure the Adobe Target destination in [!DNL Real-Time Customer Data Platform] to start sending segments and profile attributes from [!DNL Real-Time CDP] to [!DNL Adobe Target]. |[!DNL Real-Time CDP], [!DNL Adobe Target] |
|May 2023|[Share segments and profile attributes](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/target/activate-segments-and-profile-attributes.html?lang=sv-SE)|Video |Learn how to share segments and profile attributes from Adobe [!DNL Real-Time Customer Data Platform] to [!DNL Adobe Target] to display real-time personalized content in your websites, mobile apps, and other digital properties.|[!DNL Adobe Target] |
|May 2023|[Use Real-time CDP segments in Target](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/target/use-rtcdp-segments-in-target.html?lang=sv-SE)|Video |Learn how to use [!DNL Real-Time Customer Data Platform] segments in [!DNL Adobe Target] to deliver personalized experiences on your website and mobile apps.|[!DNL Adobe Target] |
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Maj 2023 | [Så här beviljar du åtkomstbehörighet till Data Warehouse](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21666.html?lang=sv-SE) | Felsökning | Lär dig vilken behörighet som ska läggas till för att ge Data Warehouse åtkomstbehörighet. |
...
| -----------| ---------- | ---------- | ---------- |
|April 2023|[Error: _Not allowed to delete due to segment sharing enabled_](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21790.html?lang=sv-SE)|New article|Learn how to resolve the _Not allowed to delete due to segment sharing enabled_ error.|
|April 2023|[Unexpected AAM UI access](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21831.html?lang=sv-SE)|New article|Learn how to resolve the issue where users have access to the AAM UI but don't have specific AAM permissions.|
|April 2023|[Bulk export options](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21861.html?lang=sv-SE)|New article|Learn how to export data from [!DNL Audience Manager] in bulk.|
|April 2023|[LiveRamp server-to-server destination](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21926.html?lang=sv-SE)|New article|This article offers an overview of the [!UICONTROL LiveRamp] destination within [!DNL Audience Manager].|
...
* Stöd för nytt protokoll (DASH - Dynamic Adaptive Streaming over HTTP) har startats för adaptiv strömning i Dynamic Media-videoleverans (med CMAF aktiverat):<!-- OLD. UPDATE FOR JUNE 7 -->
   ...
   * Finns i Asien, Stillahavsområdet och Nordamerika; [aktiveras via en supportanmälan](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/video.html?lang=sv-SE#enable-dash). Kommer snart i Europa-Mellanöstern-Afrika.<!-- OLD. UPDATE FOR JUNE 7 -->
...
* **[Integrera med REST-slutpunkter med Open API 3.0](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/use-form-data-model/configure-data-sources.html?lang=sv-SE#configure-restful-services-open-api-specification-version-20-configure-restful-services-swagger-version30)** - Integrera sömlöst i postsystem som stöder Open API 3.0 för att lagra och hämta data med hjälp av formulärdatamodeller.<!-- OLD. UPDATE FOR JUNE 7 -->
...
* Stöd för testning av produkter, funktioner och användargränssnitt har nu utökats till [icke-produktionstestning av pipeline](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/configuring-non-production-pipelines.html?lang=sv-SE). <!-- NEW. LEAVE IN FOR JUNE 7 -->
* Förutom att aktivera testning av uppströms har [stöd för testning av användargränssnitt utökats till att omfatta Cypress-testning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/functional-testing/ui-testing.html?lang=sv-SE).<!-- NEW. LEAVE IN FOR JUNE 7 -->
* [Självbetjäning-innehållskopia](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/content-copy.html?lang=sv-SE) är nu tillgänglig från en högre till en lägre miljö via Cloud Manager användargränssnitt.<!-- NEW. LEAVE IN FOR JUNE 7 -->
...
>[!IMPORTANT]
>
>Adobe rekommenderar att du [uppgraderar till den senaste 1.9.10-versionen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html?lang=sv-SE) av den förbättrade anslutningen för Workfront for Experience Manager. <!-- NEW. LEAVE IN FOR JUNE 7 -->
...
| -----------| ---------- | ---------- | ---------- | ------|
| Juni 2023 | [AEM Headless, första självstudiekurs](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/headless-first/overview.html?lang=sv-SE) | Video | Lär dig hur du skapar ett dynamiskt och interaktivt webbprogram genom att kombinera kraften i React, Adobe [!DNL Experience Manager] Headless API:er och [!DNL GraphQL]. | AEM CS |
| Juni 2023 | [Bädda in ett anpassat formulär utan rubrik](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/embed-form-spa/introduction.html?lang=sv-SE) | Video | Lär dig bädda in ett anpassat formulär på ett headless sätt i [!UICONTROL Single Page Application]. | AEM Forms |
| Juni 2023 | [Konsolen för innehållsfragment](https://experienceleague.adobe.com/docs/experience-manager-learn/content-fragments-console/basics/content-fragments-console.html?lang=sv-SE) | Flera videor | Lär dig mer om grundläggande funktioner och funktioner i [!UICONTROL Content Fragments]-redigeringskonsolen i [!DNL AEM as a Cloud Service]. | AEM Sites |
| Juni 2023 | [Hämta och visa formulären i kortformat](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/embed-form-spa/display-forms-card-view.html?lang=sv-SE) | Video | Hämta formulär utan rubrik med `listForms` API och visa formulären i kortformat. | AEM Forms |
| Juni 2023 | [Adobe IMS-användargrupper](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/accessing/adobe-ims-user-groups.html?lang=sv-SE) | Videor | Adobe IMS-användargrupper skapar logiska uppsättningar av användare som exponeras för AEM, där de kan användas för att definiera finjusteringsbehörigheter för AEM-användare. | AEM CS |
...
| Juni 2023 | [GraphQL videoserie](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/modeling-basics.html?lang=sv-SE) | Video | Lär dig hur du definierar och använder [!UICONTROL Content Fragments] i Adobe Experience Manager (AEM) för användning med GraphQL. | AEM CS |
| Juni 2023 | [Konfigurerar åtkomst till AEM genomgång](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/accessing/walk-through.html?lang=sv-SE) | Video | En förkortad genomgång av konfiguration av Adobe IMS-användare, användargrupper och [!UICONTROL Product Profiles] i [!UICONTROL Admin Console]. Lär dig hur du använder dessa Adobe IMS-abstraktioner i [!UICONTROL AEM Author] för att definiera och hantera specifika gruppbaserade behörigheter. | AEM CS |
...
| Publicerad | Namn | Typ | Beskrivning |
|---------|--------|---------|---------|
| Maj 2023 | [Omdirigering till anpassad inloggningssida från ett AEM OAuth-flödesfel](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21954.html?lang=sv-SE) | Ny artikel | Lär dig varför du behöver dirigera om till en anpassad inloggningssida vid ett flödesfel i AEM `OAuth` och hur du gör det. |
| Maj 2023 | [Pipeline misslyckades med felet _Egenskapen end_aem_createsegmentstore saknas_](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22091.html?lang=sv-SE) | Ny artikel | Lär dig lösningen på problemet när CI/CD-pipeline misslyckas med felet _Egenskapen end_aem_createsegmentstore saknas_. |
| Maj 2023 | [Övervaka en replikeringskö](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22082.html?lang=sv-SE) | Ny artikel | Lär dig hur du övervakar en replikeringskö. |
| Maj 2023 | [Så här rullar du ut en borttagen [!UICONTROL Live Copy]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22081.html?lang=sv-SE) | Ny artikel | Lär dig hur du använder en borttagen [!UICONTROL Live Copy]. |
| Maj 2023 | [Aktivera Brand Portal med autentiseringsuppgifter för OAuth-server-till-server](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22074.html?lang=sv-SE) | Ny artikel | Lär dig varför kunder bör använda JWT-inloggningsmetoden i stället för inloggningsmetoden [!DNL OAuth Sever-to-Server] för att skapa Adobe [!UICONTROL IMS Technical Account Configuration]. |
| Maj 2023 | [Problem med utloggning från AEM även efter SAML SSO-autentisering](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22065.html?lang=sv-SE) | Ny artikel | Lär dig lösningen på problemet där användare inte kan logga ut när AEM autentiseras med SAML enkel inloggning (SSO). |
| Maj 2023 | [Borttagning av NetworkInfrastructure via CM API misslyckas med 405](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22063.html?lang=sv-SE) | Ny artikel | Lär dig lösningen på problemet där det inte går att ta bort `NetworkInfrastructure` via CM API med 405. |
| Maj 2023 | [Det går inte att extrahera innehåll via migreringsuppsättningen](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22031.html?lang=sv-SE) | Ny artikel | Lär dig varför det inte går att extrahera innehåll via [!DNL Migration Set]. |

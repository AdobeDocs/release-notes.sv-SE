...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Maj 2023 | [Så här beviljar du åtkomstbehörighet till Data Warehouse](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21666.html) | Felsökning | Lär dig vilken behörighet som ska läggas till för att ge Data Warehouse åtkomstbehörighet. |

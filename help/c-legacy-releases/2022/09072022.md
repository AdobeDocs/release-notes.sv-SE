---
title: Versionsinformation för central - september 2022
...
* Microsoft® Azure datalageranslutning: Nu kan du [ansluta formulärdatamodellen till Microsoft® Azure-lagring](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/use-form-data-model/configure-azure-storage.html). Här kan du hämta och lagra adaptiva formulärdata i Microsoft® Azure-lager som en BLOB.
...
| September 2022 | [Skapa en kampanj](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-campaigns/create-a-campaign.html) | Video | Lär dig att leverera engångsinnehåll till en viss målgrupp genom att köra åtgärder direkt eller enligt ett angivet schema. |

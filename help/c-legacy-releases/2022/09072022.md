...
<!-- See [Current Release Notes for Adobe Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html?lang=sv-SE) -->
...
Titta på videon [Augustiversionen 2022, en översikt av funktioner som lagts till i version 2022.8.0 (augusti 2022). &#x200B;](https://video.tv.adobe.com/v/3454200/?captions=swe&quality=12) <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->

* [Video om versionsöversikt, juli 2022](https://video.tv.adobe.com/v/3454200/?captions=swe&quality=12)
...
* Microsoft® Azure datalageranslutning: Nu kan du [ansluta formulärdatamodellen till Microsoft® Azure-lagring](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/use-form-data-model/configure-azure-storage.html?lang=sv-SE). Här kan du hämta och lagra adaptiva formulärdata i Microsoft® Azure-lager som en BLOB.
...
* **Experience League Showcase** - Visa oss - och hela världen - vad du kan göra med flera Adobe Experience Cloud-produkter. [Skicka in din berättelse idag!](https://experienceleaguecommunities.adobe.com/t5/experience-league-showcase-2022/con-p/exl-showcase-2022?profile.language=sv&sdid=3NQZB6J7&mv=email)
...
| September 2022 | [Skapa en kampanj](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-campaigns/create-a-campaign.html?lang=sv-SE) | Video | Lär dig att leverera engångsinnehåll till en viss målgrupp genom att köra åtgärder direkt eller enligt ett angivet schema. |
...
| September 2022 | [Skapa ett anpassat arbetsflöde](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/building-a-custom-workflow.html?lang=sv-SE) | Video (uppdaterad) | Lär dig att skräddarsy och automatisera dokumentflöden för att få elektroniska signaturer, samla in formulärdata och bekräfta leveransen av ett viktigt dokument för att effektivisera arbetsflödeshanteringen. | Acrobat Sign |
| September 2022 | [Skicka för signering i Microsoft Teams](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/adobe-sign-teams-mortgage.html?lang=sv-SE) | Video (uppdaterad) | Lär dig hur du skickar avtal för signering, kontrollerar status för avtal och skickar påminnelser inifrån Microsoft Teams. | Acrobat Sign |
| September 2022 | [Lägger till fält i dina dokument](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/adding-fields.html?lang=sv-SE) | Video (uppdaterad) | Lär dig hur du automatiskt placerar fält i dokumentet eller använder dra och släpp-redigeringsmiljön i Acrobat Sign. | Acrobat Sign |
| September 2022 | [Konfigurera sändningsalternativ](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/sending-options.html?lang=sv-SE) | Video (uppdaterad) | Lär dig hur du konfigurerar olika alternativ när du skickar ut ett dokument för signering. | Acrobat Sign |

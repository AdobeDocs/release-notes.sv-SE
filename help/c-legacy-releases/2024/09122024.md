...
* [!DNL Campaign] v8: **3** september - [Versionsinformation](https://experienceleague.adobe.com/sv/docs/campaign/campaign-v8/releases/release-notes) | [Produktdokumentation](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/campaign-home)
...
| September 2024 | [Marketo Measure Ultimate - översikt](https://experienceleague.adobe.com/en/docs/marketo-measure-learn/tutorials/marketo-measure-ultimate/overview) | Video | Läs om hur Marketo Measure Ultimate gör det möjligt för B2B-marknadsförare att samla in data från nästan vilken källa som helst, inklusive flera källor av samma typ, för grundlig attribuering. |
...
| September 2024 | [Publicera med Dynamic Chat på bara 15 minuter](https://experienceleague.adobe.com/en/docs/marketo-learn/tutorials/dynamic-chat/go-live-in-15-minutes) | Video | Titta på en stegvis guide där du får hjälp med den första dialogen med Dynamic Chat på bara 15 minuter. |

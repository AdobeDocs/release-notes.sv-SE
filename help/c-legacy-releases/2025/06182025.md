...
| Maj 2025 | [Begränsningslogikinkonsekvenser mellan placeringar i AEP-erbjudandebeslut](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26682) | Ny artikel | Lär dig mer om lösningarna på problemet där appningslogiken beter sig inkonsekvent mellan 1:1-meddelanden och e-postmeddelanden i funktionen **[!UICONTROL Offer Decisioning]** i Adobe Experience Platform. |
